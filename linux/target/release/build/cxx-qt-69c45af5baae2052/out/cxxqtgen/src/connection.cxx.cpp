...
namespace cxxqt1 {
extern "C" {
void rust$cxxqt1$cxxbridge1$202$qmetaobjectconnection_default(::rust::cxxqt1::QMetaObjectConnection *return$) noexcept {
...
bool rust$cxxqt1$cxxbridge1$202$qmetaobjectconnection_disconnect(::rust::cxxqt1::QMetaObjectConnection const &connection) noexcept {
...
void rust$cxxqt1$cxxbridge1$202$qmetaobjectconnection_drop(::rust::cxxqt1::QMetaObjectConnection &connection) noexcept {
