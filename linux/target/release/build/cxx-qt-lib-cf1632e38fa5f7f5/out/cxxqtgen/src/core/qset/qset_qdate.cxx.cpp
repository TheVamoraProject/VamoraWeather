...
extern "C" {
void cxxbridge1$202$QSet_QDate$cxx_clear(::QSet_QDate &self) noexcept {
  void (::QSet_QDate::*cxx_clear$)() = &::QSet_QDate::clear;
  (self.*cxx_clear$)();
}

bool cxxbridge1$202$QSet_QDate$cxx_contains(::QSet_QDate const &self, ::QDate const &arg0) noexcept {
  bool (::QSet_QDate::*cxx_contains$)(::QDate const &) const = &::QSet_QDate::contains;
  return (self.*cxx_contains$)(arg0);
}

bool cxxbridge1$202$QSet_QDate$cxx_remove(::QSet_QDate &self, ::QDate const &arg0) noexcept {
...
namespace cxxqtlib1 {
extern "C" {
void rust$cxxqtlib1$cxxbridge1$202$qset_clone_QDate(::QSet_QDate const &arg0, ::QSet_QDate *return$) noexcept {
  ::QSet_QDate (*qset_clone_QDate$)(::QSet_QDate const &) = ::rust::cxxqtlib1::construct;
  new (return$) ::QSet_QDate(qset_clone_QDate$(arg0));
}

void rust$cxxqtlib1$cxxbridge1$202$qset_default_QDate(::QSet_QDate *return$) noexcept {
  ::QSet_QDate (*qset_default_QDate$)() = ::rust::cxxqtlib1::construct;
  new (return$) ::QSet_QDate(qset_default_QDate$());
}

void rust$cxxqtlib1$cxxbridge1$202$qset_drop_QDate(::QSet_QDate &arg0) noexcept {
...
namespace qset {
extern "C" {
void rust$cxxqtlib1$qset$cxxbridge1$202$get_unchecked_QDate(::QSet_QDate const &set, ::rust::isize pos, ::QDate const **return$) noexcept {
...
void rust$cxxqtlib1$qset$cxxbridge1$202$insert_QDate(::QSet_QDate &arg0, ::QDate const &arg1) noexcept {
  void (*insert_QDate$)(::QSet_QDate &, ::QDate const &) = ::rust::cxxqtlib1::qset::qsetInsert;
  insert_QDate$(arg0, arg1);
}

::rust::isize rust$cxxqtlib1$qset$cxxbridge1$202$len_QDate(::QSet_QDate const &arg0) noexcept {
  ::rust::isize (*len_QDate$)(::QSet_QDate const &) = ::rust::cxxqtlib1::qset::qsetLen;
  return len_QDate$(arg0);
}

void rust$cxxqtlib1$qset$cxxbridge1$202$reserve_QDate(::QSet_QDate &arg0, ::rust::isize size) noexcept {
