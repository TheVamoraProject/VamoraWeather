...
static_assert(
    ...
    "type QString should be trivially move constructible and trivially destructible in C++ to be used as a return value of `desktop_file_name`, `qguiapplication_application_name`, `qguiapplication_application_display_name` in Rust");
static_assert(
...
extern "C" {
void cxxbridge1$202$QGuiApplication$desktop_file_name(::QString *return$) noexcept {
  ::QString (*desktop_file_name$)() = &::QGuiApplication::desktopFileName;
  new (return$) ::QString(desktop_file_name$());
}

void cxxbridge1$202$QGuiApplication$set_desktop_file_name(::QString const &name) noexcept {
  void (*set_desktop_file_name$)(::QString const &) = &::QGuiApplication::setDesktopFileName;
  set_desktop_file_name$(name);
}
} // extern "C"
...
namespace cxxqtlib1 {
extern "C" {
::QGuiApplication *rust$cxxqtlib1$cxxbridge1$202$qguiapplication_new(::QVector_QByteArray const &args) noexcept {
...
void rust$cxxqtlib1$cxxbridge1$202$qguiapplication_add_library_path(::QGuiApplication &app, ::QString const &path) noexcept {
...
void rust$cxxqtlib1$cxxbridge1$202$qguiapplication_application_name(::QGuiApplication const &app, ::QString *return$) noexcept {
...
void rust$cxxqtlib1$cxxbridge1$202$qguiapplication_application_display_name(::QString *return$) noexcept {
  ::QString (*qguiapplication_application_display_name$)() = ::rust::cxxqtlib1::qguiapplicationApplicationDisplayName;
  new (return$) ::QString(qguiapplication_application_display_name$());
}

void rust$cxxqtlib1$cxxbridge1$202$qguiapplication_remove_library_path(::QGuiApplication const &app, ::QString const &path) noexcept {
...
void rust$cxxqtlib1$cxxbridge1$202$qguiapplication_application_version(::QGuiApplication const &app, ::QString *return$) noexcept {
...
::std::int32_t rust$cxxqtlib1$cxxbridge1$202$qguiapplication_exec(::QGuiApplication &app) noexcept {
  ::std::int32_t (*qguiapplication_exec$)(::QGuiApplication &) = ::rust::cxxqtlib1::qapplicationExec;
  return qguiapplication_exec$(app);
}

void rust$cxxqtlib1$cxxbridge1$202$qguiapplication_library_paths(::QGuiApplication const &app, ::QStringList *return$) noexcept {
...
void rust$cxxqtlib1$cxxbridge1$202$qguiapplication_organization_domain(::QGuiApplication const &app, ::QString *return$) noexcept {
...
void rust$cxxqtlib1$cxxbridge1$202$qguiapplication_organization_name(::QGuiApplication const &app, ::QString *return$) noexcept {
...
void rust$cxxqtlib1$cxxbridge1$202$qguiapplication_set_application_name(::QGuiApplication &app, ::QString const &name) noexcept {
...
void rust$cxxqtlib1$cxxbridge1$202$qguiapplication_set_application_display_name(::QString const &name) noexcept {
  void (*qguiapplication_set_application_display_name$)(::QString const &) = ::rust::cxxqtlib1::qguiapplicationSetApplicationDisplayName;
  qguiapplication_set_application_display_name$(name);
}

void rust$cxxqtlib1$cxxbridge1$202$qguiapplication_set_application_version(::QGuiApplication &app, ::QString const &version) noexcept {
...
void rust$cxxqtlib1$cxxbridge1$202$qguiapplication_set_font(::QFont const &font) noexcept {
  void (*qguiapplication_set_font$)(::QFont const &) = ::rust::cxxqtlib1::qguiapplicationSetFont;
  qguiapplication_set_font$(font);
}

void rust$cxxqtlib1$cxxbridge1$202$qguiapplication_font(::QFont *return$) noexcept {
  ::QFont (*qguiapplication_font$)() = ::rust::cxxqtlib1::qguiapplicationFont;
  new (return$) ::QFont(qguiapplication_font$());
}

void rust$cxxqtlib1$cxxbridge1$202$qguiapplication_set_library_paths(::QGuiApplication &app, ::QStringList const &paths) noexcept {
...
void rust$cxxqtlib1$cxxbridge1$202$qguiapplication_set_organization_domain(::QGuiApplication &app, ::QString const &domain) noexcept {
...
void rust$cxxqtlib1$cxxbridge1$202$qguiapplication_set_organization_name(::QGuiApplication &app, ::QString const &name) noexcept {
...
void rust$cxxqtlib1$cxxbridge1$202$qguiapplication_keyboard_modifiers(::Qt::KeyboardModifiers *return$) noexcept {
...
void rust$cxxqtlib1$cxxbridge1$202$qguiapplication_mouse_buttons(::Qt::MouseButtons *return$) noexcept {
...
void rust$cxxqtlib1$cxxbridge1$202$qguiapplication_query_keyboard_modifiers(::Qt::KeyboardModifiers *return$) noexcept {
...
namespace cxxqt1 {
extern "C" {
::QCoreApplication const *rust$cxxqt1$cxxbridge1$202$cxx_qt_ffi_QGuiApplication_upcastPtr(::QGuiApplication const *thiz) noexcept {
...
::QGuiApplication const *rust$cxxqt1$cxxbridge1$202$cxx_qt_ffi_QGuiApplication_downcastPtr(::QCoreApplication const *base) noexcept {
