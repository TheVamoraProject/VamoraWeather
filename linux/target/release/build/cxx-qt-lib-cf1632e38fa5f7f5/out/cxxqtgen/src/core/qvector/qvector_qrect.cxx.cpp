...
extern "C" {
void cxxbridge1$202$QVector_QRect$cxx_clear(::QVector_QRect &self) noexcept {
  void (::QVector_QRect::*cxx_clear$)() = &::QVector_QRect::clear;
  (self.*cxx_clear$)();
}

bool cxxbridge1$202$QVector_QRect$cxx_contains(::QVector_QRect const &self, ::QRect const &arg0) noexcept {
...
namespace cxxqtlib1 {
extern "C" {
void rust$cxxqtlib1$cxxbridge1$202$qvector_clone_QRect(::QVector_QRect const &arg0, ::QVector_QRect *return$) noexcept {
...
void rust$cxxqtlib1$cxxbridge1$202$qvector_default_QRect(::QVector_QRect *return$) noexcept {
  ::QVector_QRect (*qvector_default_QRect$)() = ::rust::cxxqtlib1::construct;
  new (return$) ::QVector_QRect(qvector_default_QRect$());
}

void rust$cxxqtlib1$cxxbridge1$202$qvector_drop_QRect(::QVector_QRect &arg0) noexcept {
...
namespace qvector {
extern "C" {
void rust$cxxqtlib1$qvector$cxxbridge1$202$reserve_QRect(::QVector_QRect &arg0, ::rust::isize size) noexcept {
  void (*reserve_QRect$)(::QVector_QRect &, ::rust::isize) = ::rust::cxxqtlib1::qvector::qvectorReserve;
  reserve_QRect$(arg0, size);
}

void rust$cxxqtlib1$qvector$cxxbridge1$202$append_QRect(::QVector_QRect &arg0, ::QRect const &arg1) noexcept {
  void (*append_QRect$)(::QVector_QRect &, ::QRect const &) = ::rust::cxxqtlib1::qvector::qvectorAppend;
  append_QRect$(arg0, arg1);
}

void rust$cxxqtlib1$qvector$cxxbridge1$202$get_unchecked_QRect(::QVector_QRect const &set, ::rust::isize pos, ::QRect const **return$) noexcept {
...
::rust::isize rust$cxxqtlib1$qvector$cxxbridge1$202$index_of_QRect(::QVector_QRect const &arg0, ::QRect const &arg1) noexcept {
...
void rust$cxxqtlib1$qvector$cxxbridge1$202$insert_QRect(::QVector_QRect &arg0, ::rust::isize arg1, ::QRect const &arg2) noexcept {
  void (*insert_QRect$)(::QVector_QRect &, ::rust::isize, ::QRect const &) = ::rust::cxxqtlib1::qvector::qvectorInsert;
  insert_QRect$(arg0, arg1, arg2);
}

void rust$cxxqtlib1$qvector$cxxbridge1$202$remove_QRect(::QVector_QRect &arg0, ::rust::isize arg1) noexcept {
  void (*remove_QRect$)(::QVector_QRect &, ::rust::isize) = ::rust::cxxqtlib1::qvector::qvectorRemove;
  remove_QRect$(arg0, arg1);
}

::rust::isize rust$cxxqtlib1$qvector$cxxbridge1$202$len_QRect(::QVector_QRect const &arg0) noexcept {
