...
extern "C" {
bool cxxbridge1$202$QStringList$contains(::QStringList const &self, ::QString const &str, ::Qt::CaseSensitivity *cs) noexcept {
...
void cxxbridge1$202$QStringList$filter(::QStringList const &self, ::QString const &str, ::Qt::CaseSensitivity *cs, ::QStringList *return$) noexcept {
...
void cxxbridge1$202$QStringList$join(::QStringList const &self, ::QString const &separator, ::QString *return$) noexcept {
  ::QString (::QStringList::*join$)(::QString const &) const = &::QStringList::join;
  new (return$) ::QString((self.*join$)(separator));
}

void cxxbridge1$202$QStringList$sort(::QStringList &self, ::Qt::CaseSensitivity *cs) noexcept {
  void (::QStringList::*sort$)(::Qt::CaseSensitivity) = &::QStringList::sort;
  (self.*sort$)(::std::move(*cs));
}

void cxxbridge1$202$QStringList$replace_in_strings(::QStringList &self, ::QString const &before, ::QString const &after, ::Qt::CaseSensitivity *cs, ::QStringList **return$) noexcept {
...
namespace cxxqt1 {
extern "C" {
::QList_QString const *rust$cxxqt1$cxxbridge1$202$upcast_qstringlist(::QStringList const *thiz) noexcept {
  ::QList_QString const *(*upcast_qstringlist$)(::QStringList const *) = ::rust::cxxqt1::upcastPtr;
  return upcast_qstringlist$(thiz);
}

::QStringList const *rust$cxxqt1$cxxbridge1$202$downcast_qlist_qstring(::QList_QString const *base) noexcept {
...
namespace cxxqtlib1 {
extern "C" {
void rust$cxxqtlib1$cxxbridge1$202$qstringlist_clone(::QStringList const &list, ::QStringList *return$) noexcept {
  ::QStringList (*qstringlist_clone$)(::QStringList const &) = ::rust::cxxqtlib1::construct;
  new (return$) ::QStringList(qstringlist_clone$(list));
}

void rust$cxxqtlib1$cxxbridge1$202$qstringlist_drop(::QStringList &url) noexcept {
  void (*qstringlist_drop$)(::QStringList &) = ::rust::cxxqtlib1::drop;
  qstringlist_drop$(url);
}

void rust$cxxqtlib1$cxxbridge1$202$qstringlist_default(::QStringList *return$) noexcept {
  ::QStringList (*qstringlist_default$)() = ::rust::cxxqtlib1::construct;
  new (return$) ::QStringList(qstringlist_default$());
}

void rust$cxxqtlib1$cxxbridge1$202$qstringlist_from_qstring(::QString const &string, ::QStringList *return$) noexcept {
...
bool rust$cxxqtlib1$cxxbridge1$202$qstringlist_eq(::QStringList const &a, ::QStringList const &b) noexcept {
  bool (*qstringlist_eq$)(::QStringList const &, ::QStringList const &) = ::rust::cxxqtlib1::operatorEq;
  return qstringlist_eq$(a, b);
}

void rust$cxxqtlib1$cxxbridge1$202$qstringlist_to_debug_qstring(::QStringList const &value, ::QString *return$) noexcept {
...
void rust$cxxqtlib1$cxxbridge1$202$qstringlist_from_qlist_qstring(::QList_QString const &list, ::QStringList *return$) noexcept {
...
void rust$cxxqtlib1$cxxbridge1$202$qstringlist_as_qlist_qstring(::QStringList const &list, ::QList_QString *return$) noexcept {
...
::rust::isize rust$cxxqtlib1$cxxbridge1$202$qstringlist_remove_duplicates(::QStringList &list) noexcept {
