...
extern "C" {
void cxxbridge1$202$qt_message_output(::QtMsgType msg_type, ::QMessageLogContext const &context, ::QString const &string) noexcept {
...
void cxxbridge1$202$q_format_log_message(::QtMsgType msg_type, ::QMessageLogContext const &context, ::QString const &str, ::QString *return$) noexcept {
...
void cxxbridge1$202$q_set_message_pattern(::QString const &pattern) noexcept {
  void (*q_set_message_pattern$)(::QString const &) = ::qSetMessagePattern;
  q_set_message_pattern$(pattern);
}

::std::int32_t cxxbridge1$202$line(::QMessageLogContext const &context) noexcept {
  ::std::int32_t (*line$)(::QMessageLogContext const &) = ::qmessagelogcontext_line;
  return line$(context);
}

char const *cxxbridge1$202$file(::QMessageLogContext const &context) noexcept {
  char const *(*file$)(::QMessageLogContext const &) = ::qmessagelogcontext_file;
  return file$(context);
}

char const *cxxbridge1$202$function(::QMessageLogContext const &context) noexcept {
  char const *(*function$)(::QMessageLogContext const &) = ::qmessagelogcontext_function;
  return function$(context);
}

char const *cxxbridge1$202$category(::QMessageLogContext const &context) noexcept {
...
namespace cxxqtlib1 {
extern "C" {
void rust$cxxqtlib1$cxxbridge1$202$construct_qmessagelogcontext(char const *file_name, ::std::int32_t line_number, char const *function_name, char const *category_name, ::QMessageLogContext *return$) noexcept {
