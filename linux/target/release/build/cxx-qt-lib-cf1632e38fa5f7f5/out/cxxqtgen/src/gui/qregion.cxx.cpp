...
static_assert(
    ...
    "type Qt::FillRule should be trivially move constructible and trivially destructible in C++ to be used as an argument of `qregion_init_qpolygon_fillrule` in Rust");
static_assert(
...
extern "C" {
void cxxbridge1$202$QRegion$bounding_rect(::QRegion const &self, ::QRect *return$) noexcept {
  ::QRect (::QRegion::*bounding_rect$)() const = &::QRegion::boundingRect;
  new (return$) ::QRect((self.*bounding_rect$)());
}

bool cxxbridge1$202$QRegion$contains(::QRegion const &self, ::QRect const &r) noexcept {
  bool (::QRegion::*contains$)(::QRect const &) const = &::QRegion::contains;
  return (self.*contains$)(r);
}

void cxxbridge1$202$QRegion$intersected(::QRegion const &self, ::QRegion const &r, ::QRegion *return$) noexcept {
  ::QRegion (::QRegion::*intersected$)(::QRegion const &) const = &::QRegion::intersected;
  new (return$) ::QRegion((self.*intersected$)(r));
}

bool cxxbridge1$202$QRegion$is_empty(::QRegion const &self) noexcept {
  bool (::QRegion::*is_empty$)() const = &::QRegion::isEmpty;
  return (self.*is_empty$)();
}

bool cxxbridge1$202$QRegion$is_null(::QRegion const &self) noexcept {
  bool (::QRegion::*is_null$)() const = &::QRegion::isNull;
  return (self.*is_null$)();
}

::std::int32_t cxxbridge1$202$QRegion$rect_count(::QRegion const &self) noexcept {
  ::std::int32_t (::QRegion::*rect_count$)() const = &::QRegion::rectCount;
  return (self.*rect_count$)();
}

void cxxbridge1$202$QRegion$subtracted(::QRegion const &self, ::QRegion const &r, ::QRegion *return$) noexcept {
  ::QRegion (::QRegion::*subtracted$)(::QRegion const &) const = &::QRegion::subtracted;
  new (return$) ::QRegion((self.*subtracted$)(r));
}

void cxxbridge1$202$QRegion$translate(::QRegion &self, ::QPoint const &point) noexcept {
  void (::QRegion::*translate$)(::QPoint const &) = &::QRegion::translate;
  (self.*translate$)(point);
}

void cxxbridge1$202$QRegion$translated(::QRegion const &self, ::QPoint const &p, ::QRegion *return$) noexcept {
  ::QRegion (::QRegion::*translated$)(::QPoint const &) const = &::QRegion::translated;
  new (return$) ::QRegion((self.*translated$)(p));
}

void cxxbridge1$202$QRegion$united(::QRegion const &self, ::QRegion const &r, ::QRegion *return$) noexcept {
  ::QRegion (::QRegion::*united$)(::QRegion const &) const = &::QRegion::united;
  new (return$) ::QRegion((self.*united$)(r));
}

void cxxbridge1$202$QRegion$xored(::QRegion const &self, ::QRegion const &r, ::QRegion *return$) noexcept {
...
namespace cxxqtlib1 {
extern "C" {
void rust$cxxqtlib1$cxxbridge1$202$qregion_init_default(::QRegion *return$) noexcept {
  ::QRegion (*qregion_init_default$)() = ::rust::cxxqtlib1::construct;
  new (return$) ::QRegion(qregion_init_default$());
}

void rust$cxxqtlib1$cxxbridge1$202$qregion_init_qrect_regiontype(::QRect const &r, ::rust::cxxqtlib1::QRegionRegionType t, ::QRegion *return$) noexcept {
  ::QRegion (*qregion_init_qrect_regiontype$)(::QRect const &, ::rust::cxxqtlib1::QRegionRegionType) = ::rust::cxxqtlib1::construct;
  new (return$) ::QRegion(qregion_init_qrect_regiontype$(r, t));
}

void rust$cxxqtlib1$cxxbridge1$202$qregion_init_qpolygon_fillrule(::QPolygon const &a, ::Qt::FillRule *fill_rule, ::QRegion *return$) noexcept {
  ::QRegion (*qregion_init_qpolygon_fillrule$)(::QPolygon const &, ::Qt::FillRule) = ::rust::cxxqtlib1::construct;
  new (return$) ::QRegion(qregion_init_qpolygon_fillrule$(a, ::std::move(*fill_rule)));
}

void rust$cxxqtlib1$cxxbridge1$202$qregion_drop(::QRegion &r) noexcept {
  void (*qregion_drop$)(::QRegion &) = ::rust::cxxqtlib1::drop;
  qregion_drop$(r);
}

void rust$cxxqtlib1$cxxbridge1$202$qregion_clone(::QRegion const &r, ::QRegion *return$) noexcept {
