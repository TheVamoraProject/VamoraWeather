...
extern "C" {
::QString *cxxbridge1$202$QString$append(::QString &self, ::QString const &str) noexcept {
  ::QString &(::QString::*append$)(::QString const &) = &::QString::append;
  return &(self.*append$)(str);
}

void cxxbridge1$202$QString$clear(::QString &self) noexcept {
  void (::QString::*clear$)() = &::QString::clear;
  (self.*clear$)();
}

::std::int32_t cxxbridge1$202$QString$compare_i32(::QString const &self, ::QString const &other, ::Qt::CaseSensitivity *cs) noexcept {
...
bool cxxbridge1$202$QString$contains(::QString const &self, ::QString const &str, ::Qt::CaseSensitivity *cs) noexcept {
  bool (::QString::*contains$)(::QString const &, ::Qt::CaseSensitivity) const = &::QString::contains;
  return (self.*contains$)(str, ::std::move(*cs));
}

bool cxxbridge1$202$QString$ends_with(::QString const &self, ::QString const &s, ::Qt::CaseSensitivity *cs) noexcept {
  bool (::QString::*ends_with$)(::QString const &, ::Qt::CaseSensitivity) const = &::QString::endsWith;
  return (self.*ends_with$)(s, ::std::move(*cs));
}

bool cxxbridge1$202$QString$is_empty(::QString const &self) noexcept {
  bool (::QString::*is_empty$)() const = &::QString::isEmpty;
  return (self.*is_empty$)();
}

bool cxxbridge1$202$QString$is_lower(::QString const &self) noexcept {
  bool (::QString::*is_lower$)() const = &::QString::isLower;
  return (self.*is_lower$)();
}

bool cxxbridge1$202$QString$is_null(::QString const &self) noexcept {
  bool (::QString::*is_null$)() const = &::QString::isNull;
  return (self.*is_null$)();
}

bool cxxbridge1$202$QString$is_right_to_left(::QString const &self) noexcept {
  bool (::QString::*is_right_to_left$)() const = &::QString::isRightToLeft;
  return (self.*is_right_to_left$)();
}

bool cxxbridge1$202$QString$is_upper(::QString const &self) noexcept {
  bool (::QString::*is_upper$)() const = &::QString::isUpper;
  return (self.*is_upper$)();
}

bool cxxbridge1$202$QString$is_valid_utf16(::QString const &self) noexcept {
  bool (::QString::*is_valid_utf16$)() const = &::QString::isValidUtf16;
  return (self.*is_valid_utf16$)();
}

::QString *cxxbridge1$202$QString$prepend(::QString &self, ::QString const &str) noexcept {
  ::QString &(::QString::*prepend$)(::QString const &) = &::QString::prepend;
  return &(self.*prepend$)(str);
}

::QString *cxxbridge1$202$QString$remove(::QString &self, ::QString const &str, ::Qt::CaseSensitivity *cs) noexcept {
  ::QString &(::QString::*remove$)(::QString const &, ::Qt::CaseSensitivity) = &::QString::remove;
  return &(self.*remove$)(str, ::std::move(*cs));
}

void cxxbridge1$202$QString$remove_first(::QString &self, ::QString **return$) noexcept {
  ::QString &(::QString::*remove_first$)() = &::QString::removeFirst;
  new (return$) ::QString *(&(self.*remove_first$)());
}

void cxxbridge1$202$QString$remove_last(::QString &self, ::QString **return$) noexcept {
  ::QString &(::QString::*remove_last$)() = &::QString::removeLast;
  new (return$) ::QString *(&(self.*remove_last$)());
}

::QString *cxxbridge1$202$QString$replace(::QString &self, ::QString const &before, ::QString const &after, ::Qt::CaseSensitivity *cs) noexcept {
...
bool cxxbridge1$202$QString$starts_with(::QString const &self, ::QString const &s, ::Qt::CaseSensitivity *cs) noexcept {
  bool (::QString::*starts_with$)(::QString const &, ::Qt::CaseSensitivity) const = &::QString::startsWith;
  return (self.*starts_with$)(s, ::std::move(*cs));
}

void cxxbridge1$202$QString$to_html_escaped(::QString const &self, ::QString *return$) noexcept {
...
namespace cxxqtlib1 {
extern "C" {
void rust$cxxqtlib1$cxxbridge1$202$qstring_drop(::QString &string) noexcept {
  void (*qstring_drop$)(::QString &) = ::rust::cxxqtlib1::drop;
  qstring_drop$(string);
}

void rust$cxxqtlib1$cxxbridge1$202$qstring_init_default(::QString *return$) noexcept {
  ::QString (*qstring_init_default$)() = ::rust::cxxqtlib1::construct;
  new (return$) ::QString(qstring_init_default$());
}

void rust$cxxqtlib1$cxxbridge1$202$qstring_init_from_rust_string(::rust::Str string, ::QString *return$) noexcept {
...
void rust$cxxqtlib1$cxxbridge1$202$qstring_init_from_qstring(::QString const &string, ::QString *return$) noexcept {
...
bool rust$cxxqtlib1$cxxbridge1$202$qstring_eq(::QString const &a, ::QString const &b) noexcept {
  bool (*qstring_eq$)(::QString const &, ::QString const &) = ::rust::cxxqtlib1::operatorEq;
  return qstring_eq$(a, b);
}

::std::int8_t rust$cxxqtlib1$cxxbridge1$202$qstring_cmp(::QString const &a, ::QString const &b) noexcept {
  ::std::int8_t (*qstring_cmp$)(::QString const &, ::QString const &) = ::rust::cxxqtlib1::operatorCmp;
  return qstring_cmp$(a, b);
}

void rust$cxxqtlib1$cxxbridge1$202$qstring_as_slice(::QString const &string, ::rust::Slice<::std::uint16_t const> *return$) noexcept {
...
void rust$cxxqtlib1$cxxbridge1$202$qstring_arg(::QString const &string, ::QString const &a, ::QString *return$) noexcept {
  ::QString (*qstring_arg$)(::QString const &, ::QString const &) = ::rust::cxxqtlib1::qstringArg;
  new (return$) ::QString(qstring_arg$(string, a));
}

::rust::isize rust$cxxqtlib1$cxxbridge1$202$qstring_index_of(::QString const &string, ::QString const &str, ::rust::isize from, ::Qt::CaseSensitivity *cs) noexcept {
...
::QString *rust$cxxqtlib1$cxxbridge1$202$qstring_insert(::QString &string, ::rust::isize pos, ::QString const &str) noexcept {
  ::QString &(*qstring_insert$)(::QString &, ::rust::isize, ::QString const &) = ::rust::cxxqtlib1::qstringInsert;
  return &qstring_insert$(string, pos, str);
}

void rust$cxxqtlib1$cxxbridge1$202$qstring_left(::QString const &string, ::rust::isize n, ::QString *return$) noexcept {
  ::QString (*qstring_left$)(::QString const &, ::rust::isize) = ::rust::cxxqtlib1::qstringLeft;
  new (return$) ::QString(qstring_left$(string, n));
}

::rust::isize rust$cxxqtlib1$cxxbridge1$202$qstring_len(::QString const &string) noexcept {
  ::rust::isize (*qstring_len$)(::QString const &) = ::rust::cxxqtlib1::qstringLen;
  return qstring_len$(string);
}

void rust$cxxqtlib1$cxxbridge1$202$qstring_mid(::QString const &string, ::rust::isize position, ::rust::isize n, ::QString *return$) noexcept {
...
void rust$cxxqtlib1$cxxbridge1$202$qstring_right(::QString const &string, ::rust::isize n, ::QString *return$) noexcept {
  ::QString (*qstring_right$)(::QString const &, ::rust::isize) = ::rust::cxxqtlib1::qstringRight;
  new (return$) ::QString(qstring_right$(string, n));
}

void rust$cxxqtlib1$cxxbridge1$202$qstring_simplified(::QString const &string, ::QString *return$) noexcept {
  ::QString (*qstring_simplified$)(::QString const &) = ::rust::cxxqtlib1::qstringSimplified;
  new (return$) ::QString(qstring_simplified$(string));
}

void rust$cxxqtlib1$cxxbridge1$202$qstring_split(::QString const &string, ::QString const &sep, ::Qt::SplitBehaviorFlags *behavior, ::Qt::CaseSensitivity *cs, ::QStringList *return$) noexcept {
...
void rust$cxxqtlib1$cxxbridge1$202$qstring_to_latin1(::QString const &string, ::QByteArray *return$) noexcept {
  ::QByteArray (*qstring_to_latin1$)(::QString const &) = ::rust::cxxqtlib1::qstringToLatin1;
  new (return$) ::QByteArray(qstring_to_latin1$(string));
}

void rust$cxxqtlib1$cxxbridge1$202$qstring_to_local8bit(::QString const &string, ::QByteArray *return$) noexcept {
...
void rust$cxxqtlib1$cxxbridge1$202$qstring_to_lower(::QString const &string, ::QString *return$) noexcept {
  ::QString (*qstring_to_lower$)(::QString const &) = ::rust::cxxqtlib1::qstringToLower;
  new (return$) ::QString(qstring_to_lower$(string));
}

void rust$cxxqtlib1$cxxbridge1$202$qstring_to_upper(::QString const &string, ::QString *return$) noexcept {
  ::QString (*qstring_to_upper$)(::QString const &) = ::rust::cxxqtlib1::qstringToUpper;
  new (return$) ::QString(qstring_to_upper$(string));
}

void rust$cxxqtlib1$cxxbridge1$202$qstring_to_utf8(::QString const &string, ::QByteArray *return$) noexcept {
  ::QByteArray (*qstring_to_utf8$)(::QString const &) = ::rust::cxxqtlib1::qstringToUtf8;
  new (return$) ::QByteArray(qstring_to_utf8$(string));
}

void rust$cxxqtlib1$cxxbridge1$202$qstring_trimmed(::QString const &string, ::QString *return$) noexcept {
