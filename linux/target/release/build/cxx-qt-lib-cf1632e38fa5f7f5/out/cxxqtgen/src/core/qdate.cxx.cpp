...
static_assert(
    ...
    "type QDate should be trivially move constructible and trivially destructible in C++ to be used as an argument of `qdate_days_to` or return value of `current_date`, `add_days_qint64`, `add_months` in Rust");

extern "C" {
void cxxbridge1$202$QDate$current_date(::QDate *return$) noexcept {
  ::QDate (*current_date$)() = &::QDate::currentDate;
  new (return$) ::QDate(current_date$());
}

bool cxxbridge1$202$QDate$is_leap_year(::std::int32_t year) noexcept {
  bool (*is_leap_year$)(::std::int32_t) = &::QDate::isLeapYear;
  return is_leap_year$(year);
}

void cxxbridge1$202$QDate$add_days_qint64(::QDate const &self, ::qint64 *ndays, ::QDate *return$) noexcept {
  ::QDate (::QDate::*add_days_qint64$)(::qint64) const = &::QDate::addDays;
  new (return$) ::QDate((self.*add_days_qint64$)(::std::move(*ndays)));
}

void cxxbridge1$202$QDate$add_months(::QDate const &self, ::std::int32_t nmonths, ::QDate *return$) noexcept {
  ::QDate (::QDate::*add_months$)(::std::int32_t) const = &::QDate::addMonths;
  new (return$) ::QDate((self.*add_months$)(nmonths));
}

void cxxbridge1$202$QDate$add_years(::QDate const &self, ::std::int32_t nyears, ::QDate *return$) noexcept {
  ::QDate (::QDate::*add_years$)(::std::int32_t) const = &::QDate::addYears;
  new (return$) ::QDate((self.*add_years$)(nyears));
}

::std::int32_t cxxbridge1$202$QDate$day(::QDate const &self) noexcept {
  ::std::int32_t (::QDate::*day$)() const = &::QDate::day;
  return (self.*day$)();
}

::std::int32_t cxxbridge1$202$QDate$day_of_week(::QDate const &self) noexcept {
  ::std::int32_t (::QDate::*day_of_week$)() const = &::QDate::dayOfWeek;
  return (self.*day_of_week$)();
}

::std::int32_t cxxbridge1$202$QDate$day_of_year(::QDate const &self) noexcept {
  ::std::int32_t (::QDate::*day_of_year$)() const = &::QDate::dayOfYear;
  return (self.*day_of_year$)();
}

::std::int32_t cxxbridge1$202$QDate$days_in_monyth(::QDate const &self) noexcept {
  ::std::int32_t (::QDate::*days_in_monyth$)() const = &::QDate::daysInMonth;
  return (self.*days_in_monyth$)();
}

::std::int32_t cxxbridge1$202$QDate$days_in_year(::QDate const &self) noexcept {
  ::std::int32_t (::QDate::*days_in_year$)() const = &::QDate::daysInYear;
  return (self.*days_in_year$)();
}

bool cxxbridge1$202$QDate$is_null(::QDate const &self) noexcept {
  bool (::QDate::*is_null$)() const = &::QDate::isNull;
  return (self.*is_null$)();
}

bool cxxbridge1$202$QDate$is_valid(::QDate const &self) noexcept {
  bool (::QDate::*is_valid$)() const = &::QDate::isValid;
  return (self.*is_valid$)();
}

::std::int32_t cxxbridge1$202$QDate$month(::QDate const &self) noexcept {
  ::std::int32_t (::QDate::*month$)() const = &::QDate::month;
  return (self.*month$)();
}

bool cxxbridge1$202$QDate$set_date(::QDate &self, ::std::int32_t y, ::std::int32_t m, ::std::int32_t d) noexcept {
  bool (::QDate::*set_date$)(::std::int32_t, ::std::int32_t, ::std::int32_t) = &::QDate::setDate;
  return (self.*set_date$)(y, m, d);
}

void cxxbridge1$202$QDate$format_enum(::QDate const &self, ::Qt::DateFormat *format, ::QString *return$) noexcept {
  ::QString (::QDate::*format_enum$)(::Qt::DateFormat) const = &::QDate::toString;
  new (return$) ::QString((self.*format_enum$)(::std::move(*format)));
}

::std::int32_t cxxbridge1$202$QDate$year(::QDate const &self) noexcept {
...
namespace cxxqtlib1 {
extern "C" {
void rust$cxxqtlib1$cxxbridge1$202$qdate_days_to(::QDate const &date, ::QDate *d, ::qint64 *return$) noexcept {
  ::qint64 (*qdate_days_to$)(::QDate const &, ::QDate) = ::rust::cxxqtlib1::qdateDaysTo;
  new (return$) ::qint64(qdate_days_to$(date, ::std::move(*d)));
}

void rust$cxxqtlib1$cxxbridge1$202$qdate_from_string(::QString const &string, ::QString const &format, ::QDate *return$) noexcept {
...
void rust$cxxqtlib1$cxxbridge1$202$qdate_from_string_enum(::QString const &string, ::Qt::DateFormat *format, ::QDate *return$) noexcept {
...
void rust$cxxqtlib1$cxxbridge1$202$qdate_to_format(::QDate const &date, ::QString const &format, ::QString *return$) noexcept {
...
void rust$cxxqtlib1$cxxbridge1$202$qdate_init_default(::QDate *return$) noexcept {
  ::QDate (*qdate_init_default$)() = ::rust::cxxqtlib1::construct;
  new (return$) ::QDate(qdate_init_default$());
}

void rust$cxxqtlib1$cxxbridge1$202$qdate_init(::std::int32_t y, ::std::int32_t m, ::std::int32_t d, ::QDate *return$) noexcept {
  ::QDate (*qdate_init$)(::std::int32_t, ::std::int32_t, ::std::int32_t) = ::rust::cxxqtlib1::construct;
  new (return$) ::QDate(qdate_init$(y, m, d));
}

void rust$cxxqtlib1$cxxbridge1$202$qdate_to_debug_qstring(::QDate const &value, ::QString *return$) noexcept {
