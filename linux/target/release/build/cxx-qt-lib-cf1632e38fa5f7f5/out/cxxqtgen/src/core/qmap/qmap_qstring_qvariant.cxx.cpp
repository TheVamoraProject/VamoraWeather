...
extern "C" {
void cxxbridge1$202$QMap_QString_QVariant$cxx_clear(::QMap_QString_QVariant &self) noexcept {
  void (::QMap_QString_QVariant::*cxx_clear$)() = &::QMap_QString_QVariant::clear;
  (self.*cxx_clear$)();
}

bool cxxbridge1$202$QMap_QString_QVariant$cxx_contains(::QMap_QString_QVariant const &self, ::QString const &key) noexcept {
...
namespace cxxqtlib1 {
extern "C" {
void rust$cxxqtlib1$cxxbridge1$202$qmap_clone_QString_QVariant(::QMap_QString_QVariant const &arg0, ::QMap_QString_QVariant *return$) noexcept {
...
void rust$cxxqtlib1$cxxbridge1$202$qmap_default_QString_QVariant(::QMap_QString_QVariant *return$) noexcept {
...
void rust$cxxqtlib1$cxxbridge1$202$qmap_drop_QString_QVariant(::QMap_QString_QVariant &arg0) noexcept {
...
namespace qmap {
extern "C" {
void rust$cxxqtlib1$qmap$cxxbridge1$202$get_or_default_QString_QVariant(::QMap_QString_QVariant const &arg0, ::QString const &key, ::QVariant *return$) noexcept {
...
::QString const *rust$cxxqtlib1$qmap$cxxbridge1$202$get_unchecked_key_QString_QVariant(::QMap_QString_QVariant const &arg0, ::rust::isize pos) noexcept {
...
void rust$cxxqtlib1$qmap$cxxbridge1$202$get_unchecked_value_QString_QVariant(::QMap_QString_QVariant const &arg0, ::rust::isize pos, ::QVariant const **return$) noexcept {
...
void rust$cxxqtlib1$qmap$cxxbridge1$202$insert_QString_QVariant(::QMap_QString_QVariant &arg0, ::QString const &key, ::QVariant const &value) noexcept {
...
::rust::isize rust$cxxqtlib1$qmap$cxxbridge1$202$len_QString_QVariant(::QMap_QString_QVariant const &arg0) noexcept {
  ::rust::isize (*len_QString_QVariant$)(::QMap_QString_QVariant const &) = ::rust::cxxqtlib1::qmap::qmapLen;
  return len_QString_QVariant$(arg0);
}

bool rust$cxxqtlib1$qmap$cxxbridge1$202$remove_QString_QVariant(::QMap_QString_QVariant &arg0, ::QString const &key) noexcept {
