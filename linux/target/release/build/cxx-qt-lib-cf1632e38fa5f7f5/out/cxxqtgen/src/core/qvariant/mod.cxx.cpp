...
extern "C" {
void cxxbridge1$202$QVariant$clear(::QVariant &self) noexcept {
  void (::QVariant::*clear$)() = &::QVariant::clear;
  (self.*clear$)();
}

bool cxxbridge1$202$QVariant$is_null(::QVariant const &self) noexcept {
  bool (::QVariant::*is_null$)() const = &::QVariant::isNull;
  return (self.*is_null$)();
}

bool cxxbridge1$202$QVariant$is_valid(::QVariant const &self) noexcept {
  bool (::QVariant::*is_valid$)() const = &::QVariant::isValid;
  return (self.*is_valid$)();
}

::std::int32_t cxxbridge1$202$QVariant$user_type(::QVariant const &self) noexcept {
  ::std::int32_t (::QVariant::*user_type$)() const = &::QVariant::userType;
...
namespace cxxqtlib1 {
extern "C" {
void rust$cxxqtlib1$cxxbridge1$202$qvariant_drop(::QVariant &variant) noexcept {
  void (*qvariant_drop$)(::QVariant &) = ::rust::cxxqtlib1::drop;
  qvariant_drop$(variant);
}

void rust$cxxqtlib1$cxxbridge1$202$qvariant_default(::QVariant *return$) noexcept {
  ::QVariant (*qvariant_default$)() = ::rust::cxxqtlib1::construct;
  new (return$) ::QVariant(qvariant_default$());
}

void rust$cxxqtlib1$cxxbridge1$202$qvariant_clone(::QVariant const &variant, ::QVariant *return$) noexcept {
  ::QVariant (*qvariant_clone$)(::QVariant const &) = ::rust::cxxqtlib1::construct;
  new (return$) ::QVariant(qvariant_clone$(variant));
}

bool rust$cxxqtlib1$cxxbridge1$202$qvariant_eq(::QVariant const &a, ::QVariant const &b) noexcept {
  bool (*qvariant_eq$)(::QVariant const &, ::QVariant const &) = ::rust::cxxqtlib1::operatorEq;
  return qvariant_eq$(a, b);
}

void rust$cxxqtlib1$cxxbridge1$202$qvariant_to_debug_qstring(::QVariant const &variant, ::QString *return$) noexcept {
