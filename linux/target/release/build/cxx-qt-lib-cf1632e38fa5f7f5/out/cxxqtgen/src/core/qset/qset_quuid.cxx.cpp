...
extern "C" {
void cxxbridge1$202$QSet_QUuid$cxx_clear(::QSet_QUuid &self) noexcept {
  void (::QSet_QUuid::*cxx_clear$)() = &::QSet_QUuid::clear;
  (self.*cxx_clear$)();
}

bool cxxbridge1$202$QSet_QUuid$cxx_contains(::QSet_QUuid const &self, ::QUuid const &arg0) noexcept {
  bool (::QSet_QUuid::*cxx_contains$)(::QUuid const &) const = &::QSet_QUuid::contains;
  return (self.*cxx_contains$)(arg0);
}

bool cxxbridge1$202$QSet_QUuid$cxx_remove(::QSet_QUuid &self, ::QUuid const &arg0) noexcept {
...
namespace cxxqtlib1 {
extern "C" {
void rust$cxxqtlib1$cxxbridge1$202$qset_clone_QUuid(::QSet_QUuid const &arg0, ::QSet_QUuid *return$) noexcept {
  ::QSet_QUuid (*qset_clone_QUuid$)(::QSet_QUuid const &) = ::rust::cxxqtlib1::construct;
  new (return$) ::QSet_QUuid(qset_clone_QUuid$(arg0));
}

void rust$cxxqtlib1$cxxbridge1$202$qset_default_QUuid(::QSet_QUuid *return$) noexcept {
  ::QSet_QUuid (*qset_default_QUuid$)() = ::rust::cxxqtlib1::construct;
  new (return$) ::QSet_QUuid(qset_default_QUuid$());
}

void rust$cxxqtlib1$cxxbridge1$202$qset_drop_QUuid(::QSet_QUuid &arg0) noexcept {
...
namespace qset {
extern "C" {
void rust$cxxqtlib1$qset$cxxbridge1$202$get_unchecked_QUuid(::QSet_QUuid const &set, ::rust::isize pos, ::QUuid const **return$) noexcept {
...
void rust$cxxqtlib1$qset$cxxbridge1$202$insert_QUuid(::QSet_QUuid &arg0, ::QUuid const &arg1) noexcept {
  void (*insert_QUuid$)(::QSet_QUuid &, ::QUuid const &) = ::rust::cxxqtlib1::qset::qsetInsert;
  insert_QUuid$(arg0, arg1);
}

::rust::isize rust$cxxqtlib1$qset$cxxbridge1$202$len_QUuid(::QSet_QUuid const &arg0) noexcept {
  ::rust::isize (*len_QUuid$)(::QSet_QUuid const &) = ::rust::cxxqtlib1::qset::qsetLen;
  return len_QUuid$(arg0);
}

void rust$cxxqtlib1$qset$cxxbridge1$202$reserve_QUuid(::QSet_QUuid &arg0, ::rust::isize size) noexcept {
