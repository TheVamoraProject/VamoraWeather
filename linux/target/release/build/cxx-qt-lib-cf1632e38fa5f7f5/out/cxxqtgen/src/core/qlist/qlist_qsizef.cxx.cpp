...
extern "C" {
void cxxbridge1$202$QList_QSizeF$cxx_clear(::QList_QSizeF &self) noexcept {
  void (::QList_QSizeF::*cxx_clear$)() = &::QList_QSizeF::clear;
  (self.*cxx_clear$)();
}

bool cxxbridge1$202$QList_QSizeF$cxx_contains(::QList_QSizeF const &self, ::QSizeF const &arg0) noexcept {
...
namespace cxxqtlib1 {
extern "C" {
void rust$cxxqtlib1$cxxbridge1$202$qlist_clone_QSizeF(::QList_QSizeF const &arg0, ::QList_QSizeF *return$) noexcept {
...
void rust$cxxqtlib1$cxxbridge1$202$qlist_default_QSizeF(::QList_QSizeF *return$) noexcept {
  ::QList_QSizeF (*qlist_default_QSizeF$)() = ::rust::cxxqtlib1::construct;
  new (return$) ::QList_QSizeF(qlist_default_QSizeF$());
}

void rust$cxxqtlib1$cxxbridge1$202$qlist_drop_QSizeF(::QList_QSizeF &arg0) noexcept {
...
namespace qlist {
extern "C" {
void rust$cxxqtlib1$qlist$cxxbridge1$202$reserve_QSizeF(::QList_QSizeF &arg0, ::rust::isize size) noexcept {
  void (*reserve_QSizeF$)(::QList_QSizeF &, ::rust::isize) = ::rust::cxxqtlib1::qlist::qlistReserve;
  reserve_QSizeF$(arg0, size);
}

void rust$cxxqtlib1$qlist$cxxbridge1$202$append_QSizeF(::QList_QSizeF &arg0, ::QSizeF const &arg1) noexcept {
  void (*append_QSizeF$)(::QList_QSizeF &, ::QSizeF const &) = ::rust::cxxqtlib1::qlist::qlistAppend;
  append_QSizeF$(arg0, arg1);
}

void rust$cxxqtlib1$qlist$cxxbridge1$202$get_unchecked_QSizeF(::QList_QSizeF const &set, ::rust::isize pos, ::QSizeF const **return$) noexcept {
...
::rust::isize rust$cxxqtlib1$qlist$cxxbridge1$202$index_of_QSizeF(::QList_QSizeF const &arg0, ::QSizeF const &arg1) noexcept {
...
void rust$cxxqtlib1$qlist$cxxbridge1$202$insert_QSizeF(::QList_QSizeF &arg0, ::rust::isize arg1, ::QSizeF const &arg2) noexcept {
  void (*insert_QSizeF$)(::QList_QSizeF &, ::rust::isize, ::QSizeF const &) = ::rust::cxxqtlib1::qlist::qlistInsert;
  insert_QSizeF$(arg0, arg1, arg2);
}

void rust$cxxqtlib1$qlist$cxxbridge1$202$remove_QSizeF(::QList_QSizeF &arg0, ::rust::isize arg1) noexcept {
  void (*remove_QSizeF$)(::QList_QSizeF &, ::rust::isize) = ::rust::cxxqtlib1::qlist::qlistRemove;
  remove_QSizeF$(arg0, arg1);
}

::rust::isize rust$cxxqtlib1$qlist$cxxbridge1$202$len_QSizeF(::QList_QSizeF const &arg0) noexcept {
