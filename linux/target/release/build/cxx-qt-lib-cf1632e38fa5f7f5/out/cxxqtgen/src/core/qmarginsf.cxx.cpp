...
extern "C" {
double cxxbridge1$202$QMarginsF$bottom(::QMarginsF const &self) noexcept {
  double (::QMarginsF::*bottom$)() const = &::QMarginsF::bottom;
  return (self.*bottom$)();
}

bool cxxbridge1$202$QMarginsF$is_null(::QMarginsF const &self) noexcept {
  bool (::QMarginsF::*is_null$)() const = &::QMarginsF::isNull;
  return (self.*is_null$)();
}

double cxxbridge1$202$QMarginsF$left(::QMarginsF const &self) noexcept {
  double (::QMarginsF::*left$)() const = &::QMarginsF::left;
  return (self.*left$)();
}

double cxxbridge1$202$QMarginsF$right(::QMarginsF const &self) noexcept {
  double (::QMarginsF::*right$)() const = &::QMarginsF::right;
  return (self.*right$)();
}

void cxxbridge1$202$QMarginsF$set_bottom(::QMarginsF &self, double abottom) noexcept {
  void (::QMarginsF::*set_bottom$)(double) = &::QMarginsF::setBottom;
  (self.*set_bottom$)(abottom);
}

void cxxbridge1$202$QMarginsF$set_left(::QMarginsF &self, double aleft) noexcept {
  void (::QMarginsF::*set_left$)(double) = &::QMarginsF::setLeft;
  (self.*set_left$)(aleft);
}

void cxxbridge1$202$QMarginsF$set_right(::QMarginsF &self, double aright) noexcept {
  void (::QMarginsF::*set_right$)(double) = &::QMarginsF::setRight;
  (self.*set_right$)(aright);
}

void cxxbridge1$202$QMarginsF$set_top(::QMarginsF &self, double atop) noexcept {
  void (::QMarginsF::*set_top$)(double) = &::QMarginsF::setTop;
  (self.*set_top$)(atop);
}

void cxxbridge1$202$QMarginsF$to_margins(::QMarginsF const &self, ::QMargins *return$) noexcept {
  ::QMargins (::QMarginsF::*to_margins$)() const = &::QMarginsF::toMargins;
  new (return$) ::QMargins((self.*to_margins$)());
}

double cxxbridge1$202$QMarginsF$top(::QMarginsF const &self) noexcept {
...
namespace cxxqtlib1 {
extern "C" {
void rust$cxxqtlib1$cxxbridge1$202$qmarginsf_default(::QMarginsF *return$) noexcept {
  ::QMarginsF (*qmarginsf_default$)() = ::rust::cxxqtlib1::construct;
  new (return$) ::QMarginsF(qmarginsf_default$());
}

void rust$cxxqtlib1$cxxbridge1$202$qmarginsf_from_qmargin(::QMargins const &margins, ::QMarginsF *return$) noexcept {
...
void rust$cxxqtlib1$cxxbridge1$202$qmarginsf_new(double left, double top, double right, double bottom, ::QMarginsF *return$) noexcept {
...
void rust$cxxqtlib1$cxxbridge1$202$qmarginsf_to_debug_qstring(::QMarginsF const &value, ::QString *return$) noexcept {
...
void rust$cxxqtlib1$cxxbridge1$202$qmarginsf_plus(::QMarginsF const &a, ::QMarginsF const &b, ::QMarginsF *return$) noexcept {
...
void rust$cxxqtlib1$cxxbridge1$202$qmarginsf_plus_f64(::QMarginsF const &a, double const &b, ::QMarginsF *return$) noexcept {
...
void rust$cxxqtlib1$cxxbridge1$202$qmarginsf_minus(::QMarginsF const &a, ::QMarginsF const &b, ::QMarginsF *return$) noexcept {
...
void rust$cxxqtlib1$cxxbridge1$202$qmarginsf_minus_f64(::QMarginsF const &a, double const &b, ::QMarginsF *return$) noexcept {
...
void rust$cxxqtlib1$cxxbridge1$202$qmarginsf_mul(double a, ::QMarginsF const &b, ::QMarginsF *return$) noexcept {
  ::QMarginsF (*qmarginsf_mul$)(double, ::QMarginsF const &) = ::rust::cxxqtlib1::operatorMul;
  new (return$) ::QMarginsF(qmarginsf_mul$(a, b));
}

void rust$cxxqtlib1$cxxbridge1$202$qmarginsf_div(double a, ::QMarginsF const &b, ::QMarginsF *return$) noexcept {
