...
extern "C" {
bool cxxbridge1$202$QImage$all_gray(::QImage const &self) noexcept {
  bool (::QImage::*all_gray$)() const = &::QImage::allGray;
  return (self.*all_gray$)();
}

::std::int32_t cxxbridge1$202$QImage$bit_plane_count(::QImage const &self) noexcept {
  ::std::int32_t (::QImage::*bit_plane_count$)() const = &::QImage::bitPlaneCount;
  return (self.*bit_plane_count$)();
}

void cxxbridge1$202$QImage$copy(::QImage const &self, ::QRect const &rectangle, ::QImage *return$) noexcept {
  ::QImage (::QImage::*copy$)(::QRect const &) const = &::QImage::copy;
  new (return$) ::QImage((self.*copy$)(rectangle));
}

void cxxbridge1$202$QImage$create_heuristic_mask(::QImage const &self, bool clip_tight, ::QImage *return$) noexcept {
...
::std::int32_t cxxbridge1$202$QImage$color_count(::QImage const &self) noexcept {
  ::std::int32_t (::QImage::*color_count$)() const = &::QImage::colorCount;
  return (self.*color_count$)();
}

::std::int32_t cxxbridge1$202$QImage$depth(::QImage const &self) noexcept {
  ::std::int32_t (::QImage::*depth$)() const = &::QImage::depth;
  return (self.*depth$)();
}

void cxxbridge1$202$QImage$device_independent_size(::QImage const &self, ::QSizeF *return$) noexcept {
  ::QSizeF (::QImage::*device_independent_size$)() const = &::QImage::deviceIndependentSize;
  new (return$) ::QSizeF((self.*device_independent_size$)());
}

::std::int32_t cxxbridge1$202$QImage$dots_per_meter_x(::QImage const &self) noexcept {
  ::std::int32_t (::QImage::*dots_per_meter_x$)() const = &::QImage::dotsPerMeterX;
  return (self.*dots_per_meter_x$)();
}

::std::int32_t cxxbridge1$202$QImage$dots_per_meter_y(::QImage const &self) noexcept {
  ::std::int32_t (::QImage::*dots_per_meter_y$)() const = &::QImage::dotsPerMeterY;
  return (self.*dots_per_meter_y$)();
}

void cxxbridge1$202$QImage$fill(::QImage &self, ::QColor const &color) noexcept {
  void (::QImage::*fill$)(::QColor const &) = &::QImage::fill;
  (self.*fill$)(color);
}

::rust::cxxqtlib1::QImageFormat cxxbridge1$202$QImage$format(::QImage const &self) noexcept {
  ::rust::cxxqtlib1::QImageFormat (::QImage::*format$)() const = &::QImage::format;
  return (self.*format$)();
}

void cxxbridge1$202$QImage$invert_pixels(::QImage &self, ::rust::cxxqtlib1::QImageInvertMode mode) noexcept {
  void (::QImage::*invert_pixels$)(::rust::cxxqtlib1::QImageInvertMode) = &::QImage::invertPixels;
  (self.*invert_pixels$)(mode);
}

bool cxxbridge1$202$QImage$is_null(::QImage const &self) noexcept {
  bool (::QImage::*is_null$)() const = &::QImage::isNull;
  return (self.*is_null$)();
}

bool cxxbridge1$202$QImage$is_gray_scale(::QImage const &self) noexcept {
  bool (::QImage::*is_gray_scale$)() const = &::QImage::isGrayscale;
  return (self.*is_gray_scale$)();
}

bool cxxbridge1$202$QImage$has_alpha_channel(::QImage const &self) noexcept {
  bool (::QImage::*has_alpha_channel$)() const = &::QImage::hasAlphaChannel;
  return (self.*has_alpha_channel$)();
}

::std::int32_t cxxbridge1$202$QImage$height(::QImage const &self) noexcept {
  ::std::int32_t (::QImage::*height$)() const = &::QImage::height;
  return (self.*height$)();
}

void cxxbridge1$202$QImage$mirror(::QImage &self, bool horizontal, bool vertical) noexcept {
  void (::QImage::*mirror$)(bool, bool) = &::QImage::mirror;
  (self.*mirror$)(horizontal, vertical);
}

void cxxbridge1$202$QImage$rgb_swap(::QImage &self) noexcept {
  void (::QImage::*rgb_swap$)() = &::QImage::rgbSwap;
  (self.*rgb_swap$)();
}

void cxxbridge1$202$QImage$rect(::QImage const &self, ::QRect *return$) noexcept {
  ::QRect (::QImage::*rect$)() const = &::QImage::rect;
  new (return$) ::QRect((self.*rect$)());
}

void cxxbridge1$202$QImage$scaled(::QImage const &self, ::std::int32_t width, ::std::int32_t height, ::Qt::AspectRatioMode *aspect_ratio_mode, ::Qt::TransformationMode *transform_mode, ::QImage *return$) noexcept {
...
void cxxbridge1$202$QImage$scaled_to_height(::QImage const &self, ::std::int32_t height, ::Qt::TransformationMode *mode, ::QImage *return$) noexcept {
...
void cxxbridge1$202$QImage$scaled_to_width(::QImage const &self, ::std::int32_t width, ::Qt::TransformationMode *mode, ::QImage *return$) noexcept {
...
void cxxbridge1$202$QImage$set_color_count(::QImage &self, ::std::int32_t color_count) noexcept {
  void (::QImage::*set_color_count$)(::std::int32_t) = &::QImage::setColorCount;
  (self.*set_color_count$)(color_count);
}

void cxxbridge1$202$QImage$set_alpha_channel(::QImage &self, ::QImage const &alpha_channel) noexcept {
  void (::QImage::*set_alpha_channel$)(::QImage const &) = &::QImage::setAlphaChannel;
  (self.*set_alpha_channel$)(alpha_channel);
}

void cxxbridge1$202$QImage$set_dots_per_meter_x(::QImage &self, ::std::int32_t x) noexcept {
  void (::QImage::*set_dots_per_meter_x$)(::std::int32_t) = &::QImage::setDotsPerMeterX;
  (self.*set_dots_per_meter_x$)(x);
}

void cxxbridge1$202$QImage$set_dots_per_meter_y(::QImage &self, ::std::int32_t y) noexcept {
  void (::QImage::*set_dots_per_meter_y$)(::std::int32_t) = &::QImage::setDotsPerMeterY;
  (self.*set_dots_per_meter_y$)(y);
}

void cxxbridge1$202$QImage$set_offset(::QImage &self, ::QPoint const &offset) noexcept {
  void (::QImage::*set_offset$)(::QPoint const &) = &::QImage::setOffset;
  (self.*set_offset$)(offset);
}

void cxxbridge1$202$QImage$set_pixel_color(::QImage &self, ::std::int32_t x, ::std::int32_t y, ::QColor const &color) noexcept {
  void (::QImage::*set_pixel_color$)(::std::int32_t, ::std::int32_t, ::QColor const &) = &::QImage::setPixelColor;
  (self.*set_pixel_color$)(x, y, color);
}

void cxxbridge1$202$QImage$size(::QImage const &self, ::QSize *return$) noexcept {
  ::QSize (::QImage::*size$)() const = &::QImage::size;
  new (return$) ::QSize((self.*size$)());
}

void cxxbridge1$202$QImage$swap(::QImage &self, ::QImage &other) noexcept {
  void (::QImage::*swap$)(::QImage &) = &::QImage::swap;
  (self.*swap$)(other);
}

bool cxxbridge1$202$QImage$reinterpret_as_format(::QImage &self, ::rust::cxxqtlib1::QImageFormat format) noexcept {
...
void cxxbridge1$202$QImage$offset(::QImage const &self, ::QPoint *return$) noexcept {
  ::QPoint (::QImage::*offset$)() const = &::QImage::offset;
  new (return$) ::QPoint((self.*offset$)());
}

void cxxbridge1$202$QImage$pixel_color(::QImage const &self, ::std::int32_t x, ::std::int32_t y, ::QColor *return$) noexcept {
  ::QColor (::QImage::*pixel_color$)(::std::int32_t, ::std::int32_t) const = &::QImage::pixelColor;
  new (return$) ::QColor((self.*pixel_color$)(x, y));
}

::std::int32_t cxxbridge1$202$QImage$pixel_index(::QImage const &self, ::std::int32_t x, ::std::int32_t y) noexcept {
  ::std::int32_t (::QImage::*pixel_index$)(::std::int32_t, ::std::int32_t) const = &::QImage::pixelIndex;
  return (self.*pixel_index$)(x, y);
}

bool cxxbridge1$202$QImage$valid(::QImage const &self, ::std::int32_t x, ::std::int32_t y) noexcept {
  bool (::QImage::*valid$)(::std::int32_t, ::std::int32_t) const = &::QImage::valid;
  return (self.*valid$)(x, y);
}

::std::int32_t cxxbridge1$202$QImage$width(::QImage const &self) noexcept {
...
namespace cxxqtlib1 {
extern "C" {
void rust$cxxqtlib1$cxxbridge1$202$qimage_init_default(::QImage *return$) noexcept {
  ::QImage (*qimage_init_default$)() = ::rust::cxxqtlib1::construct;
  new (return$) ::QImage(qimage_init_default$());
}

void rust$cxxqtlib1$cxxbridge1$202$qimage_init_from_width_and_height_and_image_format(::std::int32_t width, ::std::int32_t height, ::rust::cxxqtlib1::QImageFormat format, ::QImage *return$) noexcept {
...
void rust$cxxqtlib1$cxxbridge1$202$qimage_drop(::QImage &image) noexcept {
  void (*qimage_drop$)(::QImage &) = ::rust::cxxqtlib1::drop;
  qimage_drop$(image);
}

void rust$cxxqtlib1$cxxbridge1$202$qimage_init_from_data(::rust::Slice<::std::uint8_t const> data, ::rust::Str format, ::QImage *return$) noexcept {
...
::std::int64_t rust$cxxqtlib1$cxxbridge1$202$qimage_cache_key(::QImage const &image) noexcept {
  ::std::int64_t (*qimage_cache_key$)(::QImage const &) = ::rust::cxxqtlib1::qimageCacheKey;
  return qimage_cache_key$(image);
}

bool rust$cxxqtlib1$cxxbridge1$202$qimage_eq(::QImage const &a, ::QImage const &b) noexcept {
  bool (*qimage_eq$)(::QImage const &, ::QImage const &) = ::rust::cxxqtlib1::operatorEq;
  return qimage_eq$(a, b);
}

void rust$cxxqtlib1$cxxbridge1$202$qimage_to_debug_qstring(::QImage const &image, ::QString *return$) noexcept {
...
void rust$cxxqtlib1$cxxbridge1$202$qimage_init_from_raw_parts_mut(::std::uint8_t *data, ::std::int32_t width, ::std::int32_t height, ::rust::cxxqtlib1::QImageFormat format, ::QImageCleanupFunction *cleanup_function, ::rust::cxxqtlib1::c_void *cleanup_info, ::QImage *return$) noexcept {
  ::QImage (*qimage_init_from_raw_parts_mut$)(::std::uint8_t *, ::std::int32_t, ::std::int32_t, ::rust::cxxqtlib1::QImageFormat, ::QImageCleanupFunction, ::rust::cxxqtlib1::c_void *) = ::rust::cxxqtlib1::qimageInitFromRawParts;
  new (return$) ::QImage(qimage_init_from_raw_parts_mut$(data, width, height, format, ::std::move(*cleanup_function), cleanup_info));
}

void rust$cxxqtlib1$cxxbridge1$202$qimage_init_from_raw_parts(::std::uint8_t const *data, ::std::int32_t width, ::std::int32_t height, ::rust::cxxqtlib1::QImageFormat format, ::QImageCleanupFunction *cleanup_function, ::rust::cxxqtlib1::c_void *cleanup_info, ::QImage *return$) noexcept {
  ::QImage (*qimage_init_from_raw_parts$)(::std::uint8_t const *, ::std::int32_t, ::std::int32_t, ::rust::cxxqtlib1::QImageFormat, ::QImageCleanupFunction, ::rust::cxxqtlib1::c_void *) = ::rust::cxxqtlib1::qimageInitFromRawParts;
