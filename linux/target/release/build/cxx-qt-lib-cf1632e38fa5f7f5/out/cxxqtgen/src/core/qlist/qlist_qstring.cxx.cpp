...
extern "C" {
void cxxbridge1$202$QList_QString$cxx_clear(::QList_QString &self) noexcept {
  void (::QList_QString::*cxx_clear$)() = &::QList_QString::clear;
  (self.*cxx_clear$)();
}

bool cxxbridge1$202$QList_QString$cxx_contains(::QList_QString const &self, ::QString const &arg0) noexcept {
...
namespace cxxqtlib1 {
extern "C" {
void rust$cxxqtlib1$cxxbridge1$202$qlist_clone_QString(::QList_QString const &arg0, ::QList_QString *return$) noexcept {
...
void rust$cxxqtlib1$cxxbridge1$202$qlist_default_QString(::QList_QString *return$) noexcept {
  ::QList_QString (*qlist_default_QString$)() = ::rust::cxxqtlib1::construct;
  new (return$) ::QList_QString(qlist_default_QString$());
}

void rust$cxxqtlib1$cxxbridge1$202$qlist_drop_QString(::QList_QString &arg0) noexcept {
...
namespace qlist {
extern "C" {
void rust$cxxqtlib1$qlist$cxxbridge1$202$reserve_QString(::QList_QString &arg0, ::rust::isize size) noexcept {
  void (*reserve_QString$)(::QList_QString &, ::rust::isize) = ::rust::cxxqtlib1::qlist::qlistReserve;
  reserve_QString$(arg0, size);
}

void rust$cxxqtlib1$qlist$cxxbridge1$202$append_QString(::QList_QString &arg0, ::QString const &arg1) noexcept {
  void (*append_QString$)(::QList_QString &, ::QString const &) = ::rust::cxxqtlib1::qlist::qlistAppend;
  append_QString$(arg0, arg1);
}

void rust$cxxqtlib1$qlist$cxxbridge1$202$get_unchecked_QString(::QList_QString const &set, ::rust::isize pos, ::QString const **return$) noexcept {
...
::rust::isize rust$cxxqtlib1$qlist$cxxbridge1$202$index_of_QString(::QList_QString const &arg0, ::QString const &arg1) noexcept {
...
void rust$cxxqtlib1$qlist$cxxbridge1$202$insert_QString(::QList_QString &arg0, ::rust::isize arg1, ::QString const &arg2) noexcept {
  void (*insert_QString$)(::QList_QString &, ::rust::isize, ::QString const &) = ::rust::cxxqtlib1::qlist::qlistInsert;
  insert_QString$(arg0, arg1, arg2);
}

void rust$cxxqtlib1$qlist$cxxbridge1$202$remove_QString(::QList_QString &arg0, ::rust::isize arg1) noexcept {
  void (*remove_QString$)(::QList_QString &, ::rust::isize) = ::rust::cxxqtlib1::qlist::qlistRemove;
  remove_QString$(arg0, arg1);
}

::rust::isize rust$cxxqtlib1$qlist$cxxbridge1$202$len_QString(::QList_QString const &arg0) noexcept {
