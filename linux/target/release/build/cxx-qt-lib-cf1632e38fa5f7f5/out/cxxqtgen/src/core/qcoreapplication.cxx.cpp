...
namespace cxxqtlib1 {
extern "C" {
::QCoreApplication *rust$cxxqtlib1$cxxbridge1$202$qcoreapplication_new(::QVector_QByteArray const &args) noexcept {
...
void rust$cxxqtlib1$cxxbridge1$202$qcoreapplication_add_library_path(::QCoreApplication &app, ::QString const &path) noexcept {
...
void rust$cxxqtlib1$cxxbridge1$202$qcoreapplication_application_name(::QCoreApplication const &app, ::QString *return$) noexcept {
...
void rust$cxxqtlib1$cxxbridge1$202$qcoreapplication_application_version(::QCoreApplication const &app, ::QString *return$) noexcept {
...
::std::int32_t rust$cxxqtlib1$cxxbridge1$202$qcoreapplication_exec(::QCoreApplication &app) noexcept {
  ::std::int32_t (*qcoreapplication_exec$)(::QCoreApplication &) = ::rust::cxxqtlib1::qapplicationExec;
  return qcoreapplication_exec$(app);
}

void rust$cxxqtlib1$cxxbridge1$202$qcoreapplication_library_paths(::QCoreApplication const &app, ::QStringList *return$) noexcept {
...
void rust$cxxqtlib1$cxxbridge1$202$qcoreapplication_organization_domain(::QCoreApplication const &app, ::QString *return$) noexcept {
...
void rust$cxxqtlib1$cxxbridge1$202$qcoreapplication_organization_name(::QCoreApplication const &app, ::QString *return$) noexcept {
...
void rust$cxxqtlib1$cxxbridge1$202$qcoreapplication_remove_library_path(::QCoreApplication const &app, ::QString const &path) noexcept {
...
void rust$cxxqtlib1$cxxbridge1$202$qcoreapplication_set_application_name(::QCoreApplication &app, ::QString const &name) noexcept {
...
void rust$cxxqtlib1$cxxbridge1$202$qcoreapplication_set_application_version(::QCoreApplication &app, ::QString const &version) noexcept {
...
void rust$cxxqtlib1$cxxbridge1$202$qcoreapplication_set_library_paths(::QCoreApplication &app, ::QStringList const &paths) noexcept {
...
void rust$cxxqtlib1$cxxbridge1$202$qcoreapplication_set_organization_domain(::QCoreApplication &app, ::QString const &domain) noexcept {
...
void rust$cxxqtlib1$cxxbridge1$202$qcoreapplication_set_organization_name(::QCoreApplication &app, ::QString const &name) noexcept {
...
namespace cxxqtgen1 {
extern "C" {
void rust$cxxqtgen1$cxxbridge1$202$QCoreApplication_connect_about_to_quit(::QCoreApplication &self_value, ::rust::cxxqtgen1::QCoreApplicationCxxQtSignalHandleraboutToQuit *signal_handler, ::Qt::ConnectionType *conn_type, ::rust::cxxqt1::QMetaObjectConnection *return$) noexcept {
...
void rust$cxxqtgen1$cxxbridge1$202$drop_QCoreApplication_signal_handler_aboutToQuit(::rust::cxxqtgen1::QCoreApplicationCxxQtSignalHandleraboutToQuit *handler) noexcept;

void rust$cxxqtgen1$cxxbridge1$202$call_QCoreApplication_signal_handler_aboutToQuit(::rust::cxxqtgen1::QCoreApplicationCxxQtSignalHandleraboutToQuit &handler, ::QCoreApplication &self_value) noexcept;
} // extern "C"
...
void drop_QCoreApplication_signal_handler_aboutToQuit(::rust::cxxqtgen1::QCoreApplicationCxxQtSignalHandleraboutToQuit handler) noexcept {
  ...
  rust$cxxqtgen1$cxxbridge1$202$drop_QCoreApplication_signal_handler_aboutToQuit(&handler$.value);
}
...
void call_QCoreApplication_signal_handler_aboutToQuit(::rust::cxxqtgen1::QCoreApplicationCxxQtSignalHandleraboutToQuit &handler, ::QCoreApplication &self_value) noexcept {
  rust$cxxqtgen1$cxxbridge1$202$call_QCoreApplication_signal_handler_aboutToQuit(handler, self_value);
}
} // namespace cxxqtgen1
} // namespace rust
