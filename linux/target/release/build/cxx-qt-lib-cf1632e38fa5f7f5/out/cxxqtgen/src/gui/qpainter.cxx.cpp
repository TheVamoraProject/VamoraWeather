...
extern "C" {
void cxxbridge1$202$QPainter$background_mode(::QPainter const &self, ::Qt::BGMode *return$) noexcept {
  ::Qt::BGMode (::QPainter::*background_mode$)() const = &::QPainter::backgroundMode;
  new (return$) ::Qt::BGMode((self.*background_mode$)());
}

void cxxbridge1$202$QPainter$brush_origin(::QPainter const &self, ::QPoint *return$) noexcept {
  ::QPoint (::QPainter::*brush_origin$)() const = &::QPainter::brushOrigin;
  new (return$) ::QPoint((self.*brush_origin$)());
}

void cxxbridge1$202$QPainter$clip_bounding_rect_or_empty(::QPainter const &self, ::QRectF *return$) noexcept {
...
void cxxbridge1$202$QPainter$clip_path(::QPainter const &self, ::QPainterPath *return$) noexcept {
  ::QPainterPath (::QPainter::*clip_path$)() const = &::QPainter::clipPath;
  new (return$) ::QPainterPath((self.*clip_path$)());
}

void cxxbridge1$202$QPainter$clip_region(::QPainter const &self, ::QRegion *return$) noexcept {
  ::QRegion (::QPainter::*clip_region$)() const = &::QPainter::clipRegion;
  new (return$) ::QRegion((self.*clip_region$)());
}

::rust::cxxqtlib1::QPainterCompositionMode cxxbridge1$202$QPainter$composition_mode(::QPainter const &self) noexcept {
...
void cxxbridge1$202$QPainter$draw_arc(::QPainter &self, ::std::int32_t x, ::std::int32_t y, ::std::int32_t width, ::std::int32_t height, ::std::int32_t start_angle, ::std::int32_t span_angle) noexcept {
...
void cxxbridge1$202$QPainter$draw_chord(::QPainter &self, ::QRect const &rectangle, ::std::int32_t start_angle, ::std::int32_t span_angle) noexcept {
...
void cxxbridge1$202$QPainter$draw_convex_polygon(::QPainter &self, ::QPolygon const &polygon) noexcept {
  void (::QPainter::*draw_convex_polygon$)(::QPolygon const &) = &::QPainter::drawConvexPolygon;
  (self.*draw_convex_polygon$)(polygon);
}

void cxxbridge1$202$QPainter$draw_ellipse(::QPainter &self, ::QRect const &rectangle) noexcept {
  void (::QPainter::*draw_ellipse$)(::QRect const &) = &::QPainter::drawEllipse;
  (self.*draw_ellipse$)(rectangle);
}

void cxxbridge1$202$QPainter$draw_image(::QPainter &self, ::QRect const &rectangle, ::QImage const &image) noexcept {
  void (::QPainter::*draw_image$)(::QRect const &, ::QImage const &) = &::QPainter::drawImage;
  (self.*draw_image$)(rectangle, image);
}

void cxxbridge1$202$QPainter$draw_line(::QPainter &self, ::QLine const &line) noexcept {
  void (::QPainter::*draw_line$)(::QLine const &) = &::QPainter::drawLine;
  (self.*draw_line$)(line);
}

void cxxbridge1$202$QPainter$draw_linef(::QPainter &self, ::QLineF const &line) noexcept {
  void (::QPainter::*draw_linef$)(::QLineF const &) = &::QPainter::drawLine;
  (self.*draw_linef$)(line);
}

void cxxbridge1$202$QPainter$draw_lines(::QPainter &self, ::QVector_QLine const &lines) noexcept {
  void (::QPainter::*draw_lines$)(::QVector_QLine const &) = &::QPainter::drawLines;
  (self.*draw_lines$)(lines);
}

void cxxbridge1$202$QPainter$draw_linefs(::QPainter &self, ::QVector_QLineF const &lines) noexcept {
  void (::QPainter::*draw_linefs$)(::QVector_QLineF const &) = &::QPainter::drawLines;
  (self.*draw_linefs$)(lines);
}

void cxxbridge1$202$QPainter$draw_path(::QPainter &self, ::QPainterPath const &path) noexcept {
  void (::QPainter::*draw_path$)(::QPainterPath const &) = &::QPainter::drawPath;
  (self.*draw_path$)(path);
}

void cxxbridge1$202$QPainter$draw_pie(::QPainter &self, ::QRectF const &rectangle, ::std::int32_t start_angle, ::std::int32_t span_angle) noexcept {
...
void cxxbridge1$202$QPainter$draw_point(::QPainter &self, ::QPoint const &point) noexcept {
  void (::QPainter::*draw_point$)(::QPoint const &) = &::QPainter::drawPoint;
  (self.*draw_point$)(point);
}

void cxxbridge1$202$QPainter$draw_points(::QPainter &self, ::QPolygon const &points) noexcept {
  void (::QPainter::*draw_points$)(::QPolygon const &) = &::QPainter::drawPoints;
  (self.*draw_points$)(points);
}

void cxxbridge1$202$QPainter$draw_polygon(::QPainter &self, ::QPolygon const &points, ::Qt::FillRule *fill_rule) noexcept {
  void (::QPainter::*draw_polygon$)(::QPolygon const &, ::Qt::FillRule) = &::QPainter::drawPolygon;
  (self.*draw_polygon$)(points, ::std::move(*fill_rule));
}

void cxxbridge1$202$QPainter$draw_polyline(::QPainter &self, ::QPolygon const &points) noexcept {
  void (::QPainter::*draw_polyline$)(::QPolygon const &) = &::QPainter::drawPolyline;
  (self.*draw_polyline$)(points);
}

void cxxbridge1$202$QPainter$draw_rect_f(::QPainter &self, ::QRectF const &rectangle) noexcept {
  void (::QPainter::*draw_rect_f$)(::QRectF const &) = &::QPainter::drawRect;
  (self.*draw_rect_f$)(rectangle);
}

void cxxbridge1$202$QPainter$draw_rounded_rect(::QPainter &self, ::QRectF const &rect, double x_radiu, double y_radius, ::Qt::SizeMode *mode) noexcept {
...
void cxxbridge1$202$QPainter$draw_text(::QPainter &self, ::QPoint const &position, ::QString const &text) noexcept {
  void (::QPainter::*draw_text$)(::QPoint const &, ::QString const &) = &::QPainter::drawText;
  (self.*draw_text$)(position, text);
}

void cxxbridge1$202$QPainter$erase_rect(::QPainter &self, ::QRectF const &rectangle) noexcept {
  void (::QPainter::*erase_rect$)(::QRectF const &) = &::QPainter::eraseRect;
  (self.*erase_rect$)(rectangle);
}

void cxxbridge1$202$QPainter$fill_rect(::QPainter &self, ::QRectF const &rectangle, ::QColor const &color) noexcept {
  void (::QPainter::*fill_rect$)(::QRectF const &, ::QColor const &) = &::QPainter::fillRect;
  (self.*fill_rect$)(rectangle, color);
}

void cxxbridge1$202$QPainter$font(::QPainter const &self, ::QFont const **return$) noexcept {
  ::QFont const &(::QPainter::*font$)() const = &::QPainter::font;
  new (return$) ::QFont const *(&(self.*font$)());
}

bool cxxbridge1$202$QPainter$has_clipping(::QPainter const &self) noexcept {
  bool (::QPainter::*has_clipping$)() const = &::QPainter::hasClipping;
  return (self.*has_clipping$)();
}

bool cxxbridge1$202$QPainter$is_active(::QPainter const &self) noexcept {
  bool (::QPainter::*is_active$)() const = &::QPainter::isActive;
  return (self.*is_active$)();
}

void cxxbridge1$202$QPainter$layout_direction(::QPainter const &self, ::Qt::LayoutDirection *return$) noexcept {
...
double cxxbridge1$202$QPainter$opacity(::QPainter const &self) noexcept {
  double (::QPainter::*opacity$)() const = &::QPainter::opacity;
  return (self.*opacity$)();
}

void cxxbridge1$202$QPainter$pen(::QPainter const &self, ::QPen const **return$) noexcept {
  ::QPen const &(::QPainter::*pen$)() const = &::QPainter::pen;
  new (return$) ::QPen const *(&(self.*pen$)());
}

void cxxbridge1$202$QPainter$save(::QPainter &self) noexcept {
  void (::QPainter::*save$)() = &::QPainter::save;
  (self.*save$)();
}

void cxxbridge1$202$QPainter$set_background_mode(::QPainter &self, ::Qt::BGMode *mode) noexcept {
  void (::QPainter::*set_background_mode$)(::Qt::BGMode) = &::QPainter::setBackgroundMode;
  (self.*set_background_mode$)(::std::move(*mode));
}

void cxxbridge1$202$QPainter$set_clipping(::QPainter &self, bool enable) noexcept {
  void (::QPainter::*set_clipping$)(bool) = &::QPainter::setClipping;
  (self.*set_clipping$)(enable);
}

void cxxbridge1$202$QPainter$set_clip_path(::QPainter &self, ::QPainterPath const &path, ::Qt::ClipOperation *operation) noexcept {
...
void cxxbridge1$202$QPainter$set_clip_rect(::QPainter &self, ::QRect const &rectangle, ::Qt::ClipOperation *operation) noexcept {
...
void cxxbridge1$202$QPainter$set_clip_region(::QPainter &self, ::QRegion const &region, ::Qt::ClipOperation *operation) noexcept {
...
void cxxbridge1$202$QPainter$set_composition_mode(::QPainter &self, ::rust::cxxqtlib1::QPainterCompositionMode mode) noexcept {
...
void cxxbridge1$202$QPainter$set_font(::QPainter &self, ::QFont const &font) noexcept {
  void (::QPainter::*set_font$)(::QFont const &) = &::QPainter::setFont;
  (self.*set_font$)(font);
}

void cxxbridge1$202$QPainter$set_layout_direction(::QPainter &self, ::Qt::LayoutDirection *direction) noexcept {
...
void cxxbridge1$202$QPainter$set_opacity(::QPainter &self, double opacity) noexcept {
  void (::QPainter::*set_opacity$)(double) = &::QPainter::setOpacity;
  (self.*set_opacity$)(opacity);
}

void cxxbridge1$202$QPainter$set_pen(::QPainter &self, ::QPen const &pen) noexcept {
  void (::QPainter::*set_pen$)(::QPen const &) = &::QPainter::setPen;
  (self.*set_pen$)(pen);
}

void cxxbridge1$202$QPainter$set_render_hint(::QPainter &self, ::rust::cxxqtlib1::QPainterRenderHint hint, bool on) noexcept {
  void (::QPainter::*set_render_hint$)(::rust::cxxqtlib1::QPainterRenderHint, bool) = &::QPainter::setRenderHint;
  (self.*set_render_hint$)(hint, on);
}

void cxxbridge1$202$QPainter$set_viewport(::QPainter &self, ::QRect const &rectangle) noexcept {
  void (::QPainter::*set_viewport$)(::QRect const &) = &::QPainter::setViewport;
  (self.*set_viewport$)(rectangle);
}

void cxxbridge1$202$QPainter$set_window(::QPainter &self, ::QRect const &rectangle) noexcept {
  void (::QPainter::*set_window$)(::QRect const &) = &::QPainter::setWindow;
  (self.*set_window$)(rectangle);
}

void cxxbridge1$202$QPainter$stroke_path(::QPainter &self, ::QPainterPath const &path, ::QPen const &pen) noexcept {
  void (::QPainter::*stroke_path$)(::QPainterPath const &, ::QPen const &) = &::QPainter::strokePath;
  (self.*stroke_path$)(path, pen);
}

bool cxxbridge1$202$QPainter$test_render_hint(::QPainter const &self, ::rust::cxxqtlib1::QPainterRenderHint hint) noexcept {
...
void cxxbridge1$202$QPainter$restore(::QPainter &self) noexcept {
  void (::QPainter::*restore$)() = &::QPainter::restore;
  (self.*restore$)();
}

void cxxbridge1$202$QPainter$rotate(::QPainter &self, double angle) noexcept {
  void (::QPainter::*rotate$)(double) = &::QPainter::rotate;
  (self.*rotate$)(angle);
}

void cxxbridge1$202$QPainter$translate(::QPainter &self, ::QPoint const &offset) noexcept {
  void (::QPainter::*translate$)(::QPoint const &) = &::QPainter::translate;
  (self.*translate$)(offset);
}

bool cxxbridge1$202$QPainter$view_transform_enabled(::QPainter const &self) noexcept {
  bool (::QPainter::*view_transform_enabled$)() const = &::QPainter::viewTransformEnabled;
  return (self.*view_transform_enabled$)();
}

void cxxbridge1$202$QPainter$viewport(::QPainter const &self, ::QRect *return$) noexcept {
  ::QRect (::QPainter::*viewport$)() const = &::QPainter::viewport;
  new (return$) ::QRect((self.*viewport$)());
}

void cxxbridge1$202$QPainter$window(::QPainter const &self, ::QRect *return$) noexcept {
...
namespace cxxqtlib1 {
extern "C" {
::QPainter *rust$cxxqtlib1$cxxbridge1$202$qpainter_init_default() noexcept {
