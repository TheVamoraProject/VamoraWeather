...
extern "C" {
bool cxxbridge1$202$QObject$block_signals(::QObject &self, bool block) noexcept {
  bool (::QObject::*block_signals$)(bool) = &::QObject::blockSignals;
  return (self.*block_signals$)(block);
}

bool cxxbridge1$202$QObject$signals_blocked(::QObject const &self) noexcept {
  bool (::QObject::*signals_blocked$)() const = &::QObject::signalsBlocked;
  return (self.*signals_blocked$)();
}

void cxxbridge1$202$QObject$set_object_name(::QObject &self, ::QString const &name) noexcept {
  void (::QObject::*set_object_name$)(::QString const &) = &::QObject::setObjectName;
  (self.*set_object_name$)(name);
}

void cxxbridge1$202$QObject$object_name(::QObject const &self, ::QString *return$) noexcept {
  ::QString (::QObject::*object_name$)() const = &::QObject::objectName;
  new (return$) ::QString((self.*object_name$)());
}

::QObject *cxxbridge1$202$QObject$parent(::QObject const &self) noexcept {
  ::QObject *(::QObject::*parent$)() const = &::QObject::parent;
  return (self.*parent$)();
}

void cxxbridge1$202$QObject$set_parent(::QObject &self, ::QObject *parent) noexcept {
