...
extern "C" {
void cxxbridge1$202$QVector_QRectF$cxx_clear(::QVector_QRectF &self) noexcept {
  void (::QVector_QRectF::*cxx_clear$)() = &::QVector_QRectF::clear;
  (self.*cxx_clear$)();
}

bool cxxbridge1$202$QVector_QRectF$cxx_contains(::QVector_QRectF const &self, ::QRectF const &arg0) noexcept {
...
namespace cxxqtlib1 {
extern "C" {
void rust$cxxqtlib1$cxxbridge1$202$qvector_clone_QRectF(::QVector_QRectF const &arg0, ::QVector_QRectF *return$) noexcept {
...
void rust$cxxqtlib1$cxxbridge1$202$qvector_default_QRectF(::QVector_QRectF *return$) noexcept {
  ::QVector_QRectF (*qvector_default_QRectF$)() = ::rust::cxxqtlib1::construct;
  new (return$) ::QVector_QRectF(qvector_default_QRectF$());
}

void rust$cxxqtlib1$cxxbridge1$202$qvector_drop_QRectF(::QVector_QRectF &arg0) noexcept {
...
namespace qvector {
extern "C" {
void rust$cxxqtlib1$qvector$cxxbridge1$202$reserve_QRectF(::QVector_QRectF &arg0, ::rust::isize size) noexcept {
  void (*reserve_QRectF$)(::QVector_QRectF &, ::rust::isize) = ::rust::cxxqtlib1::qvector::qvectorReserve;
  reserve_QRectF$(arg0, size);
}

void rust$cxxqtlib1$qvector$cxxbridge1$202$append_QRectF(::QVector_QRectF &arg0, ::QRectF const &arg1) noexcept {
  void (*append_QRectF$)(::QVector_QRectF &, ::QRectF const &) = ::rust::cxxqtlib1::qvector::qvectorAppend;
  append_QRectF$(arg0, arg1);
}

void rust$cxxqtlib1$qvector$cxxbridge1$202$get_unchecked_QRectF(::QVector_QRectF const &set, ::rust::isize pos, ::QRectF const **return$) noexcept {
...
::rust::isize rust$cxxqtlib1$qvector$cxxbridge1$202$index_of_QRectF(::QVector_QRectF const &arg0, ::QRectF const &arg1) noexcept {
...
void rust$cxxqtlib1$qvector$cxxbridge1$202$insert_QRectF(::QVector_QRectF &arg0, ::rust::isize arg1, ::QRectF const &arg2) noexcept {
...
void rust$cxxqtlib1$qvector$cxxbridge1$202$remove_QRectF(::QVector_QRectF &arg0, ::rust::isize arg1) noexcept {
  void (*remove_QRectF$)(::QVector_QRectF &, ::rust::isize) = ::rust::cxxqtlib1::qvector::qvectorRemove;
  remove_QRectF$(arg0, arg1);
}

::rust::isize rust$cxxqtlib1$qvector$cxxbridge1$202$len_QRectF(::QVector_QRectF const &arg0) noexcept {
