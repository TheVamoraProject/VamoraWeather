...
namespace qvariant {
extern "C" {
bool rust$cxxqtlib1$qvariant$cxxbridge1$202$can_convert_f64(::QVariant const &variant) noexcept {
  bool (*can_convert_f64$)(::QVariant const &) = ::rust::cxxqtlib1::qvariant::qvariantCanConvertF64;
  return can_convert_f64$(variant);
}

void rust$cxxqtlib1$qvariant$cxxbridge1$202$construct_f64(double const &value, ::QVariant *return$) noexcept {
  ::QVariant (*construct_f64$)(double const &) = ::rust::cxxqtlib1::qvariant::qvariantConstruct;
  new (return$) ::QVariant(construct_f64$(value));
}

double rust$cxxqtlib1$qvariant$cxxbridge1$202$value_or_default_f64(::QVariant const &variant) noexcept {
