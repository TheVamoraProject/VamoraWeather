...
extern "C" {
void cxxbridge1$202$QVector_QPoint$cxx_clear(::QVector_QPoint &self) noexcept {
  void (::QVector_QPoint::*cxx_clear$)() = &::QVector_QPoint::clear;
  (self.*cxx_clear$)();
}

bool cxxbridge1$202$QVector_QPoint$cxx_contains(::QVector_QPoint const &self, ::QPoint const &arg0) noexcept {
...
namespace cxxqtlib1 {
extern "C" {
void rust$cxxqtlib1$cxxbridge1$202$qvector_clone_QPoint(::QVector_QPoint const &arg0, ::QVector_QPoint *return$) noexcept {
...
void rust$cxxqtlib1$cxxbridge1$202$qvector_default_QPoint(::QVector_QPoint *return$) noexcept {
  ::QVector_QPoint (*qvector_default_QPoint$)() = ::rust::cxxqtlib1::construct;
  new (return$) ::QVector_QPoint(qvector_default_QPoint$());
}

void rust$cxxqtlib1$cxxbridge1$202$qvector_drop_QPoint(::QVector_QPoint &arg0) noexcept {
...
namespace qvector {
extern "C" {
void rust$cxxqtlib1$qvector$cxxbridge1$202$reserve_QPoint(::QVector_QPoint &arg0, ::rust::isize size) noexcept {
  void (*reserve_QPoint$)(::QVector_QPoint &, ::rust::isize) = ::rust::cxxqtlib1::qvector::qvectorReserve;
  reserve_QPoint$(arg0, size);
}

void rust$cxxqtlib1$qvector$cxxbridge1$202$append_QPoint(::QVector_QPoint &arg0, ::QPoint const &arg1) noexcept {
  void (*append_QPoint$)(::QVector_QPoint &, ::QPoint const &) = ::rust::cxxqtlib1::qvector::qvectorAppend;
  append_QPoint$(arg0, arg1);
}

void rust$cxxqtlib1$qvector$cxxbridge1$202$get_unchecked_QPoint(::QVector_QPoint const &set, ::rust::isize pos, ::QPoint const **return$) noexcept {
...
::rust::isize rust$cxxqtlib1$qvector$cxxbridge1$202$index_of_QPoint(::QVector_QPoint const &arg0, ::QPoint const &arg1) noexcept {
...
void rust$cxxqtlib1$qvector$cxxbridge1$202$insert_QPoint(::QVector_QPoint &arg0, ::rust::isize arg1, ::QPoint const &arg2) noexcept {
...
void rust$cxxqtlib1$qvector$cxxbridge1$202$remove_QPoint(::QVector_QPoint &arg0, ::rust::isize arg1) noexcept {
  void (*remove_QPoint$)(::QVector_QPoint &, ::rust::isize) = ::rust::cxxqtlib1::qvector::qvectorRemove;
  remove_QPoint$(arg0, arg1);
}

::rust::isize rust$cxxqtlib1$qvector$cxxbridge1$202$len_QPoint(::QVector_QPoint const &arg0) noexcept {
