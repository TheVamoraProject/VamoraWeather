...
extern "C" {
void cxxbridge1$202$QList_QVariant$cxx_clear(::QList_QVariant &self) noexcept {
  void (::QList_QVariant::*cxx_clear$)() = &::QList_QVariant::clear;
  (self.*cxx_clear$)();
}

bool cxxbridge1$202$QList_QVariant$cxx_contains(::QList_QVariant const &self, ::QVariant const &arg0) noexcept {
...
namespace cxxqtlib1 {
extern "C" {
void rust$cxxqtlib1$cxxbridge1$202$qlist_clone_QVariant(::QList_QVariant const &arg0, ::QList_QVariant *return$) noexcept {
...
void rust$cxxqtlib1$cxxbridge1$202$qlist_default_QVariant(::QList_QVariant *return$) noexcept {
  ::QList_QVariant (*qlist_default_QVariant$)() = ::rust::cxxqtlib1::construct;
  new (return$) ::QList_QVariant(qlist_default_QVariant$());
}

void rust$cxxqtlib1$cxxbridge1$202$qlist_drop_QVariant(::QList_QVariant &arg0) noexcept {
...
namespace qlist {
extern "C" {
void rust$cxxqtlib1$qlist$cxxbridge1$202$reserve_QVariant(::QList_QVariant &arg0, ::rust::isize size) noexcept {
  void (*reserve_QVariant$)(::QList_QVariant &, ::rust::isize) = ::rust::cxxqtlib1::qlist::qlistReserve;
  reserve_QVariant$(arg0, size);
}

void rust$cxxqtlib1$qlist$cxxbridge1$202$append_QVariant(::QList_QVariant &arg0, ::QVariant const &arg1) noexcept {
  void (*append_QVariant$)(::QList_QVariant &, ::QVariant const &) = ::rust::cxxqtlib1::qlist::qlistAppend;
  append_QVariant$(arg0, arg1);
}

void rust$cxxqtlib1$qlist$cxxbridge1$202$get_unchecked_QVariant(::QList_QVariant const &set, ::rust::isize pos, ::QVariant const **return$) noexcept {
...
::rust::isize rust$cxxqtlib1$qlist$cxxbridge1$202$index_of_QVariant(::QList_QVariant const &arg0, ::QVariant const &arg1) noexcept {
...
void rust$cxxqtlib1$qlist$cxxbridge1$202$insert_QVariant(::QList_QVariant &arg0, ::rust::isize arg1, ::QVariant const &arg2) noexcept {
...
void rust$cxxqtlib1$qlist$cxxbridge1$202$remove_QVariant(::QList_QVariant &arg0, ::rust::isize arg1) noexcept {
  void (*remove_QVariant$)(::QList_QVariant &, ::rust::isize) = ::rust::cxxqtlib1::qlist::qlistRemove;
  remove_QVariant$(arg0, arg1);
}

::rust::isize rust$cxxqtlib1$qlist$cxxbridge1$202$len_QVariant(::QList_QVariant const &arg0) noexcept {
