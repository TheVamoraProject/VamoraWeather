...
extern "C" {
void cxxbridge1$202$QSet_bool$cxx_clear(::QSet_bool &self) noexcept {
  void (::QSet_bool::*cxx_clear$)() = &::QSet_bool::clear;
  (self.*cxx_clear$)();
}

bool cxxbridge1$202$QSet_bool$cxx_contains(::QSet_bool const &self, bool const &arg0) noexcept {
  bool (::QSet_bool::*cxx_contains$)(bool const &) const = &::QSet_bool::contains;
  return (self.*cxx_contains$)(arg0);
}

bool cxxbridge1$202$QSet_bool$cxx_remove(::QSet_bool &self, bool const &arg0) noexcept {
...
namespace cxxqtlib1 {
extern "C" {
void rust$cxxqtlib1$cxxbridge1$202$qset_clone_bool(::QSet_bool const &arg0, ::QSet_bool *return$) noexcept {
  ::QSet_bool (*qset_clone_bool$)(::QSet_bool const &) = ::rust::cxxqtlib1::construct;
  new (return$) ::QSet_bool(qset_clone_bool$(arg0));
}

void rust$cxxqtlib1$cxxbridge1$202$qset_default_bool(::QSet_bool *return$) noexcept {
  ::QSet_bool (*qset_default_bool$)() = ::rust::cxxqtlib1::construct;
  new (return$) ::QSet_bool(qset_default_bool$());
}

void rust$cxxqtlib1$cxxbridge1$202$qset_drop_bool(::QSet_bool &arg0) noexcept {
...
namespace qset {
extern "C" {
bool const *rust$cxxqtlib1$qset$cxxbridge1$202$get_unchecked_bool(::QSet_bool const &set, ::rust::isize pos) noexcept {
...
void rust$cxxqtlib1$qset$cxxbridge1$202$insert_bool(::QSet_bool &arg0, bool const &arg1) noexcept {
  void (*insert_bool$)(::QSet_bool &, bool const &) = ::rust::cxxqtlib1::qset::qsetInsert;
  insert_bool$(arg0, arg1);
}

::rust::isize rust$cxxqtlib1$qset$cxxbridge1$202$len_bool(::QSet_bool const &arg0) noexcept {
  ::rust::isize (*len_bool$)(::QSet_bool const &) = ::rust::cxxqtlib1::qset::qsetLen;
  return len_bool$(arg0);
}

void rust$cxxqtlib1$qset$cxxbridge1$202$reserve_bool(::QSet_bool &arg0, ::rust::isize size) noexcept {
