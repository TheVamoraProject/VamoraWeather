...
extern "C" {
void cxxbridge1$202$QVector_QSize$cxx_clear(::QVector_QSize &self) noexcept {
  void (::QVector_QSize::*cxx_clear$)() = &::QVector_QSize::clear;
  (self.*cxx_clear$)();
}

bool cxxbridge1$202$QVector_QSize$cxx_contains(::QVector_QSize const &self, ::QSize const &arg0) noexcept {
...
namespace cxxqtlib1 {
extern "C" {
void rust$cxxqtlib1$cxxbridge1$202$qvector_clone_QSize(::QVector_QSize const &arg0, ::QVector_QSize *return$) noexcept {
...
void rust$cxxqtlib1$cxxbridge1$202$qvector_default_QSize(::QVector_QSize *return$) noexcept {
  ::QVector_QSize (*qvector_default_QSize$)() = ::rust::cxxqtlib1::construct;
  new (return$) ::QVector_QSize(qvector_default_QSize$());
}

void rust$cxxqtlib1$cxxbridge1$202$qvector_drop_QSize(::QVector_QSize &arg0) noexcept {
...
namespace qvector {
extern "C" {
void rust$cxxqtlib1$qvector$cxxbridge1$202$reserve_QSize(::QVector_QSize &arg0, ::rust::isize size) noexcept {
  void (*reserve_QSize$)(::QVector_QSize &, ::rust::isize) = ::rust::cxxqtlib1::qvector::qvectorReserve;
  reserve_QSize$(arg0, size);
}

void rust$cxxqtlib1$qvector$cxxbridge1$202$append_QSize(::QVector_QSize &arg0, ::QSize const &arg1) noexcept {
  void (*append_QSize$)(::QVector_QSize &, ::QSize const &) = ::rust::cxxqtlib1::qvector::qvectorAppend;
  append_QSize$(arg0, arg1);
}

void rust$cxxqtlib1$qvector$cxxbridge1$202$get_unchecked_QSize(::QVector_QSize const &set, ::rust::isize pos, ::QSize const **return$) noexcept {
...
::rust::isize rust$cxxqtlib1$qvector$cxxbridge1$202$index_of_QSize(::QVector_QSize const &arg0, ::QSize const &arg1) noexcept {
...
void rust$cxxqtlib1$qvector$cxxbridge1$202$insert_QSize(::QVector_QSize &arg0, ::rust::isize arg1, ::QSize const &arg2) noexcept {
  void (*insert_QSize$)(::QVector_QSize &, ::rust::isize, ::QSize const &) = ::rust::cxxqtlib1::qvector::qvectorInsert;
  insert_QSize$(arg0, arg1, arg2);
}

void rust$cxxqtlib1$qvector$cxxbridge1$202$remove_QSize(::QVector_QSize &arg0, ::rust::isize arg1) noexcept {
  void (*remove_QSize$)(::QVector_QSize &, ::rust::isize) = ::rust::cxxqtlib1::qvector::qvectorRemove;
  remove_QSize$(arg0, arg1);
}

::rust::isize rust$cxxqtlib1$qvector$cxxbridge1$202$len_QSize(::QVector_QSize const &arg0) noexcept {
