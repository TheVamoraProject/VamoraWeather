...
extern "C" {
void cxxbridge1$202$QSet_i16$cxx_clear(::QSet_i16 &self) noexcept {
  void (::QSet_i16::*cxx_clear$)() = &::QSet_i16::clear;
  (self.*cxx_clear$)();
}

bool cxxbridge1$202$QSet_i16$cxx_contains(::QSet_i16 const &self, ::std::int16_t const &arg0) noexcept {
  bool (::QSet_i16::*cxx_contains$)(::std::int16_t const &) const = &::QSet_i16::contains;
  return (self.*cxx_contains$)(arg0);
}

bool cxxbridge1$202$QSet_i16$cxx_remove(::QSet_i16 &self, ::std::int16_t const &arg0) noexcept {
...
namespace cxxqtlib1 {
extern "C" {
void rust$cxxqtlib1$cxxbridge1$202$qset_clone_i16(::QSet_i16 const &arg0, ::QSet_i16 *return$) noexcept {
  ::QSet_i16 (*qset_clone_i16$)(::QSet_i16 const &) = ::rust::cxxqtlib1::construct;
  new (return$) ::QSet_i16(qset_clone_i16$(arg0));
}

void rust$cxxqtlib1$cxxbridge1$202$qset_default_i16(::QSet_i16 *return$) noexcept {
  ::QSet_i16 (*qset_default_i16$)() = ::rust::cxxqtlib1::construct;
  new (return$) ::QSet_i16(qset_default_i16$());
}

void rust$cxxqtlib1$cxxbridge1$202$qset_drop_i16(::QSet_i16 &arg0) noexcept {
...
namespace qset {
extern "C" {
::std::int16_t const *rust$cxxqtlib1$qset$cxxbridge1$202$get_unchecked_i16(::QSet_i16 const &set, ::rust::isize pos) noexcept {
...
void rust$cxxqtlib1$qset$cxxbridge1$202$insert_i16(::QSet_i16 &arg0, ::std::int16_t const &arg1) noexcept {
  void (*insert_i16$)(::QSet_i16 &, ::std::int16_t const &) = ::rust::cxxqtlib1::qset::qsetInsert;
  insert_i16$(arg0, arg1);
}

::rust::isize rust$cxxqtlib1$qset$cxxbridge1$202$len_i16(::QSet_i16 const &arg0) noexcept {
  ::rust::isize (*len_i16$)(::QSet_i16 const &) = ::rust::cxxqtlib1::qset::qsetLen;
  return len_i16$(arg0);
}

void rust$cxxqtlib1$qset$cxxbridge1$202$reserve_i16(::QSet_i16 &arg0, ::rust::isize size) noexcept {
