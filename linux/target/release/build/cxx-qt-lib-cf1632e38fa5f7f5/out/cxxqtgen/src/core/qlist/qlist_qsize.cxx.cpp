...
extern "C" {
void cxxbridge1$202$QList_QSize$cxx_clear(::QList_QSize &self) noexcept {
  void (::QList_QSize::*cxx_clear$)() = &::QList_QSize::clear;
  (self.*cxx_clear$)();
}

bool cxxbridge1$202$QList_QSize$cxx_contains(::QList_QSize const &self, ::QSize const &arg0) noexcept {
...
namespace cxxqtlib1 {
extern "C" {
void rust$cxxqtlib1$cxxbridge1$202$qlist_clone_QSize(::QList_QSize const &arg0, ::QList_QSize *return$) noexcept {
  ::QList_QSize (*qlist_clone_QSize$)(::QList_QSize const &) = ::rust::cxxqtlib1::construct;
  new (return$) ::QList_QSize(qlist_clone_QSize$(arg0));
}

void rust$cxxqtlib1$cxxbridge1$202$qlist_default_QSize(::QList_QSize *return$) noexcept {
  ::QList_QSize (*qlist_default_QSize$)() = ::rust::cxxqtlib1::construct;
  new (return$) ::QList_QSize(qlist_default_QSize$());
}

void rust$cxxqtlib1$cxxbridge1$202$qlist_drop_QSize(::QList_QSize &arg0) noexcept {
...
namespace qlist {
extern "C" {
void rust$cxxqtlib1$qlist$cxxbridge1$202$reserve_QSize(::QList_QSize &arg0, ::rust::isize size) noexcept {
  void (*reserve_QSize$)(::QList_QSize &, ::rust::isize) = ::rust::cxxqtlib1::qlist::qlistReserve;
  reserve_QSize$(arg0, size);
}

void rust$cxxqtlib1$qlist$cxxbridge1$202$append_QSize(::QList_QSize &arg0, ::QSize const &arg1) noexcept {
  void (*append_QSize$)(::QList_QSize &, ::QSize const &) = ::rust::cxxqtlib1::qlist::qlistAppend;
  append_QSize$(arg0, arg1);
}

void rust$cxxqtlib1$qlist$cxxbridge1$202$get_unchecked_QSize(::QList_QSize const &set, ::rust::isize pos, ::QSize const **return$) noexcept {
...
::rust::isize rust$cxxqtlib1$qlist$cxxbridge1$202$index_of_QSize(::QList_QSize const &arg0, ::QSize const &arg1) noexcept {
  ::rust::isize (*index_of_QSize$)(::QList_QSize const &, ::QSize const &) = ::rust::cxxqtlib1::qlist::qlistIndexOf;
  return index_of_QSize$(arg0, arg1);
}

void rust$cxxqtlib1$qlist$cxxbridge1$202$insert_QSize(::QList_QSize &arg0, ::rust::isize arg1, ::QSize const &arg2) noexcept {
  void (*insert_QSize$)(::QList_QSize &, ::rust::isize, ::QSize const &) = ::rust::cxxqtlib1::qlist::qlistInsert;
  insert_QSize$(arg0, arg1, arg2);
}

void rust$cxxqtlib1$qlist$cxxbridge1$202$remove_QSize(::QList_QSize &arg0, ::rust::isize arg1) noexcept {
  void (*remove_QSize$)(::QList_QSize &, ::rust::isize) = ::rust::cxxqtlib1::qlist::qlistRemove;
  remove_QSize$(arg0, arg1);
}

::rust::isize rust$cxxqtlib1$qlist$cxxbridge1$202$len_QSize(::QList_QSize const &arg0) noexcept {
