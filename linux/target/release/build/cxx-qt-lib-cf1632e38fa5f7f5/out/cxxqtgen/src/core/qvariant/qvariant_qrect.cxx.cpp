...
namespace qvariant {
extern "C" {
bool rust$cxxqtlib1$qvariant$cxxbridge1$202$can_convert_QRect(::QVariant const &variant) noexcept {
  bool (*can_convert_QRect$)(::QVariant const &) = ::rust::cxxqtlib1::qvariant::qvariantCanConvertQRect;
  return can_convert_QRect$(variant);
}

void rust$cxxqtlib1$qvariant$cxxbridge1$202$construct_QRect(::QRect const &value, ::QVariant *return$) noexcept {
  ::QVariant (*construct_QRect$)(::QRect const &) = ::rust::cxxqtlib1::qvariant::qvariantConstruct;
  new (return$) ::QVariant(construct_QRect$(value));
}

void rust$cxxqtlib1$qvariant$cxxbridge1$202$value_or_default_QRect(::QVariant const &variant, ::QRect *return$) noexcept {
