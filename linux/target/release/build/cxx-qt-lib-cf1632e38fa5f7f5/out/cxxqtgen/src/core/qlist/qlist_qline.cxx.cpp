...
extern "C" {
void cxxbridge1$202$QList_QLine$cxx_clear(::QList_QLine &self) noexcept {
  void (::QList_QLine::*cxx_clear$)() = &::QList_QLine::clear;
  (self.*cxx_clear$)();
}

bool cxxbridge1$202$QList_QLine$cxx_contains(::QList_QLine const &self, ::QLine const &arg0) noexcept {
...
namespace cxxqtlib1 {
extern "C" {
void rust$cxxqtlib1$cxxbridge1$202$qlist_clone_QLine(::QList_QLine const &arg0, ::QList_QLine *return$) noexcept {
  ::QList_QLine (*qlist_clone_QLine$)(::QList_QLine const &) = ::rust::cxxqtlib1::construct;
  new (return$) ::QList_QLine(qlist_clone_QLine$(arg0));
}

void rust$cxxqtlib1$cxxbridge1$202$qlist_default_QLine(::QList_QLine *return$) noexcept {
  ::QList_QLine (*qlist_default_QLine$)() = ::rust::cxxqtlib1::construct;
  new (return$) ::QList_QLine(qlist_default_QLine$());
}

void rust$cxxqtlib1$cxxbridge1$202$qlist_drop_QLine(::QList_QLine &arg0) noexcept {
...
namespace qlist {
extern "C" {
void rust$cxxqtlib1$qlist$cxxbridge1$202$reserve_QLine(::QList_QLine &arg0, ::rust::isize size) noexcept {
  void (*reserve_QLine$)(::QList_QLine &, ::rust::isize) = ::rust::cxxqtlib1::qlist::qlistReserve;
  reserve_QLine$(arg0, size);
}

void rust$cxxqtlib1$qlist$cxxbridge1$202$append_QLine(::QList_QLine &arg0, ::QLine const &arg1) noexcept {
  void (*append_QLine$)(::QList_QLine &, ::QLine const &) = ::rust::cxxqtlib1::qlist::qlistAppend;
  append_QLine$(arg0, arg1);
}

void rust$cxxqtlib1$qlist$cxxbridge1$202$get_unchecked_QLine(::QList_QLine const &set, ::rust::isize pos, ::QLine const **return$) noexcept {
...
::rust::isize rust$cxxqtlib1$qlist$cxxbridge1$202$index_of_QLine(::QList_QLine const &arg0, ::QLine const &arg1) noexcept {
  ::rust::isize (*index_of_QLine$)(::QList_QLine const &, ::QLine const &) = ::rust::cxxqtlib1::qlist::qlistIndexOf;
  return index_of_QLine$(arg0, arg1);
}

void rust$cxxqtlib1$qlist$cxxbridge1$202$insert_QLine(::QList_QLine &arg0, ::rust::isize arg1, ::QLine const &arg2) noexcept {
  void (*insert_QLine$)(::QList_QLine &, ::rust::isize, ::QLine const &) = ::rust::cxxqtlib1::qlist::qlistInsert;
  insert_QLine$(arg0, arg1, arg2);
}

void rust$cxxqtlib1$qlist$cxxbridge1$202$remove_QLine(::QList_QLine &arg0, ::rust::isize arg1) noexcept {
  void (*remove_QLine$)(::QList_QLine &, ::rust::isize) = ::rust::cxxqtlib1::qlist::qlistRemove;
  remove_QLine$(arg0, arg1);
}

::rust::isize rust$cxxqtlib1$qlist$cxxbridge1$202$len_QLine(::QList_QLine const &arg0) noexcept {
