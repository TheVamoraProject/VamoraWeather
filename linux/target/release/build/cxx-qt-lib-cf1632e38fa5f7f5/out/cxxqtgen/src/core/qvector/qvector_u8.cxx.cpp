...
extern "C" {
void cxxbridge1$202$QVector_u8$cxx_clear(::QVector_u8 &self) noexcept {
  void (::QVector_u8::*cxx_clear$)() = &::QVector_u8::clear;
  (self.*cxx_clear$)();
}

bool cxxbridge1$202$QVector_u8$cxx_contains(::QVector_u8 const &self, ::std::uint8_t const &arg0) noexcept {
...
namespace cxxqtlib1 {
extern "C" {
void rust$cxxqtlib1$cxxbridge1$202$qvector_clone_u8(::QVector_u8 const &arg0, ::QVector_u8 *return$) noexcept {
  ::QVector_u8 (*qvector_clone_u8$)(::QVector_u8 const &) = ::rust::cxxqtlib1::construct;
  new (return$) ::QVector_u8(qvector_clone_u8$(arg0));
}

void rust$cxxqtlib1$cxxbridge1$202$qvector_default_u8(::QVector_u8 *return$) noexcept {
  ::QVector_u8 (*qvector_default_u8$)() = ::rust::cxxqtlib1::construct;
  new (return$) ::QVector_u8(qvector_default_u8$());
}

void rust$cxxqtlib1$cxxbridge1$202$qvector_drop_u8(::QVector_u8 &arg0) noexcept {
...
namespace qvector {
extern "C" {
void rust$cxxqtlib1$qvector$cxxbridge1$202$reserve_u8(::QVector_u8 &arg0, ::rust::isize size) noexcept {
  void (*reserve_u8$)(::QVector_u8 &, ::rust::isize) = ::rust::cxxqtlib1::qvector::qvectorReserve;
  reserve_u8$(arg0, size);
}

void rust$cxxqtlib1$qvector$cxxbridge1$202$append_u8(::QVector_u8 &arg0, ::std::uint8_t const &arg1) noexcept {
  void (*append_u8$)(::QVector_u8 &, ::std::uint8_t const &) = ::rust::cxxqtlib1::qvector::qvectorAppend;
  append_u8$(arg0, arg1);
}

::std::uint8_t const *rust$cxxqtlib1$qvector$cxxbridge1$202$get_unchecked_u8(::QVector_u8 const &set, ::rust::isize pos) noexcept {
...
::rust::isize rust$cxxqtlib1$qvector$cxxbridge1$202$index_of_u8(::QVector_u8 const &arg0, ::std::uint8_t const &arg1) noexcept {
...
void rust$cxxqtlib1$qvector$cxxbridge1$202$insert_u8(::QVector_u8 &arg0, ::rust::isize arg1, ::std::uint8_t const &arg2) noexcept {
  void (*insert_u8$)(::QVector_u8 &, ::rust::isize, ::std::uint8_t const &) = ::rust::cxxqtlib1::qvector::qvectorInsert;
  insert_u8$(arg0, arg1, arg2);
}

::rust::isize rust$cxxqtlib1$qvector$cxxbridge1$202$len_u8(::QVector_u8 const &arg0) noexcept {
  ::rust::isize (*len_u8$)(::QVector_u8 const &) = ::rust::cxxqtlib1::qvector::qvectorLen;
  return len_u8$(arg0);
}

void rust$cxxqtlib1$qvector$cxxbridge1$202$remove_u8(::QVector_u8 &arg0, ::rust::isize arg1) noexcept {
