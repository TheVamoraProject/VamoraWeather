...
extern "C" {
::std::int32_t cxxbridge1$202$QPoint$dot_product(::QPoint const &p1, ::QPoint const &p2) noexcept {
  ::std::int32_t (*dot_product$)(::QPoint const &, ::QPoint const &) = &::QPoint::dotProduct;
  return dot_product$(p1, p2);
}

bool cxxbridge1$202$QPoint$is_null(::QPoint const &self) noexcept {
  bool (::QPoint::*is_null$)() const = &::QPoint::isNull;
  return (self.*is_null$)();
}

::std::int32_t cxxbridge1$202$QPoint$manhattan_length(::QPoint const &self) noexcept {
  ::std::int32_t (::QPoint::*manhattan_length$)() const = &::QPoint::manhattanLength;
  return (self.*manhattan_length$)();
}

void cxxbridge1$202$QPoint$set_x(::QPoint &self, ::std::int32_t x) noexcept {
  void (::QPoint::*set_x$)(::std::int32_t) = &::QPoint::setX;
  (self.*set_x$)(x);
}

void cxxbridge1$202$QPoint$set_y(::QPoint &self, ::std::int32_t y) noexcept {
  void (::QPoint::*set_y$)(::std::int32_t) = &::QPoint::setY;
  (self.*set_y$)(y);
}

void cxxbridge1$202$QPoint$to_pointf(::QPoint const &self, ::QPointF *return$) noexcept {
  ::QPointF (::QPoint::*to_pointf$)() const = &::QPoint::toPointF;
  new (return$) ::QPointF((self.*to_pointf$)());
}

void cxxbridge1$202$QPoint$transposed(::QPoint const &self, ::QPoint *return$) noexcept {
  ::QPoint (::QPoint::*transposed$)() const = &::QPoint::transposed;
  new (return$) ::QPoint((self.*transposed$)());
}

::std::int32_t cxxbridge1$202$QPoint$x(::QPoint const &self) noexcept {
  ::std::int32_t (::QPoint::*x$)() const = &::QPoint::x;
  return (self.*x$)();
}

::std::int32_t cxxbridge1$202$QPoint$y(::QPoint const &self) noexcept {
...
namespace cxxqtlib1 {
extern "C" {
void rust$cxxqtlib1$cxxbridge1$202$qpoint_init_default(::QPoint *return$) noexcept {
  ::QPoint (*qpoint_init_default$)() = ::rust::cxxqtlib1::construct;
  new (return$) ::QPoint(qpoint_init_default$());
}

void rust$cxxqtlib1$cxxbridge1$202$qpoint_init(::std::int32_t x, ::std::int32_t y, ::QPoint *return$) noexcept {
  ::QPoint (*qpoint_init$)(::std::int32_t, ::std::int32_t) = ::rust::cxxqtlib1::construct;
  new (return$) ::QPoint(qpoint_init$(x, y));
}

void rust$cxxqtlib1$cxxbridge1$202$qpoint_to_debug_qstring(::QPoint const &value, ::QString *return$) noexcept {
...
void rust$cxxqtlib1$cxxbridge1$202$qpoint_plus(::QPoint const &a, ::QPoint const &b, ::QPoint *return$) noexcept {
  ::QPoint (*qpoint_plus$)(::QPoint const &, ::QPoint const &) = ::rust::cxxqtlib1::operatorPlus;
  new (return$) ::QPoint(qpoint_plus$(a, b));
}

void rust$cxxqtlib1$cxxbridge1$202$qpoint_minus(::QPoint const &a, ::QPoint const &b, ::QPoint *return$) noexcept {
  ::QPoint (*qpoint_minus$)(::QPoint const &, ::QPoint const &) = ::rust::cxxqtlib1::operatorMinus;
  new (return$) ::QPoint(qpoint_minus$(a, b));
}

void rust$cxxqtlib1$cxxbridge1$202$qpoint_mul_f32(float a, ::QPoint const &b, ::QPoint *return$) noexcept {
  ::QPoint (*qpoint_mul_f32$)(float, ::QPoint const &) = ::rust::cxxqtlib1::operatorMul;
  new (return$) ::QPoint(qpoint_mul_f32$(a, b));
}

void rust$cxxqtlib1$cxxbridge1$202$qpoint_mul_f64(double a, ::QPoint const &b, ::QPoint *return$) noexcept {
  ::QPoint (*qpoint_mul_f64$)(double, ::QPoint const &) = ::rust::cxxqtlib1::operatorMul;
  new (return$) ::QPoint(qpoint_mul_f64$(a, b));
}

void rust$cxxqtlib1$cxxbridge1$202$qpoint_mul_i32(::std::int32_t a, ::QPoint const &b, ::QPoint *return$) noexcept {
  ::QPoint (*qpoint_mul_i32$)(::std::int32_t, ::QPoint const &) = ::rust::cxxqtlib1::operatorMul;
  new (return$) ::QPoint(qpoint_mul_i32$(a, b));
}

void rust$cxxqtlib1$cxxbridge1$202$qpoint_div(double a, ::QPoint const &b, ::QPoint *return$) noexcept {
