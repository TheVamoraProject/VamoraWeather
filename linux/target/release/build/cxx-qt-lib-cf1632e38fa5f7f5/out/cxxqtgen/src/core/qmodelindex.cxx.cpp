...
extern "C" {
::std::int32_t cxxbridge1$202$QModelIndex$column(::QModelIndex const &self) noexcept {
  ::std::int32_t (::QModelIndex::*column$)() const = &::QModelIndex::column;
  return (self.*column$)();
}

bool cxxbridge1$202$QModelIndex$is_valid(::QModelIndex const &self) noexcept {
  bool (::QModelIndex::*is_valid$)() const = &::QModelIndex::isValid;
  return (self.*is_valid$)();
}

void cxxbridge1$202$QModelIndex$parent(::QModelIndex const &self, ::QModelIndex *return$) noexcept {
  ::QModelIndex (::QModelIndex::*parent$)() const = &::QModelIndex::parent;
  new (return$) ::QModelIndex((self.*parent$)());
}

::std::int32_t cxxbridge1$202$QModelIndex$row(::QModelIndex const &self) noexcept {
  ::std::int32_t (::QModelIndex::*row$)() const = &::QModelIndex::row;
  return (self.*row$)();
}

void cxxbridge1$202$QModelIndex$sibling(::QModelIndex const &self, ::std::int32_t row, ::std::int32_t column, ::QModelIndex *return$) noexcept {
...
void cxxbridge1$202$QModelIndex$sibling_at_column(::QModelIndex const &self, ::std::int32_t column, ::QModelIndex *return$) noexcept {
...
void cxxbridge1$202$QModelIndex$sibling_at_row(::QModelIndex const &self, ::std::int32_t row, ::QModelIndex *return$) noexcept {
...
void cxxbridge1$202$QModelIndex$internal_id_quintptr(::QModelIndex const &self, ::quintptr *return$) noexcept {
  ::quintptr (::QModelIndex::*internal_id_quintptr$)() const = &::QModelIndex::internalId;
  new (return$) ::quintptr((self.*internal_id_quintptr$)());
}

::rust::cxxqtlib1::c_void *cxxbridge1$202$QModelIndex$internal_pointer_mut(::QModelIndex const &self) noexcept {
...
namespace cxxqtlib1 {
extern "C" {
void rust$cxxqtlib1$cxxbridge1$202$qmodelindex_init_default(::QModelIndex *return$) noexcept {
  ::QModelIndex (*qmodelindex_init_default$)() = ::rust::cxxqtlib1::construct;
  new (return$) ::QModelIndex(qmodelindex_init_default$());
}

bool rust$cxxqtlib1$cxxbridge1$202$qmodelindex_eq(::QModelIndex const &a, ::QModelIndex const &b) noexcept {
  bool (*qmodelindex_eq$)(::QModelIndex const &, ::QModelIndex const &) = ::rust::cxxqtlib1::operatorEq;
  return qmodelindex_eq$(a, b);
}

void rust$cxxqtlib1$cxxbridge1$202$qmodelindex_to_debug_qstring(::QModelIndex const &value, ::QString *return$) noexcept {
