...
extern "C" {
void cxxbridge1$202$QQmlEngine$add_import_path(::QQmlEngine &self, ::QString const &path) noexcept {
  void (::QQmlEngine::*add_import_path$)(::QString const &) = &::QQmlEngine::addImportPath;
  (self.*add_import_path$)(path);
}

void cxxbridge1$202$QQmlEngine$add_plugin_path(::QQmlEngine &self, ::QString const &path) noexcept {
  void (::QQmlEngine::*add_plugin_path$)(::QString const &) = &::QQmlEngine::addPluginPath;
  (self.*add_plugin_path$)(path);
}

void cxxbridge1$202$QQmlEngine$base_url(::QQmlEngine const &self, ::QUrl *return$) noexcept {
  ::QUrl (::QQmlEngine::*base_url$)() const = &::QQmlEngine::baseUrl;
  new (return$) ::QUrl((self.*base_url$)());
}

void cxxbridge1$202$QQmlEngine$import_path_list(::QQmlEngine const &self, ::QStringList *return$) noexcept {
  ::QStringList (::QQmlEngine::*import_path_list$)() const = &::QQmlEngine::importPathList;
  new (return$) ::QStringList((self.*import_path_list$)());
}

void cxxbridge1$202$QQmlEngine$offline_storage_path(::QQmlEngine const &self, ::QString *return$) noexcept {
  ::QString (::QQmlEngine::*offline_storage_path$)() const = &::QQmlEngine::offlineStoragePath;
  new (return$) ::QString((self.*offline_storage_path$)());
}

bool cxxbridge1$202$QQmlEngine$output_warnings_to_standard_error(::QQmlEngine const &self) noexcept {
...
void cxxbridge1$202$QQmlEngine$plugin_path_list(::QQmlEngine const &self, ::QStringList *return$) noexcept {
  ::QStringList (::QQmlEngine::*plugin_path_list$)() const = &::QQmlEngine::pluginPathList;
  new (return$) ::QStringList((self.*plugin_path_list$)());
}

void cxxbridge1$202$QQmlEngine$set_base_url(::QQmlEngine &self, ::QUrl const &url) noexcept {
  void (::QQmlEngine::*set_base_url$)(::QUrl const &) = &::QQmlEngine::setBaseUrl;
  (self.*set_base_url$)(url);
}

void cxxbridge1$202$QQmlEngine$set_import_path_list(::QQmlEngine &self, ::QStringList const &paths) noexcept {
  void (::QQmlEngine::*set_import_path_list$)(::QStringList const &) = &::QQmlEngine::setImportPathList;
  (self.*set_import_path_list$)(paths);
}

void cxxbridge1$202$QQmlEngine$set_offline_storage_path(::QQmlEngine &self, ::QString const &dir) noexcept {
  void (::QQmlEngine::*set_offline_storage_path$)(::QString const &) = &::QQmlEngine::setOfflineStoragePath;
  (self.*set_offline_storage_path$)(dir);
}

void cxxbridge1$202$QQmlEngine$set_output_warnings_to_standard_error(::QQmlEngine &self, bool enabled) noexcept {
...
void cxxbridge1$202$QQmlEngine$set_plugin_path_list(::QQmlEngine &self, ::QStringList const &paths) noexcept {
  void (::QQmlEngine::*set_plugin_path_list$)(::QStringList const &) = &::QQmlEngine::setPluginPathList;
  (self.*set_plugin_path_list$)(paths);
}

void cxxbridge1$202$QQmlEngine$add_image_provider(::QQmlEngine &self, ::QString const &provider_id, ::QQmlImageProviderBase *provider) noexcept {
  void (::QQmlEngine::*add_image_provider$)(::QString const &, ::QQmlImageProviderBase *) = &::QQmlEngine::addImageProvider;
  (self.*add_image_provider$)(provider_id, provider);
}

void cxxbridge1$202$QQmlEngine$remove_image_provider(::QQmlEngine &self, ::QString const &provider_id) noexcept {
  void (::QQmlEngine::*remove_image_provider$)(::QString const &) = &::QQmlEngine::removeImageProvider;
  (self.*remove_image_provider$)(provider_id);
}
} // extern "C"
...
namespace cxxqtlib1 {
extern "C" {
::QQmlEngine *rust$cxxqtlib1$cxxbridge1$202$qqmlengine_new() noexcept {
...
namespace cxxqt1 {
extern "C" {
::QObject const *rust$cxxqt1$cxxbridge1$202$cxx_qt_ffi_QQmlEngine_upcastPtr(::QQmlEngine const *thiz) noexcept {
...
::QQmlEngine const *rust$cxxqt1$cxxbridge1$202$cxx_qt_ffi_QQmlEngine_downcastPtr(::QObject const *base) noexcept {
...
extern "C" {
void cxxbridge1$202$QQmlEngine$exit(::QQmlEngine &self, ::std::int32_t ret_code) noexcept {
...
namespace cxxqtgen1 {
extern "C" {
void rust$cxxqtgen1$cxxbridge1$202$QQmlEngine_connect_exit(::QQmlEngine &self_value, ::rust::cxxqtgen1::QQmlEngineCxxQtSignalHandlerexit *signal_handler, ::Qt::ConnectionType *conn_type, ::rust::cxxqt1::QMetaObjectConnection *return$) noexcept {
...
void rust$cxxqtgen1$cxxbridge1$202$drop_QQmlEngine_signal_handler_exit(::rust::cxxqtgen1::QQmlEngineCxxQtSignalHandlerexit *handler) noexcept;

void rust$cxxqtgen1$cxxbridge1$202$call_QQmlEngine_signal_handler_exit(::rust::cxxqtgen1::QQmlEngineCxxQtSignalHandlerexit &handler, ::QQmlEngine &self_value, ::std::int32_t ret_code) noexcept;
} // extern "C"
} // namespace cxxqtgen1
} // namespace rust

extern "C" {
void cxxbridge1$202$QQmlEngine$quit(::QQmlEngine &self) noexcept {
...
namespace cxxqtgen1 {
extern "C" {
void rust$cxxqtgen1$cxxbridge1$202$QQmlEngine_connect_quit(::QQmlEngine &self_value, ::rust::cxxqtgen1::QQmlEngineCxxQtSignalHandlerquit *signal_handler, ::Qt::ConnectionType *conn_type, ::rust::cxxqt1::QMetaObjectConnection *return$) noexcept {
...
void rust$cxxqtgen1$cxxbridge1$202$drop_QQmlEngine_signal_handler_quit(::rust::cxxqtgen1::QQmlEngineCxxQtSignalHandlerquit *handler) noexcept;

void rust$cxxqtgen1$cxxbridge1$202$call_QQmlEngine_signal_handler_quit(::rust::cxxqtgen1::QQmlEngineCxxQtSignalHandlerquit &handler, ::QQmlEngine &self_value) noexcept;
} // extern "C"
...
void drop_QQmlEngine_signal_handler_exit(::rust::cxxqtgen1::QQmlEngineCxxQtSignalHandlerexit handler) noexcept {
  ...
  rust$cxxqtgen1$cxxbridge1$202$drop_QQmlEngine_signal_handler_exit(&handler$.value);
}
...
void call_QQmlEngine_signal_handler_exit(::rust::cxxqtgen1::QQmlEngineCxxQtSignalHandlerexit &handler, ::QQmlEngine &self_value, ::std::int32_t ret_code) noexcept {
  rust$cxxqtgen1$cxxbridge1$202$call_QQmlEngine_signal_handler_exit(handler, self_value, ret_code);
}
...
void drop_QQmlEngine_signal_handler_quit(::rust::cxxqtgen1::QQmlEngineCxxQtSignalHandlerquit handler) noexcept {
  ...
  rust$cxxqtgen1$cxxbridge1$202$drop_QQmlEngine_signal_handler_quit(&handler$.value);
}
...
void call_QQmlEngine_signal_handler_quit(::rust::cxxqtgen1::QQmlEngineCxxQtSignalHandlerquit &handler, ::QQmlEngine &self_value) noexcept {
  rust$cxxqtgen1$cxxbridge1$202$call_QQmlEngine_signal_handler_quit(handler, self_value);
}
} // namespace cxxqtgen1
} // namespace rust
