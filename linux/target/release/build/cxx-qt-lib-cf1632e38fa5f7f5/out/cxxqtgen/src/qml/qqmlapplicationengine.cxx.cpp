...
extern "C" {
void cxxbridge1$202$QQmlApplicationEngine$add_import_path(::QQmlApplicationEngine &self, ::QString const &path) noexcept {
  void (::QQmlApplicationEngine::*add_import_path$)(::QString const &) = &::QQmlApplicationEngine::addImportPath;
  (self.*add_import_path$)(path);
}

void cxxbridge1$202$QQmlApplicationEngine$add_plugin_path(::QQmlApplicationEngine &self, ::QString const &path) noexcept {
  void (::QQmlApplicationEngine::*add_plugin_path$)(::QString const &) = &::QQmlApplicationEngine::addPluginPath;
  (self.*add_plugin_path$)(path);
}

void cxxbridge1$202$QQmlApplicationEngine$base_url(::QQmlApplicationEngine const &self, ::QUrl *return$) noexcept {
  ::QUrl (::QQmlApplicationEngine::*base_url$)() const = &::QQmlApplicationEngine::baseUrl;
  new (return$) ::QUrl((self.*base_url$)());
}

void cxxbridge1$202$QQmlApplicationEngine$import_path_list(::QQmlApplicationEngine const &self, ::QStringList *return$) noexcept {
...
void cxxbridge1$202$QQmlApplicationEngine$load(::QQmlApplicationEngine &self, ::QUrl const &url) noexcept {
  void (::QQmlApplicationEngine::*load$)(::QUrl const &) = &::QQmlApplicationEngine::load;
  (self.*load$)(url);
}

void cxxbridge1$202$QQmlApplicationEngine$load_data(::QQmlApplicationEngine &self, ::QByteArray const &data, ::QUrl const &url) noexcept {
  void (::QQmlApplicationEngine::*load_data$)(::QByteArray const &, ::QUrl const &) = &::QQmlApplicationEngine::loadData;
  (self.*load_data$)(data, url);
}

void cxxbridge1$202$QQmlApplicationEngine$offline_storage_path(::QQmlApplicationEngine const &self, ::QString *return$) noexcept {
...
void cxxbridge1$202$QQmlApplicationEngine$plugin_path_list(::QQmlApplicationEngine const &self, ::QStringList *return$) noexcept {
...
void cxxbridge1$202$QQmlApplicationEngine$set_base_url(::QQmlApplicationEngine &self, ::QUrl const &url) noexcept {
  void (::QQmlApplicationEngine::*set_base_url$)(::QUrl const &) = &::QQmlApplicationEngine::setBaseUrl;
  (self.*set_base_url$)(url);
}

void cxxbridge1$202$QQmlApplicationEngine$set_import_path_list(::QQmlApplicationEngine &self, ::QStringList const &paths) noexcept {
...
void cxxbridge1$202$QQmlApplicationEngine$set_initial_properties(::QQmlApplicationEngine &self, ::QMap_QString_QVariant const &properties) noexcept {
...
void cxxbridge1$202$QQmlApplicationEngine$set_plugin_path_list(::QQmlApplicationEngine &self, ::QStringList const &paths) noexcept {
...
void cxxbridge1$202$QQmlApplicationEngine$set_offline_storage_path(::QQmlApplicationEngine &self, ::QString const &dir) noexcept {
...
namespace cxxqtlib1 {
extern "C" {
::QQmlApplicationEngine *rust$cxxqtlib1$cxxbridge1$202$qqmlapplicationengine_new() noexcept {
...
namespace cxxqt1 {
extern "C" {
::QQmlEngine const *rust$cxxqt1$cxxbridge1$202$cxx_qt_ffi_QQmlApplicationEngine_upcastPtr(::QQmlApplicationEngine const *thiz) noexcept {
...
::QQmlApplicationEngine const *rust$cxxqt1$cxxbridge1$202$cxx_qt_ffi_QQmlApplicationEngine_downcastPtr(::QQmlEngine const *base) noexcept {
...
extern "C" {
void cxxbridge1$202$QQmlApplicationEngine$object_created(::QQmlApplicationEngine &self, ::QObject *qobject, ::QUrl const &url) noexcept {
...
namespace cxxqtgen1 {
extern "C" {
void rust$cxxqtgen1$cxxbridge1$202$QQmlApplicationEngine_connect_object_created(::QQmlApplicationEngine &self_value, ::rust::cxxqtgen1::QQmlApplicationEngineCxxQtSignalHandlerobjectCreated *signal_handler, ::Qt::ConnectionType *conn_type, ::rust::cxxqt1::QMetaObjectConnection *return$) noexcept {
...
void rust$cxxqtgen1$cxxbridge1$202$drop_QQmlApplicationEngine_signal_handler_objectCreated(::rust::cxxqtgen1::QQmlApplicationEngineCxxQtSignalHandlerobjectCreated *handler) noexcept;

void rust$cxxqtgen1$cxxbridge1$202$call_QQmlApplicationEngine_signal_handler_objectCreated(::rust::cxxqtgen1::QQmlApplicationEngineCxxQtSignalHandlerobjectCreated &handler, ::QQmlApplicationEngine &self_value, ::QObject *qobject, ::QUrl const &url) noexcept;
} // extern "C"
} // namespace cxxqtgen1
} // namespace rust

extern "C" {
void cxxbridge1$202$QQmlApplicationEngine$object_creation_failed(::QQmlApplicationEngine &self, ::QUrl const &url) noexcept {
...
namespace cxxqtgen1 {
extern "C" {
void rust$cxxqtgen1$cxxbridge1$202$QQmlApplicationEngine_connect_object_creation_failed(::QQmlApplicationEngine &self_value, ::rust::cxxqtgen1::QQmlApplicationEngineCxxQtSignalHandlerobjectCreationFailed *signal_handler, ::Qt::ConnectionType *conn_type, ::rust::cxxqt1::QMetaObjectConnection *return$) noexcept {
...
void rust$cxxqtgen1$cxxbridge1$202$drop_QQmlApplicationEngine_signal_handler_objectCreationFailed(::rust::cxxqtgen1::QQmlApplicationEngineCxxQtSignalHandlerobjectCreationFailed *handler) noexcept;

void rust$cxxqtgen1$cxxbridge1$202$call_QQmlApplicationEngine_signal_handler_objectCreationFailed(::rust::cxxqtgen1::QQmlApplicationEngineCxxQtSignalHandlerobjectCreationFailed &handler, ::QQmlApplicationEngine &self_value, ::QUrl const &url) noexcept;
} // extern "C"
...
void drop_QQmlApplicationEngine_signal_handler_objectCreated(::rust::cxxqtgen1::QQmlApplicationEngineCxxQtSignalHandlerobjectCreated handler) noexcept {
  ...
  rust$cxxqtgen1$cxxbridge1$202$drop_QQmlApplicationEngine_signal_handler_objectCreated(&handler$.value);
}
...
void call_QQmlApplicationEngine_signal_handler_objectCreated(::rust::cxxqtgen1::QQmlApplicationEngineCxxQtSignalHandlerobjectCreated &handler, ::QQmlApplicationEngine &self_value, ::QObject *qobject, ::QUrl const &url) noexcept {
  rust$cxxqtgen1$cxxbridge1$202$call_QQmlApplicationEngine_signal_handler_objectCreated(handler, self_value, qobject, url);
}
...
void drop_QQmlApplicationEngine_signal_handler_objectCreationFailed(::rust::cxxqtgen1::QQmlApplicationEngineCxxQtSignalHandlerobjectCreationFailed handler) noexcept {
  ...
  rust$cxxqtgen1$cxxbridge1$202$drop_QQmlApplicationEngine_signal_handler_objectCreationFailed(&handler$.value);
}
...
void call_QQmlApplicationEngine_signal_handler_objectCreationFailed(::rust::cxxqtgen1::QQmlApplicationEngineCxxQtSignalHandlerobjectCreationFailed &handler, ::QQmlApplicationEngine &self_value, ::QUrl const &url) noexcept {
  rust$cxxqtgen1$cxxbridge1$202$call_QQmlApplicationEngine_signal_handler_objectCreationFailed(handler, self_value, url);
}
} // namespace cxxqtgen1
} // namespace rust
