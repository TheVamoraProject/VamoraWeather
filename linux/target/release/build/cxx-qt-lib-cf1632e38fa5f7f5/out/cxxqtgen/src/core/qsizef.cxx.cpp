...
extern "C" {
void cxxbridge1$202$QSizeF$bounded_to(::QSizeF const &self, ::QSizeF const &other_size, ::QSizeF *return$) noexcept {
  ::QSizeF (::QSizeF::*bounded_to$)(::QSizeF const &) const = &::QSizeF::boundedTo;
  new (return$) ::QSizeF((self.*bounded_to$)(other_size));
}

void cxxbridge1$202$QSizeF$expanded_to(::QSizeF const &self, ::QSizeF const &other_size, ::QSizeF *return$) noexcept {
  ::QSizeF (::QSizeF::*expanded_to$)(::QSizeF const &) const = &::QSizeF::expandedTo;
  new (return$) ::QSizeF((self.*expanded_to$)(other_size));
}

double cxxbridge1$202$QSizeF$height(::QSizeF const &self) noexcept {
  double (::QSizeF::*height$)() const = &::QSizeF::height;
  return (self.*height$)();
}

bool cxxbridge1$202$QSizeF$is_empty(::QSizeF const &self) noexcept {
  bool (::QSizeF::*is_empty$)() const = &::QSizeF::isEmpty;
  return (self.*is_empty$)();
}

bool cxxbridge1$202$QSizeF$is_null(::QSizeF const &self) noexcept {
  bool (::QSizeF::*is_null$)() const = &::QSizeF::isNull;
  return (self.*is_null$)();
}

bool cxxbridge1$202$QSizeF$is_valid(::QSizeF const &self) noexcept {
  bool (::QSizeF::*is_valid$)() const = &::QSizeF::isValid;
  return (self.*is_valid$)();
}

void cxxbridge1$202$QSizeF$grown_by(::QSizeF const &self, ::QMarginsF *margins, ::QSizeF *return$) noexcept {
  ::QSizeF (::QSizeF::*grown_by$)(::QMarginsF) const = &::QSizeF::grownBy;
  new (return$) ::QSizeF((self.*grown_by$)(::std::move(*margins)));
}

void cxxbridge1$202$QSizeF$scale(::QSizeF &self, ::QSizeF const &size, ::Qt::AspectRatioMode *mode) noexcept {
  void (::QSizeF::*scale$)(::QSizeF const &, ::Qt::AspectRatioMode) = &::QSizeF::scale;
  (self.*scale$)(size, ::std::move(*mode));
}

void cxxbridge1$202$QSizeF$scaled(::QSizeF const &self, ::QSizeF const &s, ::Qt::AspectRatioMode *mode, ::QSizeF *return$) noexcept {
  ::QSizeF (::QSizeF::*scaled$)(::QSizeF const &, ::Qt::AspectRatioMode) const = &::QSizeF::scaled;
  new (return$) ::QSizeF((self.*scaled$)(s, ::std::move(*mode)));
}

void cxxbridge1$202$QSizeF$set_height(::QSizeF &self, double height) noexcept {
  void (::QSizeF::*set_height$)(double) = &::QSizeF::setHeight;
  (self.*set_height$)(height);
}

void cxxbridge1$202$QSizeF$set_width(::QSizeF &self, double width) noexcept {
  void (::QSizeF::*set_width$)(double) = &::QSizeF::setWidth;
  (self.*set_width$)(width);
}

void cxxbridge1$202$QSizeF$shrunk_by(::QSizeF const &self, ::QMarginsF *margins, ::QSizeF *return$) noexcept {
  ::QSizeF (::QSizeF::*shrunk_by$)(::QMarginsF) const = &::QSizeF::shrunkBy;
  new (return$) ::QSizeF((self.*shrunk_by$)(::std::move(*margins)));
}

void cxxbridge1$202$QSizeF$to_size(::QSizeF const &self, ::QSize *return$) noexcept {
  ::QSize (::QSizeF::*to_size$)() const = &::QSizeF::toSize;
  new (return$) ::QSize((self.*to_size$)());
}

void cxxbridge1$202$QSizeF$transpose(::QSizeF &self) noexcept {
  void (::QSizeF::*transpose$)() = &::QSizeF::transpose;
  (self.*transpose$)();
}

void cxxbridge1$202$QSizeF$transposed(::QSizeF const &self, ::QSizeF *return$) noexcept {
  ::QSizeF (::QSizeF::*transposed$)() const = &::QSizeF::transposed;
  new (return$) ::QSizeF((self.*transposed$)());
}

double cxxbridge1$202$QSizeF$width(::QSizeF const &self) noexcept {
...
namespace cxxqtlib1 {
extern "C" {
void rust$cxxqtlib1$cxxbridge1$202$qsizef_init_default(::QSizeF *return$) noexcept {
  ::QSizeF (*qsizef_init_default$)() = ::rust::cxxqtlib1::construct;
  new (return$) ::QSizeF(qsizef_init_default$());
}

void rust$cxxqtlib1$cxxbridge1$202$qsizef_init(double w, double h, ::QSizeF *return$) noexcept {
  ::QSizeF (*qsizef_init$)(double, double) = ::rust::cxxqtlib1::construct;
  new (return$) ::QSizeF(qsizef_init$(w, h));
}

void rust$cxxqtlib1$cxxbridge1$202$qsizef_from_qsize(::QSize const &size, ::QSizeF *return$) noexcept {
  ::QSizeF (*qsizef_from_qsize$)(::QSize const &) = ::rust::cxxqtlib1::construct;
  new (return$) ::QSizeF(qsizef_from_qsize$(size));
}

void rust$cxxqtlib1$cxxbridge1$202$qsizef_to_debug_qstring(::QSizeF const &value, ::QString *return$) noexcept {
...
void rust$cxxqtlib1$cxxbridge1$202$qsizef_plus(::QSizeF const &a, ::QSizeF const &b, ::QSizeF *return$) noexcept {
  ::QSizeF (*qsizef_plus$)(::QSizeF const &, ::QSizeF const &) = ::rust::cxxqtlib1::operatorPlus;
  new (return$) ::QSizeF(qsizef_plus$(a, b));
}

void rust$cxxqtlib1$cxxbridge1$202$qsizef_minus(::QSizeF const &a, ::QSizeF const &b, ::QSizeF *return$) noexcept {
  ::QSizeF (*qsizef_minus$)(::QSizeF const &, ::QSizeF const &) = ::rust::cxxqtlib1::operatorMinus;
  new (return$) ::QSizeF(qsizef_minus$(a, b));
}

void rust$cxxqtlib1$cxxbridge1$202$qsizef_mul(double a, ::QSizeF const &b, ::QSizeF *return$) noexcept {
  ::QSizeF (*qsizef_mul$)(double, ::QSizeF const &) = ::rust::cxxqtlib1::operatorMul;
  new (return$) ::QSizeF(qsizef_mul$(a, b));
}

void rust$cxxqtlib1$cxxbridge1$202$qsizef_div(double a, ::QSizeF const &b, ::QSizeF *return$) noexcept {
