...
extern "C" {
bool cxxbridge1$202$QVector3D$is_null(::QVector3D const &self) noexcept {
  bool (::QVector3D::*is_null$)() const = &::QVector3D::isNull;
  return (self.*is_null$)();
}

float cxxbridge1$202$QVector3D$length(::QVector3D const &self) noexcept {
  float (::QVector3D::*length$)() const = &::QVector3D::length;
  return (self.*length$)();
}

float cxxbridge1$202$QVector3D$length_squared(::QVector3D const &self) noexcept {
  float (::QVector3D::*length_squared$)() const = &::QVector3D::lengthSquared;
  return (self.*length_squared$)();
}

void cxxbridge1$202$QVector3D$normalize(::QVector3D &self) noexcept {
  void (::QVector3D::*normalize$)() = &::QVector3D::normalize;
  (self.*normalize$)();
}

void cxxbridge1$202$QVector3D$normalized(::QVector3D const &self, ::QVector3D *return$) noexcept {
  ::QVector3D (::QVector3D::*normalized$)() const = &::QVector3D::normalized;
  new (return$) ::QVector3D((self.*normalized$)());
}

void cxxbridge1$202$QVector3D$set_x(::QVector3D &self, float x) noexcept {
  void (::QVector3D::*set_x$)(float) = &::QVector3D::setX;
  (self.*set_x$)(x);
}

void cxxbridge1$202$QVector3D$set_y(::QVector3D &self, float y) noexcept {
  void (::QVector3D::*set_y$)(float) = &::QVector3D::setY;
  (self.*set_y$)(y);
}

void cxxbridge1$202$QVector3D$set_z(::QVector3D &self, float z) noexcept {
  void (::QVector3D::*set_z$)(float) = &::QVector3D::setZ;
  (self.*set_z$)(z);
}

void cxxbridge1$202$QVector3D$to_point(::QVector3D const &self, ::QPoint *return$) noexcept {
  ::QPoint (::QVector3D::*to_point$)() const = &::QVector3D::toPoint;
  new (return$) ::QPoint((self.*to_point$)());
}

void cxxbridge1$202$QVector3D$to_pointf(::QVector3D const &self, ::QPointF *return$) noexcept {
  ::QPointF (::QVector3D::*to_pointf$)() const = &::QVector3D::toPointF;
  new (return$) ::QPointF((self.*to_pointf$)());
}

void cxxbridge1$202$QVector3D$to_vector2d(::QVector3D const &self, ::QVector2D *return$) noexcept {
  ::QVector2D (::QVector3D::*to_vector2d$)() const = &::QVector3D::toVector2D;
  new (return$) ::QVector2D((self.*to_vector2d$)());
}

void cxxbridge1$202$QVector3D$to_vector4d(::QVector3D const &self, ::QVector4D *return$) noexcept {
  ::QVector4D (::QVector3D::*to_vector4d$)() const = &::QVector3D::toVector4D;
  new (return$) ::QVector4D((self.*to_vector4d$)());
}

float cxxbridge1$202$QVector3D$x(::QVector3D const &self) noexcept {
  float (::QVector3D::*x$)() const = &::QVector3D::x;
  return (self.*x$)();
}

float cxxbridge1$202$QVector3D$y(::QVector3D const &self) noexcept {
  float (::QVector3D::*y$)() const = &::QVector3D::y;
  return (self.*y$)();
}

float cxxbridge1$202$QVector3D$z(::QVector3D const &self) noexcept {
...
namespace cxxqtlib1 {
extern "C" {
void rust$cxxqtlib1$cxxbridge1$202$qvector3d_init_qvector4d(::QVector4D *vector, ::QVector3D *return$) noexcept {
...
void rust$cxxqtlib1$cxxbridge1$202$qvector3d_init_qvector2d(::QVector2D *vector, ::QVector3D *return$) noexcept {
...
void rust$cxxqtlib1$cxxbridge1$202$qvector3d_init_qpointf(::QPointF *point, ::QVector3D *return$) noexcept {
...
void rust$cxxqtlib1$cxxbridge1$202$qvector3d_init_qpoint(::QPoint *point, ::QVector3D *return$) noexcept {
  ::QVector3D (*qvector3d_init_qpoint$)(::QPoint) = ::rust::cxxqtlib1::construct;
  new (return$) ::QVector3D(qvector3d_init_qpoint$(::std::move(*point)));
}

void rust$cxxqtlib1$cxxbridge1$202$qvector3d_init(float x, float y, float z, ::QVector3D *return$) noexcept {
  ::QVector3D (*qvector3d_init$)(float, float, float) = ::rust::cxxqtlib1::construct;
  new (return$) ::QVector3D(qvector3d_init$(x, y, z));
}

void rust$cxxqtlib1$cxxbridge1$202$qvector3d_init_default(::QVector3D *return$) noexcept {
  ::QVector3D (*qvector3d_init_default$)() = ::rust::cxxqtlib1::construct;
  new (return$) ::QVector3D(qvector3d_init_default$());
}

float rust$cxxqtlib1$cxxbridge1$202$qvector3d_distance_to_line(::QVector3D const &vector, ::QVector3D *point, ::QVector3D *direction) noexcept {
...
float rust$cxxqtlib1$cxxbridge1$202$qvector3d_distance_to_plane(::QVector3D const &vector, ::QVector3D *point, ::QVector3D *normal) noexcept {
...
float rust$cxxqtlib1$cxxbridge1$202$qvector3d_distance_to_point(::QVector3D const &vector, ::QVector3D *point) noexcept {
...
void rust$cxxqtlib1$cxxbridge1$202$qvector3d_to_debug_qstring(::QVector3D const &value, ::QString *return$) noexcept {
...
void rust$cxxqtlib1$cxxbridge1$202$qvector3d_plus(::QVector3D const &a, ::QVector3D const &b, ::QVector3D *return$) noexcept {
...
void rust$cxxqtlib1$cxxbridge1$202$qvector3d_minus(::QVector3D const &a, ::QVector3D const &b, ::QVector3D *return$) noexcept {
...
void rust$cxxqtlib1$cxxbridge1$202$qvector3d_mul(float a, ::QVector3D const &b, ::QVector3D *return$) noexcept {
  ::QVector3D (*qvector3d_mul$)(float, ::QVector3D const &) = ::rust::cxxqtlib1::operatorMul;
  new (return$) ::QVector3D(qvector3d_mul$(a, b));
}

void rust$cxxqtlib1$cxxbridge1$202$qvector3d_div(float a, ::QVector3D const &b, ::QVector3D *return$) noexcept {
