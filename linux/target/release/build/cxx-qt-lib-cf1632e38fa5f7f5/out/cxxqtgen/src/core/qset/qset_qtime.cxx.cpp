...
extern "C" {
void cxxbridge1$202$QSet_QTime$cxx_clear(::QSet_QTime &self) noexcept {
  void (::QSet_QTime::*cxx_clear$)() = &::QSet_QTime::clear;
  (self.*cxx_clear$)();
}

bool cxxbridge1$202$QSet_QTime$cxx_contains(::QSet_QTime const &self, ::QTime const &arg0) noexcept {
  bool (::QSet_QTime::*cxx_contains$)(::QTime const &) const = &::QSet_QTime::contains;
  return (self.*cxx_contains$)(arg0);
}

bool cxxbridge1$202$QSet_QTime$cxx_remove(::QSet_QTime &self, ::QTime const &arg0) noexcept {
...
namespace cxxqtlib1 {
extern "C" {
void rust$cxxqtlib1$cxxbridge1$202$qset_clone_QTime(::QSet_QTime const &arg0, ::QSet_QTime *return$) noexcept {
  ::QSet_QTime (*qset_clone_QTime$)(::QSet_QTime const &) = ::rust::cxxqtlib1::construct;
  new (return$) ::QSet_QTime(qset_clone_QTime$(arg0));
}

void rust$cxxqtlib1$cxxbridge1$202$qset_default_QTime(::QSet_QTime *return$) noexcept {
  ::QSet_QTime (*qset_default_QTime$)() = ::rust::cxxqtlib1::construct;
  new (return$) ::QSet_QTime(qset_default_QTime$());
}

void rust$cxxqtlib1$cxxbridge1$202$qset_drop_QTime(::QSet_QTime &arg0) noexcept {
...
namespace qset {
extern "C" {
void rust$cxxqtlib1$qset$cxxbridge1$202$get_unchecked_QTime(::QSet_QTime const &set, ::rust::isize pos, ::QTime const **return$) noexcept {
...
void rust$cxxqtlib1$qset$cxxbridge1$202$insert_QTime(::QSet_QTime &arg0, ::QTime const &arg1) noexcept {
  void (*insert_QTime$)(::QSet_QTime &, ::QTime const &) = ::rust::cxxqtlib1::qset::qsetInsert;
  insert_QTime$(arg0, arg1);
}

::rust::isize rust$cxxqtlib1$qset$cxxbridge1$202$len_QTime(::QSet_QTime const &arg0) noexcept {
  ::rust::isize (*len_QTime$)(::QSet_QTime const &) = ::rust::cxxqtlib1::qset::qsetLen;
  return len_QTime$(arg0);
}

void rust$cxxqtlib1$qset$cxxbridge1$202$reserve_QTime(::QSet_QTime &arg0, ::rust::isize size) noexcept {
