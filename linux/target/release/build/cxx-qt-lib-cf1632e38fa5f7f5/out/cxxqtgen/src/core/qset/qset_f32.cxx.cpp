...
extern "C" {
void cxxbridge1$202$QSet_f32$cxx_clear(::QSet_f32 &self) noexcept {
  void (::QSet_f32::*cxx_clear$)() = &::QSet_f32::clear;
  (self.*cxx_clear$)();
}

bool cxxbridge1$202$QSet_f32$cxx_contains(::QSet_f32 const &self, float const &arg0) noexcept {
  bool (::QSet_f32::*cxx_contains$)(float const &) const = &::QSet_f32::contains;
  return (self.*cxx_contains$)(arg0);
}

bool cxxbridge1$202$QSet_f32$cxx_remove(::QSet_f32 &self, float const &arg0) noexcept {
...
namespace cxxqtlib1 {
extern "C" {
void rust$cxxqtlib1$cxxbridge1$202$qset_clone_f32(::QSet_f32 const &arg0, ::QSet_f32 *return$) noexcept {
  ::QSet_f32 (*qset_clone_f32$)(::QSet_f32 const &) = ::rust::cxxqtlib1::construct;
  new (return$) ::QSet_f32(qset_clone_f32$(arg0));
}

void rust$cxxqtlib1$cxxbridge1$202$qset_default_f32(::QSet_f32 *return$) noexcept {
  ::QSet_f32 (*qset_default_f32$)() = ::rust::cxxqtlib1::construct;
  new (return$) ::QSet_f32(qset_default_f32$());
}

void rust$cxxqtlib1$cxxbridge1$202$qset_drop_f32(::QSet_f32 &arg0) noexcept {
...
namespace qset {
extern "C" {
float const *rust$cxxqtlib1$qset$cxxbridge1$202$get_unchecked_f32(::QSet_f32 const &set, ::rust::isize pos) noexcept {
...
void rust$cxxqtlib1$qset$cxxbridge1$202$insert_f32(::QSet_f32 &arg0, float const &arg1) noexcept {
  void (*insert_f32$)(::QSet_f32 &, float const &) = ::rust::cxxqtlib1::qset::qsetInsert;
  insert_f32$(arg0, arg1);
}

::rust::isize rust$cxxqtlib1$qset$cxxbridge1$202$len_f32(::QSet_f32 const &arg0) noexcept {
  ::rust::isize (*len_f32$)(::QSet_f32 const &) = ::rust::cxxqtlib1::qset::qsetLen;
  return len_f32$(arg0);
}

void rust$cxxqtlib1$qset$cxxbridge1$202$reserve_f32(::QSet_f32 &arg0, ::rust::isize size) noexcept {
