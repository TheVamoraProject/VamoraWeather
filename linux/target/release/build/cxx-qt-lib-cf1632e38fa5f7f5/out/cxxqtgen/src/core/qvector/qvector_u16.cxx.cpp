...
extern "C" {
void cxxbridge1$202$QVector_u16$cxx_clear(::QVector_u16 &self) noexcept {
  void (::QVector_u16::*cxx_clear$)() = &::QVector_u16::clear;
  (self.*cxx_clear$)();
}

bool cxxbridge1$202$QVector_u16$cxx_contains(::QVector_u16 const &self, ::std::uint16_t const &arg0) noexcept {
...
namespace cxxqtlib1 {
extern "C" {
void rust$cxxqtlib1$cxxbridge1$202$qvector_clone_u16(::QVector_u16 const &arg0, ::QVector_u16 *return$) noexcept {
  ::QVector_u16 (*qvector_clone_u16$)(::QVector_u16 const &) = ::rust::cxxqtlib1::construct;
  new (return$) ::QVector_u16(qvector_clone_u16$(arg0));
}

void rust$cxxqtlib1$cxxbridge1$202$qvector_default_u16(::QVector_u16 *return$) noexcept {
  ::QVector_u16 (*qvector_default_u16$)() = ::rust::cxxqtlib1::construct;
  new (return$) ::QVector_u16(qvector_default_u16$());
}

void rust$cxxqtlib1$cxxbridge1$202$qvector_drop_u16(::QVector_u16 &arg0) noexcept {
...
namespace qvector {
extern "C" {
void rust$cxxqtlib1$qvector$cxxbridge1$202$reserve_u16(::QVector_u16 &arg0, ::rust::isize size) noexcept {
  void (*reserve_u16$)(::QVector_u16 &, ::rust::isize) = ::rust::cxxqtlib1::qvector::qvectorReserve;
  reserve_u16$(arg0, size);
}

void rust$cxxqtlib1$qvector$cxxbridge1$202$append_u16(::QVector_u16 &arg0, ::std::uint16_t const &arg1) noexcept {
  void (*append_u16$)(::QVector_u16 &, ::std::uint16_t const &) = ::rust::cxxqtlib1::qvector::qvectorAppend;
  append_u16$(arg0, arg1);
}

::std::uint16_t const *rust$cxxqtlib1$qvector$cxxbridge1$202$get_unchecked_u16(::QVector_u16 const &set, ::rust::isize pos) noexcept {
...
::rust::isize rust$cxxqtlib1$qvector$cxxbridge1$202$index_of_u16(::QVector_u16 const &arg0, ::std::uint16_t const &arg1) noexcept {
...
void rust$cxxqtlib1$qvector$cxxbridge1$202$insert_u16(::QVector_u16 &arg0, ::rust::isize arg1, ::std::uint16_t const &arg2) noexcept {
  void (*insert_u16$)(::QVector_u16 &, ::rust::isize, ::std::uint16_t const &) = ::rust::cxxqtlib1::qvector::qvectorInsert;
  insert_u16$(arg0, arg1, arg2);
}

::rust::isize rust$cxxqtlib1$qvector$cxxbridge1$202$len_u16(::QVector_u16 const &arg0) noexcept {
  ::rust::isize (*len_u16$)(::QVector_u16 const &) = ::rust::cxxqtlib1::qvector::qvectorLen;
  return len_u16$(arg0);
}

void rust$cxxqtlib1$qvector$cxxbridge1$202$remove_u16(::QVector_u16 &arg0, ::rust::isize arg1) noexcept {
