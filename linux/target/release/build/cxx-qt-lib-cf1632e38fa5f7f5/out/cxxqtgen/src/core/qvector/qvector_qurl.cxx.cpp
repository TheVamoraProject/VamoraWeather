...
extern "C" {
void cxxbridge1$202$QVector_QUrl$cxx_clear(::QVector_QUrl &self) noexcept {
  void (::QVector_QUrl::*cxx_clear$)() = &::QVector_QUrl::clear;
  (self.*cxx_clear$)();
}

bool cxxbridge1$202$QVector_QUrl$cxx_contains(::QVector_QUrl const &self, ::QUrl const &arg0) noexcept {
...
namespace cxxqtlib1 {
extern "C" {
void rust$cxxqtlib1$cxxbridge1$202$qvector_clone_QUrl(::QVector_QUrl const &arg0, ::QVector_QUrl *return$) noexcept {
...
void rust$cxxqtlib1$cxxbridge1$202$qvector_default_QUrl(::QVector_QUrl *return$) noexcept {
  ::QVector_QUrl (*qvector_default_QUrl$)() = ::rust::cxxqtlib1::construct;
  new (return$) ::QVector_QUrl(qvector_default_QUrl$());
}

void rust$cxxqtlib1$cxxbridge1$202$qvector_drop_QUrl(::QVector_QUrl &arg0) noexcept {
...
namespace qvector {
extern "C" {
void rust$cxxqtlib1$qvector$cxxbridge1$202$reserve_QUrl(::QVector_QUrl &arg0, ::rust::isize size) noexcept {
  void (*reserve_QUrl$)(::QVector_QUrl &, ::rust::isize) = ::rust::cxxqtlib1::qvector::qvectorReserve;
  reserve_QUrl$(arg0, size);
}

void rust$cxxqtlib1$qvector$cxxbridge1$202$append_QUrl(::QVector_QUrl &arg0, ::QUrl const &arg1) noexcept {
  void (*append_QUrl$)(::QVector_QUrl &, ::QUrl const &) = ::rust::cxxqtlib1::qvector::qvectorAppend;
  append_QUrl$(arg0, arg1);
}

void rust$cxxqtlib1$qvector$cxxbridge1$202$get_unchecked_QUrl(::QVector_QUrl const &set, ::rust::isize pos, ::QUrl const **return$) noexcept {
...
::rust::isize rust$cxxqtlib1$qvector$cxxbridge1$202$index_of_QUrl(::QVector_QUrl const &arg0, ::QUrl const &arg1) noexcept {
...
void rust$cxxqtlib1$qvector$cxxbridge1$202$insert_QUrl(::QVector_QUrl &arg0, ::rust::isize arg1, ::QUrl const &arg2) noexcept {
  void (*insert_QUrl$)(::QVector_QUrl &, ::rust::isize, ::QUrl const &) = ::rust::cxxqtlib1::qvector::qvectorInsert;
  insert_QUrl$(arg0, arg1, arg2);
}

void rust$cxxqtlib1$qvector$cxxbridge1$202$remove_QUrl(::QVector_QUrl &arg0, ::rust::isize arg1) noexcept {
  void (*remove_QUrl$)(::QVector_QUrl &, ::rust::isize) = ::rust::cxxqtlib1::qvector::qvectorRemove;
  remove_QUrl$(arg0, arg1);
}

::rust::isize rust$cxxqtlib1$qvector$cxxbridge1$202$len_QUrl(::QVector_QUrl const &arg0) noexcept {
