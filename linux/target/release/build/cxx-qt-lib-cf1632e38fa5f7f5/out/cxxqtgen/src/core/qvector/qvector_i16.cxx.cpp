...
extern "C" {
void cxxbridge1$202$QVector_i16$cxx_clear(::QVector_i16 &self) noexcept {
  void (::QVector_i16::*cxx_clear$)() = &::QVector_i16::clear;
  (self.*cxx_clear$)();
}

bool cxxbridge1$202$QVector_i16$cxx_contains(::QVector_i16 const &self, ::std::int16_t const &arg0) noexcept {
...
namespace cxxqtlib1 {
extern "C" {
void rust$cxxqtlib1$cxxbridge1$202$qvector_clone_i16(::QVector_i16 const &arg0, ::QVector_i16 *return$) noexcept {
  ::QVector_i16 (*qvector_clone_i16$)(::QVector_i16 const &) = ::rust::cxxqtlib1::construct;
  new (return$) ::QVector_i16(qvector_clone_i16$(arg0));
}

void rust$cxxqtlib1$cxxbridge1$202$qvector_default_i16(::QVector_i16 *return$) noexcept {
  ::QVector_i16 (*qvector_default_i16$)() = ::rust::cxxqtlib1::construct;
  new (return$) ::QVector_i16(qvector_default_i16$());
}

void rust$cxxqtlib1$cxxbridge1$202$qvector_drop_i16(::QVector_i16 &arg0) noexcept {
...
namespace qvector {
extern "C" {
void rust$cxxqtlib1$qvector$cxxbridge1$202$reserve_i16(::QVector_i16 &arg0, ::rust::isize size) noexcept {
  void (*reserve_i16$)(::QVector_i16 &, ::rust::isize) = ::rust::cxxqtlib1::qvector::qvectorReserve;
  reserve_i16$(arg0, size);
}

void rust$cxxqtlib1$qvector$cxxbridge1$202$append_i16(::QVector_i16 &arg0, ::std::int16_t const &arg1) noexcept {
  void (*append_i16$)(::QVector_i16 &, ::std::int16_t const &) = ::rust::cxxqtlib1::qvector::qvectorAppend;
  append_i16$(arg0, arg1);
}

::std::int16_t const *rust$cxxqtlib1$qvector$cxxbridge1$202$get_unchecked_i16(::QVector_i16 const &set, ::rust::isize pos) noexcept {
...
::rust::isize rust$cxxqtlib1$qvector$cxxbridge1$202$index_of_i16(::QVector_i16 const &arg0, ::std::int16_t const &arg1) noexcept {
...
void rust$cxxqtlib1$qvector$cxxbridge1$202$insert_i16(::QVector_i16 &arg0, ::rust::isize arg1, ::std::int16_t const &arg2) noexcept {
  void (*insert_i16$)(::QVector_i16 &, ::rust::isize, ::std::int16_t const &) = ::rust::cxxqtlib1::qvector::qvectorInsert;
  insert_i16$(arg0, arg1, arg2);
}

::rust::isize rust$cxxqtlib1$qvector$cxxbridge1$202$len_i16(::QVector_i16 const &arg0) noexcept {
  ::rust::isize (*len_i16$)(::QVector_i16 const &) = ::rust::cxxqtlib1::qvector::qvectorLen;
  return len_i16$(arg0);
}

void rust$cxxqtlib1$qvector$cxxbridge1$202$remove_i16(::QVector_i16 &arg0, ::rust::isize arg1) noexcept {
