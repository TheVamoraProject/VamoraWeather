...
extern "C" {
void cxxbridge1$202$QList_u64$cxx_clear(::QList_u64 &self) noexcept {
  void (::QList_u64::*cxx_clear$)() = &::QList_u64::clear;
  (self.*cxx_clear$)();
}

bool cxxbridge1$202$QList_u64$cxx_contains(::QList_u64 const &self, ::std::uint64_t const &arg0) noexcept {
...
namespace cxxqtlib1 {
extern "C" {
void rust$cxxqtlib1$cxxbridge1$202$qlist_clone_u64(::QList_u64 const &arg0, ::QList_u64 *return$) noexcept {
  ::QList_u64 (*qlist_clone_u64$)(::QList_u64 const &) = ::rust::cxxqtlib1::construct;
  new (return$) ::QList_u64(qlist_clone_u64$(arg0));
}

void rust$cxxqtlib1$cxxbridge1$202$qlist_default_u64(::QList_u64 *return$) noexcept {
  ::QList_u64 (*qlist_default_u64$)() = ::rust::cxxqtlib1::construct;
  new (return$) ::QList_u64(qlist_default_u64$());
}

void rust$cxxqtlib1$cxxbridge1$202$qlist_drop_u64(::QList_u64 &arg0) noexcept {
...
namespace qlist {
extern "C" {
void rust$cxxqtlib1$qlist$cxxbridge1$202$reserve_u64(::QList_u64 &arg0, ::rust::isize size) noexcept {
  void (*reserve_u64$)(::QList_u64 &, ::rust::isize) = ::rust::cxxqtlib1::qlist::qlistReserve;
  reserve_u64$(arg0, size);
}

void rust$cxxqtlib1$qlist$cxxbridge1$202$append_u64(::QList_u64 &arg0, ::std::uint64_t const &arg1) noexcept {
  void (*append_u64$)(::QList_u64 &, ::std::uint64_t const &) = ::rust::cxxqtlib1::qlist::qlistAppend;
  append_u64$(arg0, arg1);
}

::std::uint64_t const *rust$cxxqtlib1$qlist$cxxbridge1$202$get_unchecked_u64(::QList_u64 const &set, ::rust::isize pos) noexcept {
...
::rust::isize rust$cxxqtlib1$qlist$cxxbridge1$202$index_of_u64(::QList_u64 const &arg0, ::std::uint64_t const &arg1) noexcept {
...
void rust$cxxqtlib1$qlist$cxxbridge1$202$insert_u64(::QList_u64 &arg0, ::rust::isize arg1, ::std::uint64_t const &arg2) noexcept {
  void (*insert_u64$)(::QList_u64 &, ::rust::isize, ::std::uint64_t const &) = ::rust::cxxqtlib1::qlist::qlistInsert;
  insert_u64$(arg0, arg1, arg2);
}

::rust::isize rust$cxxqtlib1$qlist$cxxbridge1$202$len_u64(::QList_u64 const &arg0) noexcept {
  ::rust::isize (*len_u64$)(::QList_u64 const &) = ::rust::cxxqtlib1::qlist::qlistLen;
  return len_u64$(arg0);
}

void rust$cxxqtlib1$qlist$cxxbridge1$202$remove_u64(::QList_u64 &arg0, ::rust::isize arg1) noexcept {
