...
extern "C" {
void cxxbridge1$202$QSize$bounded_to(::QSize const &self, ::QSize const &other_size, ::QSize *return$) noexcept {
  ::QSize (::QSize::*bounded_to$)(::QSize const &) const = &::QSize::boundedTo;
  new (return$) ::QSize((self.*bounded_to$)(other_size));
}

void cxxbridge1$202$QSize$expanded_to(::QSize const &self, ::QSize const &other_size, ::QSize *return$) noexcept {
  ::QSize (::QSize::*expanded_to$)(::QSize const &) const = &::QSize::expandedTo;
  new (return$) ::QSize((self.*expanded_to$)(other_size));
}

::std::int32_t cxxbridge1$202$QSize$height(::QSize const &self) noexcept {
  ::std::int32_t (::QSize::*height$)() const = &::QSize::height;
  return (self.*height$)();
}

bool cxxbridge1$202$QSize$is_empty(::QSize const &self) noexcept {
  bool (::QSize::*is_empty$)() const = &::QSize::isEmpty;
  return (self.*is_empty$)();
}

bool cxxbridge1$202$QSize$is_null(::QSize const &self) noexcept {
  bool (::QSize::*is_null$)() const = &::QSize::isNull;
  return (self.*is_null$)();
}

bool cxxbridge1$202$QSize$is_valid(::QSize const &self) noexcept {
  bool (::QSize::*is_valid$)() const = &::QSize::isValid;
  return (self.*is_valid$)();
}

void cxxbridge1$202$QSize$grown_by(::QSize const &self, ::QMargins *margins, ::QSize *return$) noexcept {
  ::QSize (::QSize::*grown_by$)(::QMargins) const = &::QSize::grownBy;
  new (return$) ::QSize((self.*grown_by$)(::std::move(*margins)));
}

void cxxbridge1$202$QSize$scale(::QSize &self, ::QSize const &size, ::Qt::AspectRatioMode *mode) noexcept {
  void (::QSize::*scale$)(::QSize const &, ::Qt::AspectRatioMode) = &::QSize::scale;
  (self.*scale$)(size, ::std::move(*mode));
}

void cxxbridge1$202$QSize$scaled(::QSize const &self, ::QSize const &s, ::Qt::AspectRatioMode *mode, ::QSize *return$) noexcept {
  ::QSize (::QSize::*scaled$)(::QSize const &, ::Qt::AspectRatioMode) const = &::QSize::scaled;
  new (return$) ::QSize((self.*scaled$)(s, ::std::move(*mode)));
}

void cxxbridge1$202$QSize$set_height(::QSize &self, ::std::int32_t height) noexcept {
  void (::QSize::*set_height$)(::std::int32_t) = &::QSize::setHeight;
  (self.*set_height$)(height);
}

void cxxbridge1$202$QSize$set_width(::QSize &self, ::std::int32_t width) noexcept {
  void (::QSize::*set_width$)(::std::int32_t) = &::QSize::setWidth;
  (self.*set_width$)(width);
}

void cxxbridge1$202$QSize$shrunk_by(::QSize const &self, ::QMargins *margins, ::QSize *return$) noexcept {
  ::QSize (::QSize::*shrunk_by$)(::QMargins) const = &::QSize::shrunkBy;
  new (return$) ::QSize((self.*shrunk_by$)(::std::move(*margins)));
}

void cxxbridge1$202$QSize$to_sizef(::QSize const &self, ::QSizeF *return$) noexcept {
  ::QSizeF (::QSize::*to_sizef$)() const = &::QSize::toSizeF;
  new (return$) ::QSizeF((self.*to_sizef$)());
}

void cxxbridge1$202$QSize$transpose(::QSize &self) noexcept {
  void (::QSize::*transpose$)() = &::QSize::transpose;
  (self.*transpose$)();
}

void cxxbridge1$202$QSize$transposed(::QSize const &self, ::QSize *return$) noexcept {
  ::QSize (::QSize::*transposed$)() const = &::QSize::transposed;
  new (return$) ::QSize((self.*transposed$)());
}

::std::int32_t cxxbridge1$202$QSize$width(::QSize const &self) noexcept {
...
namespace cxxqtlib1 {
extern "C" {
void rust$cxxqtlib1$cxxbridge1$202$qsize_init_default(::QSize *return$) noexcept {
  ::QSize (*qsize_init_default$)() = ::rust::cxxqtlib1::construct;
  new (return$) ::QSize(qsize_init_default$());
}

void rust$cxxqtlib1$cxxbridge1$202$qsize_init(::std::int32_t w, ::std::int32_t h, ::QSize *return$) noexcept {
  ::QSize (*qsize_init$)(::std::int32_t, ::std::int32_t) = ::rust::cxxqtlib1::construct;
  new (return$) ::QSize(qsize_init$(w, h));
}

void rust$cxxqtlib1$cxxbridge1$202$qsize_to_debug_qstring(::QSize const &value, ::QString *return$) noexcept {
  ::QString (*qsize_to_debug_qstring$)(::QSize const &) = ::rust::cxxqtlib1::toDebugQString;
  new (return$) ::QString(qsize_to_debug_qstring$(value));
}

void rust$cxxqtlib1$cxxbridge1$202$qsize_plus(::QSize const &a, ::QSize const &b, ::QSize *return$) noexcept {
  ::QSize (*qsize_plus$)(::QSize const &, ::QSize const &) = ::rust::cxxqtlib1::operatorPlus;
  new (return$) ::QSize(qsize_plus$(a, b));
}

void rust$cxxqtlib1$cxxbridge1$202$qsize_minus(::QSize const &a, ::QSize const &b, ::QSize *return$) noexcept {
  ::QSize (*qsize_minus$)(::QSize const &, ::QSize const &) = ::rust::cxxqtlib1::operatorMinus;
  new (return$) ::QSize(qsize_minus$(a, b));
}

void rust$cxxqtlib1$cxxbridge1$202$qsize_mul(double a, ::QSize const &b, ::QSize *return$) noexcept {
  ::QSize (*qsize_mul$)(double, ::QSize const &) = ::rust::cxxqtlib1::operatorMul;
  new (return$) ::QSize(qsize_mul$(a, b));
}

void rust$cxxqtlib1$cxxbridge1$202$qsize_div(double a, ::QSize const &b, ::QSize *return$) noexcept {
