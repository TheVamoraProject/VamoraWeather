...
extern "C" {
void cxxbridge1$202$QVector_QSizeF$cxx_clear(::QVector_QSizeF &self) noexcept {
  void (::QVector_QSizeF::*cxx_clear$)() = &::QVector_QSizeF::clear;
  (self.*cxx_clear$)();
}

bool cxxbridge1$202$QVector_QSizeF$cxx_contains(::QVector_QSizeF const &self, ::QSizeF const &arg0) noexcept {
...
namespace cxxqtlib1 {
extern "C" {
void rust$cxxqtlib1$cxxbridge1$202$qvector_clone_QSizeF(::QVector_QSizeF const &arg0, ::QVector_QSizeF *return$) noexcept {
...
void rust$cxxqtlib1$cxxbridge1$202$qvector_default_QSizeF(::QVector_QSizeF *return$) noexcept {
  ::QVector_QSizeF (*qvector_default_QSizeF$)() = ::rust::cxxqtlib1::construct;
  new (return$) ::QVector_QSizeF(qvector_default_QSizeF$());
}

void rust$cxxqtlib1$cxxbridge1$202$qvector_drop_QSizeF(::QVector_QSizeF &arg0) noexcept {
...
namespace qvector {
extern "C" {
void rust$cxxqtlib1$qvector$cxxbridge1$202$reserve_QSizeF(::QVector_QSizeF &arg0, ::rust::isize size) noexcept {
  void (*reserve_QSizeF$)(::QVector_QSizeF &, ::rust::isize) = ::rust::cxxqtlib1::qvector::qvectorReserve;
  reserve_QSizeF$(arg0, size);
}

void rust$cxxqtlib1$qvector$cxxbridge1$202$append_QSizeF(::QVector_QSizeF &arg0, ::QSizeF const &arg1) noexcept {
  void (*append_QSizeF$)(::QVector_QSizeF &, ::QSizeF const &) = ::rust::cxxqtlib1::qvector::qvectorAppend;
  append_QSizeF$(arg0, arg1);
}

void rust$cxxqtlib1$qvector$cxxbridge1$202$get_unchecked_QSizeF(::QVector_QSizeF const &set, ::rust::isize pos, ::QSizeF const **return$) noexcept {
...
::rust::isize rust$cxxqtlib1$qvector$cxxbridge1$202$index_of_QSizeF(::QVector_QSizeF const &arg0, ::QSizeF const &arg1) noexcept {
...
void rust$cxxqtlib1$qvector$cxxbridge1$202$insert_QSizeF(::QVector_QSizeF &arg0, ::rust::isize arg1, ::QSizeF const &arg2) noexcept {
...
void rust$cxxqtlib1$qvector$cxxbridge1$202$remove_QSizeF(::QVector_QSizeF &arg0, ::rust::isize arg1) noexcept {
  void (*remove_QSizeF$)(::QVector_QSizeF &, ::rust::isize) = ::rust::cxxqtlib1::qvector::qvectorRemove;
  remove_QSizeF$(arg0, arg1);
}

::rust::isize rust$cxxqtlib1$qvector$cxxbridge1$202$len_QSizeF(::QVector_QSizeF const &arg0) noexcept {
