...
extern "C" {
void cxxbridge1$202$QVector_f64$cxx_clear(::QVector_f64 &self) noexcept {
  void (::QVector_f64::*cxx_clear$)() = &::QVector_f64::clear;
  (self.*cxx_clear$)();
}

bool cxxbridge1$202$QVector_f64$cxx_contains(::QVector_f64 const &self, double const &arg0) noexcept {
...
namespace cxxqtlib1 {
extern "C" {
void rust$cxxqtlib1$cxxbridge1$202$qvector_clone_f64(::QVector_f64 const &arg0, ::QVector_f64 *return$) noexcept {
  ::QVector_f64 (*qvector_clone_f64$)(::QVector_f64 const &) = ::rust::cxxqtlib1::construct;
  new (return$) ::QVector_f64(qvector_clone_f64$(arg0));
}

void rust$cxxqtlib1$cxxbridge1$202$qvector_default_f64(::QVector_f64 *return$) noexcept {
  ::QVector_f64 (*qvector_default_f64$)() = ::rust::cxxqtlib1::construct;
  new (return$) ::QVector_f64(qvector_default_f64$());
}

void rust$cxxqtlib1$cxxbridge1$202$qvector_drop_f64(::QVector_f64 &arg0) noexcept {
...
namespace qvector {
extern "C" {
void rust$cxxqtlib1$qvector$cxxbridge1$202$reserve_f64(::QVector_f64 &arg0, ::rust::isize size) noexcept {
  void (*reserve_f64$)(::QVector_f64 &, ::rust::isize) = ::rust::cxxqtlib1::qvector::qvectorReserve;
  reserve_f64$(arg0, size);
}

void rust$cxxqtlib1$qvector$cxxbridge1$202$append_f64(::QVector_f64 &arg0, double const &arg1) noexcept {
  void (*append_f64$)(::QVector_f64 &, double const &) = ::rust::cxxqtlib1::qvector::qvectorAppend;
  append_f64$(arg0, arg1);
}

double const *rust$cxxqtlib1$qvector$cxxbridge1$202$get_unchecked_f64(::QVector_f64 const &set, ::rust::isize pos) noexcept {
...
::rust::isize rust$cxxqtlib1$qvector$cxxbridge1$202$index_of_f64(::QVector_f64 const &arg0, double const &arg1) noexcept {
...
void rust$cxxqtlib1$qvector$cxxbridge1$202$insert_f64(::QVector_f64 &arg0, ::rust::isize arg1, double const &arg2) noexcept {
  void (*insert_f64$)(::QVector_f64 &, ::rust::isize, double const &) = ::rust::cxxqtlib1::qvector::qvectorInsert;
  insert_f64$(arg0, arg1, arg2);
}

::rust::isize rust$cxxqtlib1$qvector$cxxbridge1$202$len_f64(::QVector_f64 const &arg0) noexcept {
  ::rust::isize (*len_f64$)(::QVector_f64 const &) = ::rust::cxxqtlib1::qvector::qvectorLen;
  return len_f64$(arg0);
}

void rust$cxxqtlib1$qvector$cxxbridge1$202$remove_f64(::QVector_f64 &arg0, ::rust::isize arg1) noexcept {
