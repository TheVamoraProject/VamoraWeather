...
extern "C" {
bool cxxbridge1$202$QAnyStringView$is_empty(::QAnyStringView const &self) noexcept {
  bool (::QAnyStringView::*is_empty$)() const = &::QAnyStringView::isEmpty;
  return (self.*is_empty$)();
}

bool cxxbridge1$202$QAnyStringView$is_null(::QAnyStringView const &self) noexcept {
  bool (::QAnyStringView::*is_null$)() const = &::QAnyStringView::isNull;
  return (self.*is_null$)();
}

void cxxbridge1$202$QAnyStringView$to_qstring(::QAnyStringView const &self, ::QString *return$) noexcept {
...
namespace cxxqtlib1 {
extern "C" {
void rust$cxxqtlib1$cxxbridge1$202$QAnyStringView_init_default(::QAnyStringView *return$) noexcept {
  ::QAnyStringView (*QAnyStringView_init_default$)() = ::rust::cxxqtlib1::construct;
  new (return$) ::QAnyStringView(QAnyStringView_init_default$());
}

void rust$cxxqtlib1$cxxbridge1$202$QAnyStringView_init_from_rust_string(::rust::Str string, ::QAnyStringView *return$) noexcept {
...
void rust$cxxqtlib1$cxxbridge1$202$QAnyStringView_init_from_qbytearray(::QByteArray const &bytes, ::QAnyStringView *return$) noexcept {
...
void rust$cxxqtlib1$cxxbridge1$202$QAnyStringView_init_from_qstring(::QString const &string, ::QAnyStringView *return$) noexcept {
...
void rust$cxxqtlib1$cxxbridge1$202$QAnyStringView_init_from_QAnyStringView(::QAnyStringView const &string, ::QAnyStringView *return$) noexcept {
...
bool rust$cxxqtlib1$cxxbridge1$202$QAnyStringView_eq(::QAnyStringView const &a, ::QAnyStringView const &b) noexcept {
  bool (*QAnyStringView_eq$)(::QAnyStringView const &, ::QAnyStringView const &) = ::rust::cxxqtlib1::operatorEq;
  return QAnyStringView_eq$(a, b);
}

::rust::isize rust$cxxqtlib1$cxxbridge1$202$QAnyStringView_len(::QAnyStringView const &string) noexcept {
