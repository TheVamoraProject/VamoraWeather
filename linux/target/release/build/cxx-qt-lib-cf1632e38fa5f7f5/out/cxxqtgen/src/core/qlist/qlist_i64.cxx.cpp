...
extern "C" {
void cxxbridge1$202$QList_i64$cxx_clear(::QList_i64 &self) noexcept {
  void (::QList_i64::*cxx_clear$)() = &::QList_i64::clear;
  (self.*cxx_clear$)();
}

bool cxxbridge1$202$QList_i64$cxx_contains(::QList_i64 const &self, ::std::int64_t const &arg0) noexcept {
...
namespace cxxqtlib1 {
extern "C" {
void rust$cxxqtlib1$cxxbridge1$202$qlist_clone_i64(::QList_i64 const &arg0, ::QList_i64 *return$) noexcept {
  ::QList_i64 (*qlist_clone_i64$)(::QList_i64 const &) = ::rust::cxxqtlib1::construct;
  new (return$) ::QList_i64(qlist_clone_i64$(arg0));
}

void rust$cxxqtlib1$cxxbridge1$202$qlist_default_i64(::QList_i64 *return$) noexcept {
  ::QList_i64 (*qlist_default_i64$)() = ::rust::cxxqtlib1::construct;
  new (return$) ::QList_i64(qlist_default_i64$());
}

void rust$cxxqtlib1$cxxbridge1$202$qlist_drop_i64(::QList_i64 &arg0) noexcept {
...
namespace qlist {
extern "C" {
void rust$cxxqtlib1$qlist$cxxbridge1$202$reserve_i64(::QList_i64 &arg0, ::rust::isize size) noexcept {
  void (*reserve_i64$)(::QList_i64 &, ::rust::isize) = ::rust::cxxqtlib1::qlist::qlistReserve;
  reserve_i64$(arg0, size);
}

void rust$cxxqtlib1$qlist$cxxbridge1$202$append_i64(::QList_i64 &arg0, ::std::int64_t const &arg1) noexcept {
  void (*append_i64$)(::QList_i64 &, ::std::int64_t const &) = ::rust::cxxqtlib1::qlist::qlistAppend;
  append_i64$(arg0, arg1);
}

::std::int64_t const *rust$cxxqtlib1$qlist$cxxbridge1$202$get_unchecked_i64(::QList_i64 const &set, ::rust::isize pos) noexcept {
...
::rust::isize rust$cxxqtlib1$qlist$cxxbridge1$202$index_of_i64(::QList_i64 const &arg0, ::std::int64_t const &arg1) noexcept {
  ::rust::isize (*index_of_i64$)(::QList_i64 const &, ::std::int64_t const &) = ::rust::cxxqtlib1::qlist::qlistIndexOf;
  return index_of_i64$(arg0, arg1);
}

void rust$cxxqtlib1$qlist$cxxbridge1$202$insert_i64(::QList_i64 &arg0, ::rust::isize arg1, ::std::int64_t const &arg2) noexcept {
  void (*insert_i64$)(::QList_i64 &, ::rust::isize, ::std::int64_t const &) = ::rust::cxxqtlib1::qlist::qlistInsert;
  insert_i64$(arg0, arg1, arg2);
}

::rust::isize rust$cxxqtlib1$qlist$cxxbridge1$202$len_i64(::QList_i64 const &arg0) noexcept {
  ::rust::isize (*len_i64$)(::QList_i64 const &) = ::rust::cxxqtlib1::qlist::qlistLen;
  return len_i64$(arg0);
}

void rust$cxxqtlib1$qlist$cxxbridge1$202$remove_i64(::QList_i64 &arg0, ::rust::isize arg1) noexcept {
