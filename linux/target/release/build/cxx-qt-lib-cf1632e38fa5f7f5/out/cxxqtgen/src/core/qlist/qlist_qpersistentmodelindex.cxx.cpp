...
extern "C" {
void cxxbridge1$202$QList_QPersistentModelIndex$cxx_clear(::QList_QPersistentModelIndex &self) noexcept {
  void (::QList_QPersistentModelIndex::*cxx_clear$)() = &::QList_QPersistentModelIndex::clear;
  (self.*cxx_clear$)();
}

bool cxxbridge1$202$QList_QPersistentModelIndex$cxx_contains(::QList_QPersistentModelIndex const &self, ::QPersistentModelIndex const &arg0) noexcept {
...
namespace cxxqtlib1 {
extern "C" {
void rust$cxxqtlib1$cxxbridge1$202$qlist_clone_QPersistentModelIndex(::QList_QPersistentModelIndex const &arg0, ::QList_QPersistentModelIndex *return$) noexcept {
...
void rust$cxxqtlib1$cxxbridge1$202$qlist_default_QPersistentModelIndex(::QList_QPersistentModelIndex *return$) noexcept {
...
void rust$cxxqtlib1$cxxbridge1$202$qlist_drop_QPersistentModelIndex(::QList_QPersistentModelIndex &arg0) noexcept {
...
namespace qlist {
extern "C" {
void rust$cxxqtlib1$qlist$cxxbridge1$202$reserve_QPersistentModelIndex(::QList_QPersistentModelIndex &arg0, ::rust::isize size) noexcept {
...
void rust$cxxqtlib1$qlist$cxxbridge1$202$append_QPersistentModelIndex(::QList_QPersistentModelIndex &arg0, ::QPersistentModelIndex const &arg1) noexcept {
...
void rust$cxxqtlib1$qlist$cxxbridge1$202$get_unchecked_QPersistentModelIndex(::QList_QPersistentModelIndex const &set, ::rust::isize pos, ::QPersistentModelIndex const **return$) noexcept {
...
::rust::isize rust$cxxqtlib1$qlist$cxxbridge1$202$index_of_QPersistentModelIndex(::QList_QPersistentModelIndex const &arg0, ::QPersistentModelIndex const &arg1) noexcept {
...
void rust$cxxqtlib1$qlist$cxxbridge1$202$insert_QPersistentModelIndex(::QList_QPersistentModelIndex &arg0, ::rust::isize arg1, ::QPersistentModelIndex const &arg2) noexcept {
...
void rust$cxxqtlib1$qlist$cxxbridge1$202$remove_QPersistentModelIndex(::QList_QPersistentModelIndex &arg0, ::rust::isize arg1) noexcept {
...
::rust::isize rust$cxxqtlib1$qlist$cxxbridge1$202$len_QPersistentModelIndex(::QList_QPersistentModelIndex const &arg0) noexcept {
