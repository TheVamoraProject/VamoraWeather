...
extern "C" {
::std::int32_t cxxbridge1$202$QMargins$bottom(::QMargins const &self) noexcept {
  ::std::int32_t (::QMargins::*bottom$)() const = &::QMargins::bottom;
  return (self.*bottom$)();
}

bool cxxbridge1$202$QMargins$is_null(::QMargins const &self) noexcept {
  bool (::QMargins::*is_null$)() const = &::QMargins::isNull;
  return (self.*is_null$)();
}

::std::int32_t cxxbridge1$202$QMargins$left(::QMargins const &self) noexcept {
  ::std::int32_t (::QMargins::*left$)() const = &::QMargins::left;
  return (self.*left$)();
}

::std::int32_t cxxbridge1$202$QMargins$right(::QMargins const &self) noexcept {
  ::std::int32_t (::QMargins::*right$)() const = &::QMargins::right;
  return (self.*right$)();
}

void cxxbridge1$202$QMargins$set_bottom(::QMargins &self, ::std::int32_t bottom) noexcept {
  void (::QMargins::*set_bottom$)(::std::int32_t) = &::QMargins::setBottom;
  (self.*set_bottom$)(bottom);
}

void cxxbridge1$202$QMargins$set_left(::QMargins &self, ::std::int32_t left) noexcept {
  void (::QMargins::*set_left$)(::std::int32_t) = &::QMargins::setLeft;
  (self.*set_left$)(left);
}

void cxxbridge1$202$QMargins$set_right(::QMargins &self, ::std::int32_t right) noexcept {
  void (::QMargins::*set_right$)(::std::int32_t) = &::QMargins::setRight;
  (self.*set_right$)(right);
}

void cxxbridge1$202$QMargins$set_top(::QMargins &self, ::std::int32_t top) noexcept {
  void (::QMargins::*set_top$)(::std::int32_t) = &::QMargins::setTop;
  (self.*set_top$)(top);
}

void cxxbridge1$202$QMargins$to_marginsf(::QMargins const &self, ::QMarginsF *return$) noexcept {
  ::QMarginsF (::QMargins::*to_marginsf$)() const = &::QMargins::toMarginsF;
  new (return$) ::QMarginsF((self.*to_marginsf$)());
}

::std::int32_t cxxbridge1$202$QMargins$top(::QMargins const &self) noexcept {
...
namespace cxxqtlib1 {
extern "C" {
void rust$cxxqtlib1$cxxbridge1$202$qmargins_default(::QMargins *return$) noexcept {
  ::QMargins (*qmargins_default$)() = ::rust::cxxqtlib1::construct;
  new (return$) ::QMargins(qmargins_default$());
}

void rust$cxxqtlib1$cxxbridge1$202$qmargins_new(::std::int32_t left, ::std::int32_t top, ::std::int32_t right, ::std::int32_t bottom, ::QMargins *return$) noexcept {
...
void rust$cxxqtlib1$cxxbridge1$202$qmargins_to_debug_qstring(::QMargins const &value, ::QString *return$) noexcept {
...
void rust$cxxqtlib1$cxxbridge1$202$qmargins_plus(::QMargins const &a, ::QMargins const &b, ::QMargins *return$) noexcept {
  ::QMargins (*qmargins_plus$)(::QMargins const &, ::QMargins const &) = ::rust::cxxqtlib1::operatorPlus;
  new (return$) ::QMargins(qmargins_plus$(a, b));
}

void rust$cxxqtlib1$cxxbridge1$202$qmargins_plus_i32(::QMargins const &a, ::std::int32_t const &b, ::QMargins *return$) noexcept {
...
void rust$cxxqtlib1$cxxbridge1$202$qmargins_minus(::QMargins const &a, ::QMargins const &b, ::QMargins *return$) noexcept {
  ::QMargins (*qmargins_minus$)(::QMargins const &, ::QMargins const &) = ::rust::cxxqtlib1::operatorMinus;
  new (return$) ::QMargins(qmargins_minus$(a, b));
}

void rust$cxxqtlib1$cxxbridge1$202$qmargins_minus_i32(::QMargins const &a, ::std::int32_t const &b, ::QMargins *return$) noexcept {
...
void rust$cxxqtlib1$cxxbridge1$202$qmargins_mul_i32(::std::int32_t a, ::QMargins const &b, ::QMargins *return$) noexcept {
  ::QMargins (*qmargins_mul_i32$)(::std::int32_t, ::QMargins const &) = ::rust::cxxqtlib1::operatorMul;
  new (return$) ::QMargins(qmargins_mul_i32$(a, b));
}

void rust$cxxqtlib1$cxxbridge1$202$qmargins_mul_f64(double a, ::QMargins const &b, ::QMargins *return$) noexcept {
  ::QMargins (*qmargins_mul_f64$)(double, ::QMargins const &) = ::rust::cxxqtlib1::operatorMul;
  new (return$) ::QMargins(qmargins_mul_f64$(a, b));
}

void rust$cxxqtlib1$cxxbridge1$202$qmargins_div_i32(::std::int32_t a, ::QMargins const &b, ::QMargins *return$) noexcept {
  ::QMargins (*qmargins_div_i32$)(::std::int32_t, ::QMargins const &) = ::rust::cxxqtlib1::operatorDiv;
  new (return$) ::QMargins(qmargins_div_i32$(a, b));
}

void rust$cxxqtlib1$cxxbridge1$202$qmargins_div_f64(double a, ::QMargins const &b, ::QMargins *return$) noexcept {
