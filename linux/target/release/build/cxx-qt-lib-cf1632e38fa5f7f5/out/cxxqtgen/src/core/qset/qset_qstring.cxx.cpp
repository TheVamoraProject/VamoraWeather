...
extern "C" {
void cxxbridge1$202$QSet_QString$cxx_clear(::QSet_QString &self) noexcept {
  void (::QSet_QString::*cxx_clear$)() = &::QSet_QString::clear;
  (self.*cxx_clear$)();
}

bool cxxbridge1$202$QSet_QString$cxx_contains(::QSet_QString const &self, ::QString const &arg0) noexcept {
  bool (::QSet_QString::*cxx_contains$)(::QString const &) const = &::QSet_QString::contains;
  return (self.*cxx_contains$)(arg0);
}

bool cxxbridge1$202$QSet_QString$cxx_remove(::QSet_QString &self, ::QString const &arg0) noexcept {
...
namespace cxxqtlib1 {
extern "C" {
void rust$cxxqtlib1$cxxbridge1$202$qset_clone_QString(::QSet_QString const &arg0, ::QSet_QString *return$) noexcept {
...
void rust$cxxqtlib1$cxxbridge1$202$qset_default_QString(::QSet_QString *return$) noexcept {
  ::QSet_QString (*qset_default_QString$)() = ::rust::cxxqtlib1::construct;
  new (return$) ::QSet_QString(qset_default_QString$());
}

void rust$cxxqtlib1$cxxbridge1$202$qset_drop_QString(::QSet_QString &arg0) noexcept {
...
namespace qset {
extern "C" {
void rust$cxxqtlib1$qset$cxxbridge1$202$get_unchecked_QString(::QSet_QString const &set, ::rust::isize pos, ::QString const **return$) noexcept {
...
void rust$cxxqtlib1$qset$cxxbridge1$202$insert_QString(::QSet_QString &arg0, ::QString const &arg1) noexcept {
  void (*insert_QString$)(::QSet_QString &, ::QString const &) = ::rust::cxxqtlib1::qset::qsetInsert;
  insert_QString$(arg0, arg1);
}

::rust::isize rust$cxxqtlib1$qset$cxxbridge1$202$len_QString(::QSet_QString const &arg0) noexcept {
  ::rust::isize (*len_QString$)(::QSet_QString const &) = ::rust::cxxqtlib1::qset::qsetLen;
  return len_QString$(arg0);
}

void rust$cxxqtlib1$qset$cxxbridge1$202$reserve_QString(::QSet_QString &arg0, ::rust::isize size) noexcept {
