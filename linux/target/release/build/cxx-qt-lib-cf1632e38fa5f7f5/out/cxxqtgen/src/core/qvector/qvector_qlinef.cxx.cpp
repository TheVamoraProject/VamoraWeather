...
extern "C" {
void cxxbridge1$202$QVector_QLineF$cxx_clear(::QVector_QLineF &self) noexcept {
  void (::QVector_QLineF::*cxx_clear$)() = &::QVector_QLineF::clear;
  (self.*cxx_clear$)();
}

bool cxxbridge1$202$QVector_QLineF$cxx_contains(::QVector_QLineF const &self, ::QLineF const &arg0) noexcept {
...
namespace cxxqtlib1 {
extern "C" {
void rust$cxxqtlib1$cxxbridge1$202$qvector_clone_QLineF(::QVector_QLineF const &arg0, ::QVector_QLineF *return$) noexcept {
...
void rust$cxxqtlib1$cxxbridge1$202$qvector_default_QLineF(::QVector_QLineF *return$) noexcept {
  ::QVector_QLineF (*qvector_default_QLineF$)() = ::rust::cxxqtlib1::construct;
  new (return$) ::QVector_QLineF(qvector_default_QLineF$());
}

void rust$cxxqtlib1$cxxbridge1$202$qvector_drop_QLineF(::QVector_QLineF &arg0) noexcept {
...
namespace qvector {
extern "C" {
void rust$cxxqtlib1$qvector$cxxbridge1$202$reserve_QLineF(::QVector_QLineF &arg0, ::rust::isize size) noexcept {
  void (*reserve_QLineF$)(::QVector_QLineF &, ::rust::isize) = ::rust::cxxqtlib1::qvector::qvectorReserve;
  reserve_QLineF$(arg0, size);
}

void rust$cxxqtlib1$qvector$cxxbridge1$202$append_QLineF(::QVector_QLineF &arg0, ::QLineF const &arg1) noexcept {
  void (*append_QLineF$)(::QVector_QLineF &, ::QLineF const &) = ::rust::cxxqtlib1::qvector::qvectorAppend;
  append_QLineF$(arg0, arg1);
}

void rust$cxxqtlib1$qvector$cxxbridge1$202$get_unchecked_QLineF(::QVector_QLineF const &set, ::rust::isize pos, ::QLineF const **return$) noexcept {
...
::rust::isize rust$cxxqtlib1$qvector$cxxbridge1$202$index_of_QLineF(::QVector_QLineF const &arg0, ::QLineF const &arg1) noexcept {
...
void rust$cxxqtlib1$qvector$cxxbridge1$202$insert_QLineF(::QVector_QLineF &arg0, ::rust::isize arg1, ::QLineF const &arg2) noexcept {
...
void rust$cxxqtlib1$qvector$cxxbridge1$202$remove_QLineF(::QVector_QLineF &arg0, ::rust::isize arg1) noexcept {
  void (*remove_QLineF$)(::QVector_QLineF &, ::rust::isize) = ::rust::cxxqtlib1::qvector::qvectorRemove;
  remove_QLineF$(arg0, arg1);
}

::rust::isize rust$cxxqtlib1$qvector$cxxbridge1$202$len_QLineF(::QVector_QLineF const &arg0) noexcept {
