...
extern "C" {
void cxxbridge1$202$QPolygon$bounding_rect(::QPolygon const &self, ::QRect *return$) noexcept {
  ::QRect (::QPolygon::*bounding_rect$)() const = &::QPolygon::boundingRect;
  new (return$) ::QRect((self.*bounding_rect$)());
}

bool cxxbridge1$202$QPolygon$contains_point(::QPolygon const &self, ::QPoint const &point, ::Qt::FillRule *fill_rule) noexcept {
...
void cxxbridge1$202$QPolygon$intersected(::QPolygon const &self, ::QPolygon const &r, ::QPolygon *return$) noexcept {
  ::QPolygon (::QPolygon::*intersected$)(::QPolygon const &) const = &::QPolygon::intersected;
  new (return$) ::QPolygon((self.*intersected$)(r));
}

bool cxxbridge1$202$QPolygon$intersects(::QPolygon const &self, ::QPolygon const &p) noexcept {
  bool (::QPolygon::*intersects$)(::QPolygon const &) const = &::QPolygon::intersects;
  return (self.*intersects$)(p);
}

void cxxbridge1$202$QPolygon$point(::QPolygon const &self, ::std::int32_t index, ::QPoint *return$) noexcept {
  ::QPoint (::QPolygon::*point$)(::std::int32_t) const = &::QPolygon::point;
  new (return$) ::QPoint((self.*point$)(index));
}

void cxxbridge1$202$QPolygon$set_point(::QPolygon &self, ::std::int32_t index, ::QPoint const &point) noexcept {
  void (::QPolygon::*set_point$)(::std::int32_t, ::QPoint const &) = &::QPolygon::setPoint;
  (self.*set_point$)(index, point);
}

void cxxbridge1$202$QPolygon$subtracted(::QPolygon const &self, ::QPolygon const &r, ::QPolygon *return$) noexcept {
  ::QPolygon (::QPolygon::*subtracted$)(::QPolygon const &) const = &::QPolygon::subtracted;
  new (return$) ::QPolygon((self.*subtracted$)(r));
}

void cxxbridge1$202$QPolygon$to_polygonf(::QPolygon const &self, ::QPolygonF *return$) noexcept {
  ::QPolygonF (::QPolygon::*to_polygonf$)() const = &::QPolygon::toPolygonF;
  new (return$) ::QPolygonF((self.*to_polygonf$)());
}

void cxxbridge1$202$QPolygon$translate(::QPolygon &self, ::std::int32_t dx, ::std::int32_t dy) noexcept {
  void (::QPolygon::*translate$)(::std::int32_t, ::std::int32_t) = &::QPolygon::translate;
  (self.*translate$)(dx, dy);
}

void cxxbridge1$202$QPolygon$translated(::QPolygon const &self, ::std::int32_t dx, ::std::int32_t dy, ::QPolygon *return$) noexcept {
  ::QPolygon (::QPolygon::*translated$)(::std::int32_t, ::std::int32_t) const = &::QPolygon::translated;
  new (return$) ::QPolygon((self.*translated$)(dx, dy));
}

void cxxbridge1$202$QPolygon$united(::QPolygon const &self, ::QPolygon const &r, ::QPolygon *return$) noexcept {
...
namespace cxxqt1 {
extern "C" {
::QVector_QPoint const *rust$cxxqt1$cxxbridge1$202$upcast_qpolygon(::QPolygon const *thiz) noexcept {
  ::QVector_QPoint const *(*upcast_qpolygon$)(::QPolygon const *) = ::rust::cxxqt1::upcastPtr;
  return upcast_qpolygon$(thiz);
}

::QPolygon const *rust$cxxqt1$cxxbridge1$202$downcast_qvector_qpoint(::QVector_QPoint const *base) noexcept {
...
namespace cxxqtlib1 {
extern "C" {
void rust$cxxqtlib1$cxxbridge1$202$qpolygon_init_default(::QPolygon *return$) noexcept {
  ::QPolygon (*qpolygon_init_default$)() = ::rust::cxxqtlib1::construct;
  new (return$) ::QPolygon(qpolygon_init_default$());
}

void rust$cxxqtlib1$cxxbridge1$202$qpolygon_init_qrect(::QRect const &rect, bool closed, ::QPolygon *return$) noexcept {
...
void rust$cxxqtlib1$cxxbridge1$202$qpolygon_init_qvector_qpoint(::QVector_QPoint const &points, ::QPolygon *return$) noexcept {
  ::QPolygon (*qpolygon_init_qvector_qpoint$)(::QVector_QPoint const &) = ::rust::cxxqtlib1::construct;
  new (return$) ::QPolygon(qpolygon_init_qvector_qpoint$(points));
}

void rust$cxxqtlib1$cxxbridge1$202$qpolygon_drop(::QPolygon &pen) noexcept {
  void (*qpolygon_drop$)(::QPolygon &) = ::rust::cxxqtlib1::drop;
  qpolygon_drop$(pen);
}

void rust$cxxqtlib1$cxxbridge1$202$qpolygon_clone(::QPolygon const &p, ::QPolygon *return$) noexcept {
  ::QPolygon (*qpolygon_clone$)(::QPolygon const &) = ::rust::cxxqtlib1::construct;
  new (return$) ::QPolygon(qpolygon_clone$(p));
}

bool rust$cxxqtlib1$cxxbridge1$202$qpolygon_eq(::QPolygon const &a, ::QPolygon const &b) noexcept {
  bool (*qpolygon_eq$)(::QPolygon const &, ::QPolygon const &) = ::rust::cxxqtlib1::operatorEq;
  return qpolygon_eq$(a, b);
}

void rust$cxxqtlib1$cxxbridge1$202$qpolygon_to_debug_qstring(::QPolygon const &value, ::QString *return$) noexcept {
