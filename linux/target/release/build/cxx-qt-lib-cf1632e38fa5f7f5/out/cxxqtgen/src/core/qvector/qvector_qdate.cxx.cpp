...
extern "C" {
void cxxbridge1$202$QVector_QDate$cxx_clear(::QVector_QDate &self) noexcept {
  void (::QVector_QDate::*cxx_clear$)() = &::QVector_QDate::clear;
  (self.*cxx_clear$)();
}

bool cxxbridge1$202$QVector_QDate$cxx_contains(::QVector_QDate const &self, ::QDate const &arg0) noexcept {
...
namespace cxxqtlib1 {
extern "C" {
void rust$cxxqtlib1$cxxbridge1$202$qvector_clone_QDate(::QVector_QDate const &arg0, ::QVector_QDate *return$) noexcept {
...
void rust$cxxqtlib1$cxxbridge1$202$qvector_default_QDate(::QVector_QDate *return$) noexcept {
  ::QVector_QDate (*qvector_default_QDate$)() = ::rust::cxxqtlib1::construct;
  new (return$) ::QVector_QDate(qvector_default_QDate$());
}

void rust$cxxqtlib1$cxxbridge1$202$qvector_drop_QDate(::QVector_QDate &arg0) noexcept {
...
namespace qvector {
extern "C" {
void rust$cxxqtlib1$qvector$cxxbridge1$202$reserve_QDate(::QVector_QDate &arg0, ::rust::isize size) noexcept {
  void (*reserve_QDate$)(::QVector_QDate &, ::rust::isize) = ::rust::cxxqtlib1::qvector::qvectorReserve;
  reserve_QDate$(arg0, size);
}

void rust$cxxqtlib1$qvector$cxxbridge1$202$append_QDate(::QVector_QDate &arg0, ::QDate const &arg1) noexcept {
  void (*append_QDate$)(::QVector_QDate &, ::QDate const &) = ::rust::cxxqtlib1::qvector::qvectorAppend;
  append_QDate$(arg0, arg1);
}

void rust$cxxqtlib1$qvector$cxxbridge1$202$get_unchecked_QDate(::QVector_QDate const &set, ::rust::isize pos, ::QDate const **return$) noexcept {
...
::rust::isize rust$cxxqtlib1$qvector$cxxbridge1$202$index_of_QDate(::QVector_QDate const &arg0, ::QDate const &arg1) noexcept {
...
void rust$cxxqtlib1$qvector$cxxbridge1$202$insert_QDate(::QVector_QDate &arg0, ::rust::isize arg1, ::QDate const &arg2) noexcept {
  void (*insert_QDate$)(::QVector_QDate &, ::rust::isize, ::QDate const &) = ::rust::cxxqtlib1::qvector::qvectorInsert;
  insert_QDate$(arg0, arg1, arg2);
}

void rust$cxxqtlib1$qvector$cxxbridge1$202$remove_QDate(::QVector_QDate &arg0, ::rust::isize arg1) noexcept {
  void (*remove_QDate$)(::QVector_QDate &, ::rust::isize) = ::rust::cxxqtlib1::qvector::qvectorRemove;
  remove_QDate$(arg0, arg1);
}

::rust::isize rust$cxxqtlib1$qvector$cxxbridge1$202$len_QDate(::QVector_QDate const &arg0) noexcept {
