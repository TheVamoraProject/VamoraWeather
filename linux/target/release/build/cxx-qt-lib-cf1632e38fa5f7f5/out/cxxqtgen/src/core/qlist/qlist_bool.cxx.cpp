...
extern "C" {
void cxxbridge1$202$QList_bool$cxx_clear(::QList_bool &self) noexcept {
  void (::QList_bool::*cxx_clear$)() = &::QList_bool::clear;
  (self.*cxx_clear$)();
}

bool cxxbridge1$202$QList_bool$cxx_contains(::QList_bool const &self, bool const &arg0) noexcept {
...
namespace cxxqtlib1 {
extern "C" {
void rust$cxxqtlib1$cxxbridge1$202$qlist_clone_bool(::QList_bool const &arg0, ::QList_bool *return$) noexcept {
  ::QList_bool (*qlist_clone_bool$)(::QList_bool const &) = ::rust::cxxqtlib1::construct;
  new (return$) ::QList_bool(qlist_clone_bool$(arg0));
}

void rust$cxxqtlib1$cxxbridge1$202$qlist_default_bool(::QList_bool *return$) noexcept {
  ::QList_bool (*qlist_default_bool$)() = ::rust::cxxqtlib1::construct;
  new (return$) ::QList_bool(qlist_default_bool$());
}

void rust$cxxqtlib1$cxxbridge1$202$qlist_drop_bool(::QList_bool &arg0) noexcept {
...
namespace qlist {
extern "C" {
void rust$cxxqtlib1$qlist$cxxbridge1$202$reserve_bool(::QList_bool &arg0, ::rust::isize size) noexcept {
  void (*reserve_bool$)(::QList_bool &, ::rust::isize) = ::rust::cxxqtlib1::qlist::qlistReserve;
  reserve_bool$(arg0, size);
}

void rust$cxxqtlib1$qlist$cxxbridge1$202$append_bool(::QList_bool &arg0, bool const &arg1) noexcept {
  void (*append_bool$)(::QList_bool &, bool const &) = ::rust::cxxqtlib1::qlist::qlistAppend;
  append_bool$(arg0, arg1);
}

bool const *rust$cxxqtlib1$qlist$cxxbridge1$202$get_unchecked_bool(::QList_bool const &set, ::rust::isize pos) noexcept {
...
::rust::isize rust$cxxqtlib1$qlist$cxxbridge1$202$index_of_bool(::QList_bool const &arg0, bool const &arg1) noexcept {
  ::rust::isize (*index_of_bool$)(::QList_bool const &, bool const &) = ::rust::cxxqtlib1::qlist::qlistIndexOf;
  return index_of_bool$(arg0, arg1);
}

void rust$cxxqtlib1$qlist$cxxbridge1$202$insert_bool(::QList_bool &arg0, ::rust::isize arg1, bool const &arg2) noexcept {
  void (*insert_bool$)(::QList_bool &, ::rust::isize, bool const &) = ::rust::cxxqtlib1::qlist::qlistInsert;
  insert_bool$(arg0, arg1, arg2);
}

::rust::isize rust$cxxqtlib1$qlist$cxxbridge1$202$len_bool(::QList_bool const &arg0) noexcept {
  ::rust::isize (*len_bool$)(::QList_bool const &) = ::rust::cxxqtlib1::qlist::qlistLen;
  return len_bool$(arg0);
}

void rust$cxxqtlib1$qlist$cxxbridge1$202$remove_bool(::QList_bool &arg0, ::rust::isize arg1) noexcept {
