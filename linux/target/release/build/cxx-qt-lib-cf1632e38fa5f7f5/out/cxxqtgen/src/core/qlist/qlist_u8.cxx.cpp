...
extern "C" {
void cxxbridge1$202$QList_u8$cxx_clear(::QList_u8 &self) noexcept {
  void (::QList_u8::*cxx_clear$)() = &::QList_u8::clear;
  (self.*cxx_clear$)();
}

bool cxxbridge1$202$QList_u8$cxx_contains(::QList_u8 const &self, ::std::uint8_t const &arg0) noexcept {
...
namespace cxxqtlib1 {
extern "C" {
void rust$cxxqtlib1$cxxbridge1$202$qlist_clone_u8(::QList_u8 const &arg0, ::QList_u8 *return$) noexcept {
  ::QList_u8 (*qlist_clone_u8$)(::QList_u8 const &) = ::rust::cxxqtlib1::construct;
  new (return$) ::QList_u8(qlist_clone_u8$(arg0));
}

void rust$cxxqtlib1$cxxbridge1$202$qlist_default_u8(::QList_u8 *return$) noexcept {
  ::QList_u8 (*qlist_default_u8$)() = ::rust::cxxqtlib1::construct;
  new (return$) ::QList_u8(qlist_default_u8$());
}

void rust$cxxqtlib1$cxxbridge1$202$qlist_drop_u8(::QList_u8 &arg0) noexcept {
...
namespace qlist {
extern "C" {
void rust$cxxqtlib1$qlist$cxxbridge1$202$reserve_u8(::QList_u8 &arg0, ::rust::isize size) noexcept {
  void (*reserve_u8$)(::QList_u8 &, ::rust::isize) = ::rust::cxxqtlib1::qlist::qlistReserve;
  reserve_u8$(arg0, size);
}

void rust$cxxqtlib1$qlist$cxxbridge1$202$append_u8(::QList_u8 &arg0, ::std::uint8_t const &arg1) noexcept {
  void (*append_u8$)(::QList_u8 &, ::std::uint8_t const &) = ::rust::cxxqtlib1::qlist::qlistAppend;
  append_u8$(arg0, arg1);
}

::std::uint8_t const *rust$cxxqtlib1$qlist$cxxbridge1$202$get_unchecked_u8(::QList_u8 const &set, ::rust::isize pos) noexcept {
...
::rust::isize rust$cxxqtlib1$qlist$cxxbridge1$202$index_of_u8(::QList_u8 const &arg0, ::std::uint8_t const &arg1) noexcept {
  ::rust::isize (*index_of_u8$)(::QList_u8 const &, ::std::uint8_t const &) = ::rust::cxxqtlib1::qlist::qlistIndexOf;
  return index_of_u8$(arg0, arg1);
}

void rust$cxxqtlib1$qlist$cxxbridge1$202$insert_u8(::QList_u8 &arg0, ::rust::isize arg1, ::std::uint8_t const &arg2) noexcept {
  void (*insert_u8$)(::QList_u8 &, ::rust::isize, ::std::uint8_t const &) = ::rust::cxxqtlib1::qlist::qlistInsert;
  insert_u8$(arg0, arg1, arg2);
}

::rust::isize rust$cxxqtlib1$qlist$cxxbridge1$202$len_u8(::QList_u8 const &arg0) noexcept {
  ::rust::isize (*len_u8$)(::QList_u8 const &) = ::rust::cxxqtlib1::qlist::qlistLen;
  return len_u8$(arg0);
}

void rust$cxxqtlib1$qlist$cxxbridge1$202$remove_u8(::QList_u8 &arg0, ::rust::isize arg1) noexcept {
