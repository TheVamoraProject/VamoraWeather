...
extern "C" {
void cxxbridge1$202$QList_QPoint$cxx_clear(::QList_QPoint &self) noexcept {
  void (::QList_QPoint::*cxx_clear$)() = &::QList_QPoint::clear;
  (self.*cxx_clear$)();
}

bool cxxbridge1$202$QList_QPoint$cxx_contains(::QList_QPoint const &self, ::QPoint const &arg0) noexcept {
...
namespace cxxqtlib1 {
extern "C" {
void rust$cxxqtlib1$cxxbridge1$202$qlist_clone_QPoint(::QList_QPoint const &arg0, ::QList_QPoint *return$) noexcept {
...
void rust$cxxqtlib1$cxxbridge1$202$qlist_default_QPoint(::QList_QPoint *return$) noexcept {
  ::QList_QPoint (*qlist_default_QPoint$)() = ::rust::cxxqtlib1::construct;
  new (return$) ::QList_QPoint(qlist_default_QPoint$());
}

void rust$cxxqtlib1$cxxbridge1$202$qlist_drop_QPoint(::QList_QPoint &arg0) noexcept {
...
namespace qlist {
extern "C" {
void rust$cxxqtlib1$qlist$cxxbridge1$202$reserve_QPoint(::QList_QPoint &arg0, ::rust::isize size) noexcept {
  void (*reserve_QPoint$)(::QList_QPoint &, ::rust::isize) = ::rust::cxxqtlib1::qlist::qlistReserve;
  reserve_QPoint$(arg0, size);
}

void rust$cxxqtlib1$qlist$cxxbridge1$202$append_QPoint(::QList_QPoint &arg0, ::QPoint const &arg1) noexcept {
  void (*append_QPoint$)(::QList_QPoint &, ::QPoint const &) = ::rust::cxxqtlib1::qlist::qlistAppend;
  append_QPoint$(arg0, arg1);
}

void rust$cxxqtlib1$qlist$cxxbridge1$202$get_unchecked_QPoint(::QList_QPoint const &set, ::rust::isize pos, ::QPoint const **return$) noexcept {
...
::rust::isize rust$cxxqtlib1$qlist$cxxbridge1$202$index_of_QPoint(::QList_QPoint const &arg0, ::QPoint const &arg1) noexcept {
...
void rust$cxxqtlib1$qlist$cxxbridge1$202$insert_QPoint(::QList_QPoint &arg0, ::rust::isize arg1, ::QPoint const &arg2) noexcept {
  void (*insert_QPoint$)(::QList_QPoint &, ::rust::isize, ::QPoint const &) = ::rust::cxxqtlib1::qlist::qlistInsert;
  insert_QPoint$(arg0, arg1, arg2);
}

void rust$cxxqtlib1$qlist$cxxbridge1$202$remove_QPoint(::QList_QPoint &arg0, ::rust::isize arg1) noexcept {
  void (*remove_QPoint$)(::QList_QPoint &, ::rust::isize) = ::rust::cxxqtlib1::qlist::qlistRemove;
  remove_QPoint$(arg0, arg1);
}

::rust::isize rust$cxxqtlib1$qlist$cxxbridge1$202$len_QPoint(::QList_QPoint const &arg0) noexcept {
