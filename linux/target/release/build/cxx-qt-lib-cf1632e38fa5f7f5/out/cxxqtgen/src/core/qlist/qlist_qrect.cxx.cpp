...
extern "C" {
void cxxbridge1$202$QList_QRect$cxx_clear(::QList_QRect &self) noexcept {
  void (::QList_QRect::*cxx_clear$)() = &::QList_QRect::clear;
  (self.*cxx_clear$)();
}

bool cxxbridge1$202$QList_QRect$cxx_contains(::QList_QRect const &self, ::QRect const &arg0) noexcept {
...
namespace cxxqtlib1 {
extern "C" {
void rust$cxxqtlib1$cxxbridge1$202$qlist_clone_QRect(::QList_QRect const &arg0, ::QList_QRect *return$) noexcept {
  ::QList_QRect (*qlist_clone_QRect$)(::QList_QRect const &) = ::rust::cxxqtlib1::construct;
  new (return$) ::QList_QRect(qlist_clone_QRect$(arg0));
}

void rust$cxxqtlib1$cxxbridge1$202$qlist_default_QRect(::QList_QRect *return$) noexcept {
  ::QList_QRect (*qlist_default_QRect$)() = ::rust::cxxqtlib1::construct;
  new (return$) ::QList_QRect(qlist_default_QRect$());
}

void rust$cxxqtlib1$cxxbridge1$202$qlist_drop_QRect(::QList_QRect &arg0) noexcept {
...
namespace qlist {
extern "C" {
void rust$cxxqtlib1$qlist$cxxbridge1$202$reserve_QRect(::QList_QRect &arg0, ::rust::isize size) noexcept {
  void (*reserve_QRect$)(::QList_QRect &, ::rust::isize) = ::rust::cxxqtlib1::qlist::qlistReserve;
  reserve_QRect$(arg0, size);
}

void rust$cxxqtlib1$qlist$cxxbridge1$202$append_QRect(::QList_QRect &arg0, ::QRect const &arg1) noexcept {
  void (*append_QRect$)(::QList_QRect &, ::QRect const &) = ::rust::cxxqtlib1::qlist::qlistAppend;
  append_QRect$(arg0, arg1);
}

void rust$cxxqtlib1$qlist$cxxbridge1$202$get_unchecked_QRect(::QList_QRect const &set, ::rust::isize pos, ::QRect const **return$) noexcept {
...
::rust::isize rust$cxxqtlib1$qlist$cxxbridge1$202$index_of_QRect(::QList_QRect const &arg0, ::QRect const &arg1) noexcept {
  ::rust::isize (*index_of_QRect$)(::QList_QRect const &, ::QRect const &) = ::rust::cxxqtlib1::qlist::qlistIndexOf;
  return index_of_QRect$(arg0, arg1);
}

void rust$cxxqtlib1$qlist$cxxbridge1$202$insert_QRect(::QList_QRect &arg0, ::rust::isize arg1, ::QRect const &arg2) noexcept {
  void (*insert_QRect$)(::QList_QRect &, ::rust::isize, ::QRect const &) = ::rust::cxxqtlib1::qlist::qlistInsert;
  insert_QRect$(arg0, arg1, arg2);
}

void rust$cxxqtlib1$qlist$cxxbridge1$202$remove_QRect(::QList_QRect &arg0, ::rust::isize arg1) noexcept {
  void (*remove_QRect$)(::QList_QRect &, ::rust::isize) = ::rust::cxxqtlib1::qlist::qlistRemove;
  remove_QRect$(arg0, arg1);
}

::rust::isize rust$cxxqtlib1$qlist$cxxbridge1$202$len_QRect(::QList_QRect const &arg0) noexcept {
