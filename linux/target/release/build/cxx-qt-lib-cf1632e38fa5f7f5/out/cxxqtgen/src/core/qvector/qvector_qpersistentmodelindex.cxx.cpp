...
extern "C" {
void cxxbridge1$202$QVector_QPersistentModelIndex$cxx_clear(::QVector_QPersistentModelIndex &self) noexcept {
  void (::QVector_QPersistentModelIndex::*cxx_clear$)() = &::QVector_QPersistentModelIndex::clear;
  (self.*cxx_clear$)();
}

bool cxxbridge1$202$QVector_QPersistentModelIndex$cxx_contains(::QVector_QPersistentModelIndex const &self, ::QPersistentModelIndex const &arg0) noexcept {
...
namespace cxxqtlib1 {
extern "C" {
void rust$cxxqtlib1$cxxbridge1$202$qvector_clone_QPersistentModelIndex(::QVector_QPersistentModelIndex const &arg0, ::QVector_QPersistentModelIndex *return$) noexcept {
...
void rust$cxxqtlib1$cxxbridge1$202$qvector_default_QPersistentModelIndex(::QVector_QPersistentModelIndex *return$) noexcept {
...
void rust$cxxqtlib1$cxxbridge1$202$qvector_drop_QPersistentModelIndex(::QVector_QPersistentModelIndex &arg0) noexcept {
...
namespace qvector {
extern "C" {
void rust$cxxqtlib1$qvector$cxxbridge1$202$reserve_QPersistentModelIndex(::QVector_QPersistentModelIndex &arg0, ::rust::isize size) noexcept {
...
void rust$cxxqtlib1$qvector$cxxbridge1$202$append_QPersistentModelIndex(::QVector_QPersistentModelIndex &arg0, ::QPersistentModelIndex const &arg1) noexcept {
...
void rust$cxxqtlib1$qvector$cxxbridge1$202$get_unchecked_QPersistentModelIndex(::QVector_QPersistentModelIndex const &set, ::rust::isize pos, ::QPersistentModelIndex const **return$) noexcept {
...
::rust::isize rust$cxxqtlib1$qvector$cxxbridge1$202$index_of_QPersistentModelIndex(::QVector_QPersistentModelIndex const &arg0, ::QPersistentModelIndex const &arg1) noexcept {
...
void rust$cxxqtlib1$qvector$cxxbridge1$202$insert_QPersistentModelIndex(::QVector_QPersistentModelIndex &arg0, ::rust::isize arg1, ::QPersistentModelIndex const &arg2) noexcept {
...
void rust$cxxqtlib1$qvector$cxxbridge1$202$remove_QPersistentModelIndex(::QVector_QPersistentModelIndex &arg0, ::rust::isize arg1) noexcept {
...
::rust::isize rust$cxxqtlib1$qvector$cxxbridge1$202$len_QPersistentModelIndex(::QVector_QPersistentModelIndex const &arg0) noexcept {
