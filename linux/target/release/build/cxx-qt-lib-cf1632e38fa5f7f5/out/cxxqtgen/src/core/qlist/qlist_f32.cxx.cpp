...
extern "C" {
void cxxbridge1$202$QList_f32$cxx_clear(::QList_f32 &self) noexcept {
  void (::QList_f32::*cxx_clear$)() = &::QList_f32::clear;
  (self.*cxx_clear$)();
}

bool cxxbridge1$202$QList_f32$cxx_contains(::QList_f32 const &self, float const &arg0) noexcept {
...
namespace cxxqtlib1 {
extern "C" {
void rust$cxxqtlib1$cxxbridge1$202$qlist_clone_f32(::QList_f32 const &arg0, ::QList_f32 *return$) noexcept {
  ::QList_f32 (*qlist_clone_f32$)(::QList_f32 const &) = ::rust::cxxqtlib1::construct;
  new (return$) ::QList_f32(qlist_clone_f32$(arg0));
}

void rust$cxxqtlib1$cxxbridge1$202$qlist_default_f32(::QList_f32 *return$) noexcept {
  ::QList_f32 (*qlist_default_f32$)() = ::rust::cxxqtlib1::construct;
  new (return$) ::QList_f32(qlist_default_f32$());
}

void rust$cxxqtlib1$cxxbridge1$202$qlist_drop_f32(::QList_f32 &arg0) noexcept {
...
namespace qlist {
extern "C" {
void rust$cxxqtlib1$qlist$cxxbridge1$202$reserve_f32(::QList_f32 &arg0, ::rust::isize size) noexcept {
  void (*reserve_f32$)(::QList_f32 &, ::rust::isize) = ::rust::cxxqtlib1::qlist::qlistReserve;
  reserve_f32$(arg0, size);
}

void rust$cxxqtlib1$qlist$cxxbridge1$202$append_f32(::QList_f32 &arg0, float const &arg1) noexcept {
  void (*append_f32$)(::QList_f32 &, float const &) = ::rust::cxxqtlib1::qlist::qlistAppend;
  append_f32$(arg0, arg1);
}

float const *rust$cxxqtlib1$qlist$cxxbridge1$202$get_unchecked_f32(::QList_f32 const &set, ::rust::isize pos) noexcept {
...
::rust::isize rust$cxxqtlib1$qlist$cxxbridge1$202$index_of_f32(::QList_f32 const &arg0, float const &arg1) noexcept {
  ::rust::isize (*index_of_f32$)(::QList_f32 const &, float const &) = ::rust::cxxqtlib1::qlist::qlistIndexOf;
  return index_of_f32$(arg0, arg1);
}

void rust$cxxqtlib1$qlist$cxxbridge1$202$insert_f32(::QList_f32 &arg0, ::rust::isize arg1, float const &arg2) noexcept {
  void (*insert_f32$)(::QList_f32 &, ::rust::isize, float const &) = ::rust::cxxqtlib1::qlist::qlistInsert;
  insert_f32$(arg0, arg1, arg2);
}

::rust::isize rust$cxxqtlib1$qlist$cxxbridge1$202$len_f32(::QList_f32 const &arg0) noexcept {
  ::rust::isize (*len_f32$)(::QList_f32 const &) = ::rust::cxxqtlib1::qlist::qlistLen;
  return len_f32$(arg0);
}

void rust$cxxqtlib1$qlist$cxxbridge1$202$remove_f32(::QList_f32 &arg0, ::rust::isize arg1) noexcept {
