...
namespace qvariant {
extern "C" {
bool rust$cxxqtlib1$qvariant$cxxbridge1$202$can_convert_QVector2D(::QVariant const &variant) noexcept {
...
void rust$cxxqtlib1$qvariant$cxxbridge1$202$construct_QVector2D(::QVector2D const &value, ::QVariant *return$) noexcept {
...
void rust$cxxqtlib1$qvariant$cxxbridge1$202$value_or_default_QVector2D(::QVariant const &variant, ::QVector2D *return$) noexcept {
