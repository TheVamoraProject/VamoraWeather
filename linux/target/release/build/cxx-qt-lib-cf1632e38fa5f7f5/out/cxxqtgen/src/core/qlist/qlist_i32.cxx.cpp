...
extern "C" {
void cxxbridge1$202$QList_i32$cxx_clear(::QList_i32 &self) noexcept {
  void (::QList_i32::*cxx_clear$)() = &::QList_i32::clear;
  (self.*cxx_clear$)();
}

bool cxxbridge1$202$QList_i32$cxx_contains(::QList_i32 const &self, ::std::int32_t const &arg0) noexcept {
...
namespace cxxqtlib1 {
extern "C" {
void rust$cxxqtlib1$cxxbridge1$202$qlist_clone_i32(::QList_i32 const &arg0, ::QList_i32 *return$) noexcept {
  ::QList_i32 (*qlist_clone_i32$)(::QList_i32 const &) = ::rust::cxxqtlib1::construct;
  new (return$) ::QList_i32(qlist_clone_i32$(arg0));
}

void rust$cxxqtlib1$cxxbridge1$202$qlist_default_i32(::QList_i32 *return$) noexcept {
  ::QList_i32 (*qlist_default_i32$)() = ::rust::cxxqtlib1::construct;
  new (return$) ::QList_i32(qlist_default_i32$());
}

void rust$cxxqtlib1$cxxbridge1$202$qlist_drop_i32(::QList_i32 &arg0) noexcept {
...
namespace qlist {
extern "C" {
void rust$cxxqtlib1$qlist$cxxbridge1$202$reserve_i32(::QList_i32 &arg0, ::rust::isize size) noexcept {
  void (*reserve_i32$)(::QList_i32 &, ::rust::isize) = ::rust::cxxqtlib1::qlist::qlistReserve;
  reserve_i32$(arg0, size);
}

void rust$cxxqtlib1$qlist$cxxbridge1$202$append_i32(::QList_i32 &arg0, ::std::int32_t const &arg1) noexcept {
  void (*append_i32$)(::QList_i32 &, ::std::int32_t const &) = ::rust::cxxqtlib1::qlist::qlistAppend;
  append_i32$(arg0, arg1);
}

::std::int32_t const *rust$cxxqtlib1$qlist$cxxbridge1$202$get_unchecked_i32(::QList_i32 const &set, ::rust::isize pos) noexcept {
...
::rust::isize rust$cxxqtlib1$qlist$cxxbridge1$202$index_of_i32(::QList_i32 const &arg0, ::std::int32_t const &arg1) noexcept {
  ::rust::isize (*index_of_i32$)(::QList_i32 const &, ::std::int32_t const &) = ::rust::cxxqtlib1::qlist::qlistIndexOf;
  return index_of_i32$(arg0, arg1);
}

void rust$cxxqtlib1$qlist$cxxbridge1$202$insert_i32(::QList_i32 &arg0, ::rust::isize arg1, ::std::int32_t const &arg2) noexcept {
  void (*insert_i32$)(::QList_i32 &, ::rust::isize, ::std::int32_t const &) = ::rust::cxxqtlib1::qlist::qlistInsert;
  insert_i32$(arg0, arg1, arg2);
}

::rust::isize rust$cxxqtlib1$qlist$cxxbridge1$202$len_i32(::QList_i32 const &arg0) noexcept {
  ::rust::isize (*len_i32$)(::QList_i32 const &) = ::rust::cxxqtlib1::qlist::qlistLen;
  return len_i32$(arg0);
}

void rust$cxxqtlib1$qlist$cxxbridge1$202$remove_i32(::QList_i32 &arg0, ::rust::isize arg1) noexcept {
