...
extern "C" {
void cxxbridge1$202$QSet_QPersistentModelIndex$cxx_clear(::QSet_QPersistentModelIndex &self) noexcept {
  void (::QSet_QPersistentModelIndex::*cxx_clear$)() = &::QSet_QPersistentModelIndex::clear;
  (self.*cxx_clear$)();
}

bool cxxbridge1$202$QSet_QPersistentModelIndex$cxx_contains(::QSet_QPersistentModelIndex const &self, ::QPersistentModelIndex const &arg0) noexcept {
...
bool cxxbridge1$202$QSet_QPersistentModelIndex$cxx_remove(::QSet_QPersistentModelIndex &self, ::QPersistentModelIndex const &arg0) noexcept {
...
namespace cxxqtlib1 {
extern "C" {
void rust$cxxqtlib1$cxxbridge1$202$qset_clone_QPersistentModelIndex(::QSet_QPersistentModelIndex const &arg0, ::QSet_QPersistentModelIndex *return$) noexcept {
...
void rust$cxxqtlib1$cxxbridge1$202$qset_default_QPersistentModelIndex(::QSet_QPersistentModelIndex *return$) noexcept {
...
void rust$cxxqtlib1$cxxbridge1$202$qset_drop_QPersistentModelIndex(::QSet_QPersistentModelIndex &arg0) noexcept {
...
namespace qset {
extern "C" {
void rust$cxxqtlib1$qset$cxxbridge1$202$get_unchecked_QPersistentModelIndex(::QSet_QPersistentModelIndex const &set, ::rust::isize pos, ::QPersistentModelIndex const **return$) noexcept {
...
void rust$cxxqtlib1$qset$cxxbridge1$202$insert_QPersistentModelIndex(::QSet_QPersistentModelIndex &arg0, ::QPersistentModelIndex const &arg1) noexcept {
...
::rust::isize rust$cxxqtlib1$qset$cxxbridge1$202$len_QPersistentModelIndex(::QSet_QPersistentModelIndex const &arg0) noexcept {
...
void rust$cxxqtlib1$qset$cxxbridge1$202$reserve_QPersistentModelIndex(::QSet_QPersistentModelIndex &arg0, ::rust::isize size) noexcept {
