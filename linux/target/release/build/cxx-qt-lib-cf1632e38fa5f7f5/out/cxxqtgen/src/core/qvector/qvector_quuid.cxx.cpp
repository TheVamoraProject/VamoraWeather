...
extern "C" {
void cxxbridge1$202$QVector_QUuid$cxx_clear(::QVector_QUuid &self) noexcept {
  void (::QVector_QUuid::*cxx_clear$)() = &::QVector_QUuid::clear;
  (self.*cxx_clear$)();
}

bool cxxbridge1$202$QVector_QUuid$cxx_contains(::QVector_QUuid const &self, ::QUuid const &arg0) noexcept {
...
namespace cxxqtlib1 {
extern "C" {
void rust$cxxqtlib1$cxxbridge1$202$qvector_clone_QUuid(::QVector_QUuid const &arg0, ::QVector_QUuid *return$) noexcept {
...
void rust$cxxqtlib1$cxxbridge1$202$qvector_default_QUuid(::QVector_QUuid *return$) noexcept {
  ::QVector_QUuid (*qvector_default_QUuid$)() = ::rust::cxxqtlib1::construct;
  new (return$) ::QVector_QUuid(qvector_default_QUuid$());
}

void rust$cxxqtlib1$cxxbridge1$202$qvector_drop_QUuid(::QVector_QUuid &arg0) noexcept {
...
namespace qvector {
extern "C" {
void rust$cxxqtlib1$qvector$cxxbridge1$202$reserve_QUuid(::QVector_QUuid &arg0, ::rust::isize size) noexcept {
  void (*reserve_QUuid$)(::QVector_QUuid &, ::rust::isize) = ::rust::cxxqtlib1::qvector::qvectorReserve;
  reserve_QUuid$(arg0, size);
}

void rust$cxxqtlib1$qvector$cxxbridge1$202$append_QUuid(::QVector_QUuid &arg0, ::QUuid const &arg1) noexcept {
  void (*append_QUuid$)(::QVector_QUuid &, ::QUuid const &) = ::rust::cxxqtlib1::qvector::qvectorAppend;
  append_QUuid$(arg0, arg1);
}

void rust$cxxqtlib1$qvector$cxxbridge1$202$get_unchecked_QUuid(::QVector_QUuid const &set, ::rust::isize pos, ::QUuid const **return$) noexcept {
...
::rust::isize rust$cxxqtlib1$qvector$cxxbridge1$202$index_of_QUuid(::QVector_QUuid const &arg0, ::QUuid const &arg1) noexcept {
...
void rust$cxxqtlib1$qvector$cxxbridge1$202$insert_QUuid(::QVector_QUuid &arg0, ::rust::isize arg1, ::QUuid const &arg2) noexcept {
  void (*insert_QUuid$)(::QVector_QUuid &, ::rust::isize, ::QUuid const &) = ::rust::cxxqtlib1::qvector::qvectorInsert;
  insert_QUuid$(arg0, arg1, arg2);
}

void rust$cxxqtlib1$qvector$cxxbridge1$202$remove_QUuid(::QVector_QUuid &arg0, ::rust::isize arg1) noexcept {
  void (*remove_QUuid$)(::QVector_QUuid &, ::rust::isize) = ::rust::cxxqtlib1::qvector::qvectorRemove;
  remove_QUuid$(arg0, arg1);
}

::rust::isize rust$cxxqtlib1$qvector$cxxbridge1$202$len_QUuid(::QVector_QUuid const &arg0) noexcept {
