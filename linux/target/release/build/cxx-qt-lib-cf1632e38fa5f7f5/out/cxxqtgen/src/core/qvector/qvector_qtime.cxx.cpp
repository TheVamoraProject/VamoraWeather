...
extern "C" {
void cxxbridge1$202$QVector_QTime$cxx_clear(::QVector_QTime &self) noexcept {
  void (::QVector_QTime::*cxx_clear$)() = &::QVector_QTime::clear;
  (self.*cxx_clear$)();
}

bool cxxbridge1$202$QVector_QTime$cxx_contains(::QVector_QTime const &self, ::QTime const &arg0) noexcept {
...
namespace cxxqtlib1 {
extern "C" {
void rust$cxxqtlib1$cxxbridge1$202$qvector_clone_QTime(::QVector_QTime const &arg0, ::QVector_QTime *return$) noexcept {
...
void rust$cxxqtlib1$cxxbridge1$202$qvector_default_QTime(::QVector_QTime *return$) noexcept {
  ::QVector_QTime (*qvector_default_QTime$)() = ::rust::cxxqtlib1::construct;
  new (return$) ::QVector_QTime(qvector_default_QTime$());
}

void rust$cxxqtlib1$cxxbridge1$202$qvector_drop_QTime(::QVector_QTime &arg0) noexcept {
...
namespace qvector {
extern "C" {
void rust$cxxqtlib1$qvector$cxxbridge1$202$reserve_QTime(::QVector_QTime &arg0, ::rust::isize size) noexcept {
  void (*reserve_QTime$)(::QVector_QTime &, ::rust::isize) = ::rust::cxxqtlib1::qvector::qvectorReserve;
  reserve_QTime$(arg0, size);
}

void rust$cxxqtlib1$qvector$cxxbridge1$202$append_QTime(::QVector_QTime &arg0, ::QTime const &arg1) noexcept {
  void (*append_QTime$)(::QVector_QTime &, ::QTime const &) = ::rust::cxxqtlib1::qvector::qvectorAppend;
  append_QTime$(arg0, arg1);
}

void rust$cxxqtlib1$qvector$cxxbridge1$202$get_unchecked_QTime(::QVector_QTime const &set, ::rust::isize pos, ::QTime const **return$) noexcept {
...
::rust::isize rust$cxxqtlib1$qvector$cxxbridge1$202$index_of_QTime(::QVector_QTime const &arg0, ::QTime const &arg1) noexcept {
...
void rust$cxxqtlib1$qvector$cxxbridge1$202$insert_QTime(::QVector_QTime &arg0, ::rust::isize arg1, ::QTime const &arg2) noexcept {
  void (*insert_QTime$)(::QVector_QTime &, ::rust::isize, ::QTime const &) = ::rust::cxxqtlib1::qvector::qvectorInsert;
  insert_QTime$(arg0, arg1, arg2);
}

void rust$cxxqtlib1$qvector$cxxbridge1$202$remove_QTime(::QVector_QTime &arg0, ::rust::isize arg1) noexcept {
  void (*remove_QTime$)(::QVector_QTime &, ::rust::isize) = ::rust::cxxqtlib1::qvector::qvectorRemove;
  remove_QTime$(arg0, arg1);
}

::rust::isize rust$cxxqtlib1$qvector$cxxbridge1$202$len_QTime(::QVector_QTime const &arg0) noexcept {
