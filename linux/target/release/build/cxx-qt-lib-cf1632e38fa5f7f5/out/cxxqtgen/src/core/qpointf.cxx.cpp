...
extern "C" {
double cxxbridge1$202$QPointF$dot_product(::QPointF const &p1, ::QPointF const &p2) noexcept {
  double (*dot_product$)(::QPointF const &, ::QPointF const &) = &::QPointF::dotProduct;
  return dot_product$(p1, p2);
}

bool cxxbridge1$202$QPointF$is_null(::QPointF const &self) noexcept {
  bool (::QPointF::*is_null$)() const = &::QPointF::isNull;
  return (self.*is_null$)();
}

double cxxbridge1$202$QPointF$manhattan_length(::QPointF const &self) noexcept {
  double (::QPointF::*manhattan_length$)() const = &::QPointF::manhattanLength;
  return (self.*manhattan_length$)();
}

void cxxbridge1$202$QPointF$set_x(::QPointF &self, double x) noexcept {
  void (::QPointF::*set_x$)(double) = &::QPointF::setX;
  (self.*set_x$)(x);
}

void cxxbridge1$202$QPointF$set_y(::QPointF &self, double y) noexcept {
  void (::QPointF::*set_y$)(double) = &::QPointF::setY;
  (self.*set_y$)(y);
}

void cxxbridge1$202$QPointF$to_point(::QPointF const &self, ::QPoint *return$) noexcept {
  ::QPoint (::QPointF::*to_point$)() const = &::QPointF::toPoint;
  new (return$) ::QPoint((self.*to_point$)());
}

void cxxbridge1$202$QPointF$transposed(::QPointF const &self, ::QPointF *return$) noexcept {
  ::QPointF (::QPointF::*transposed$)() const = &::QPointF::transposed;
  new (return$) ::QPointF((self.*transposed$)());
}

double cxxbridge1$202$QPointF$x(::QPointF const &self) noexcept {
  double (::QPointF::*x$)() const = &::QPointF::x;
  return (self.*x$)();
}

double cxxbridge1$202$QPointF$y(::QPointF const &self) noexcept {
...
namespace cxxqtlib1 {
extern "C" {
void rust$cxxqtlib1$cxxbridge1$202$qpointf_init_default(::QPointF *return$) noexcept {
  ::QPointF (*qpointf_init_default$)() = ::rust::cxxqtlib1::construct;
  new (return$) ::QPointF(qpointf_init_default$());
}

void rust$cxxqtlib1$cxxbridge1$202$qpointf_init(double x, double y, ::QPointF *return$) noexcept {
  ::QPointF (*qpointf_init$)(double, double) = ::rust::cxxqtlib1::construct;
  new (return$) ::QPointF(qpointf_init$(x, y));
}

void rust$cxxqtlib1$cxxbridge1$202$qpointf_from_qpoint(::QPoint const &point, ::QPointF *return$) noexcept {
  ::QPointF (*qpointf_from_qpoint$)(::QPoint const &) = ::rust::cxxqtlib1::construct;
  new (return$) ::QPointF(qpointf_from_qpoint$(point));
}

void rust$cxxqtlib1$cxxbridge1$202$qpointf_to_debug_qstring(::QPointF const &value, ::QString *return$) noexcept {
...
void rust$cxxqtlib1$cxxbridge1$202$qpointf_plus(::QPointF const &a, ::QPointF const &b, ::QPointF *return$) noexcept {
  ::QPointF (*qpointf_plus$)(::QPointF const &, ::QPointF const &) = ::rust::cxxqtlib1::operatorPlus;
  new (return$) ::QPointF(qpointf_plus$(a, b));
}

void rust$cxxqtlib1$cxxbridge1$202$qpointf_minus(::QPointF const &a, ::QPointF const &b, ::QPointF *return$) noexcept {
  ::QPointF (*qpointf_minus$)(::QPointF const &, ::QPointF const &) = ::rust::cxxqtlib1::operatorMinus;
  new (return$) ::QPointF(qpointf_minus$(a, b));
}

void rust$cxxqtlib1$cxxbridge1$202$qpointf_mul(double a, ::QPointF const &b, ::QPointF *return$) noexcept {
  ::QPointF (*qpointf_mul$)(double, ::QPointF const &) = ::rust::cxxqtlib1::operatorMul;
  new (return$) ::QPointF(qpointf_mul$(a, b));
}

void rust$cxxqtlib1$cxxbridge1$202$qpointf_div(double a, ::QPointF const &b, ::QPointF *return$) noexcept {
