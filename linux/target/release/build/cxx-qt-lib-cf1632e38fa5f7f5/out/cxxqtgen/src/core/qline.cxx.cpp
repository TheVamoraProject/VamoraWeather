...
static_assert(
    ...
    "type QPoint should be trivially move constructible and trivially destructible in C++ to be used as a return value of `p1`, `p2`, `center` in Rust");
static_assert(
...
extern "C" {
void cxxbridge1$202$QLine$p1(::QLine const &self, ::QPoint *return$) noexcept {
  ::QPoint (::QLine::*p1$)() const = &::QLine::p1;
  new (return$) ::QPoint((self.*p1$)());
}

void cxxbridge1$202$QLine$p2(::QLine const &self, ::QPoint *return$) noexcept {
  ::QPoint (::QLine::*p2$)() const = &::QLine::p2;
  new (return$) ::QPoint((self.*p2$)());
}

::std::int32_t cxxbridge1$202$QLine$x1(::QLine const &self) noexcept {
  ::std::int32_t (::QLine::*x1$)() const = &::QLine::x1;
  return (self.*x1$)();
}

::std::int32_t cxxbridge1$202$QLine$x2(::QLine const &self) noexcept {
  ::std::int32_t (::QLine::*x2$)() const = &::QLine::x2;
  return (self.*x2$)();
}

::std::int32_t cxxbridge1$202$QLine$y1(::QLine const &self) noexcept {
  ::std::int32_t (::QLine::*y1$)() const = &::QLine::y1;
  return (self.*y1$)();
}

::std::int32_t cxxbridge1$202$QLine$y2(::QLine const &self) noexcept {
  ::std::int32_t (::QLine::*y2$)() const = &::QLine::y2;
  return (self.*y2$)();
}

void cxxbridge1$202$QLine$center(::QLine const &self, ::QPoint *return$) noexcept {
  ::QPoint (::QLine::*center$)() const = &::QLine::center;
  new (return$) ::QPoint((self.*center$)());
}

::std::int32_t cxxbridge1$202$QLine$dx(::QLine const &self) noexcept {
  ::std::int32_t (::QLine::*dx$)() const = &::QLine::dx;
  return (self.*dx$)();
}

::std::int32_t cxxbridge1$202$QLine$dy(::QLine const &self) noexcept {
  ::std::int32_t (::QLine::*dy$)() const = &::QLine::dy;
  return (self.*dy$)();
}

bool cxxbridge1$202$QLine$is_null(::QLine const &self) noexcept {
  bool (::QLine::*is_null$)() const = &::QLine::isNull;
  return (self.*is_null$)();
}

void cxxbridge1$202$QLine$set_p1(::QLine &self, ::QPoint const &p1) noexcept {
  void (::QLine::*set_p1$)(::QPoint const &) = &::QLine::setP1;
  (self.*set_p1$)(p1);
}

void cxxbridge1$202$QLine$set_p2(::QLine &self, ::QPoint const &p1) noexcept {
  void (::QLine::*set_p2$)(::QPoint const &) = &::QLine::setP2;
  (self.*set_p2$)(p1);
}

void cxxbridge1$202$QLine$set_line(::QLine &self, ::std::int32_t x1, ::std::int32_t y1, ::std::int32_t x2, ::std::int32_t y2) noexcept {
  void (::QLine::*set_line$)(::std::int32_t, ::std::int32_t, ::std::int32_t, ::std::int32_t) = &::QLine::setLine;
  (self.*set_line$)(x1, y1, x2, y2);
}

void cxxbridge1$202$QLine$set_points(::QLine &self, ::QPoint const &p1, ::QPoint const &p2) noexcept {
  void (::QLine::*set_points$)(::QPoint const &, ::QPoint const &) = &::QLine::setPoints;
  (self.*set_points$)(p1, p2);
}

void cxxbridge1$202$QLine$to_linef(::QLine const &self, ::QLineF *return$) noexcept {
  ::QLineF (::QLine::*to_linef$)() const = &::QLine::toLineF;
  new (return$) ::QLineF((self.*to_linef$)());
}

void cxxbridge1$202$QLine$translate(::QLine &self, ::QPoint const &offset) noexcept {
  void (::QLine::*translate$)(::QPoint const &) = &::QLine::translate;
  (self.*translate$)(offset);
}

void cxxbridge1$202$QLine$translated(::QLine const &self, ::QPoint const &offset, ::QLine *return$) noexcept {
...
namespace cxxqtlib1 {
extern "C" {
void rust$cxxqtlib1$cxxbridge1$202$qline_default(::QLine *return$) noexcept {
  ::QLine (*qline_default$)() = ::rust::cxxqtlib1::construct;
  new (return$) ::QLine(qline_default$());
}

void rust$cxxqtlib1$cxxbridge1$202$qline_new(::QPoint const &pt1, ::QPoint const &pt2, ::QLine *return$) noexcept {
  ::QLine (*qline_new$)(::QPoint const &, ::QPoint const &) = ::rust::cxxqtlib1::construct;
  new (return$) ::QLine(qline_new$(pt1, pt2));
}

void rust$cxxqtlib1$cxxbridge1$202$qline_to_debug_qstring(::QLine const &value, ::QString *return$) noexcept {
