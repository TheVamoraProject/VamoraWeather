...
namespace qvariant {
extern "C" {
bool rust$cxxqtlib1$qvariant$cxxbridge1$202$can_convert_u16(::QVariant const &variant) noexcept {
  bool (*can_convert_u16$)(::QVariant const &) = ::rust::cxxqtlib1::qvariant::qvariantCanConvertU16;
  return can_convert_u16$(variant);
}

void rust$cxxqtlib1$qvariant$cxxbridge1$202$construct_u16(::std::uint16_t const &value, ::QVariant *return$) noexcept {
...
::std::uint16_t rust$cxxqtlib1$qvariant$cxxbridge1$202$value_or_default_u16(::QVariant const &variant) noexcept {
