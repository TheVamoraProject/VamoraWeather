...
extern "C" {
void cxxbridge1$202$QVector_QDateTime$cxx_clear(::QVector_QDateTime &self) noexcept {
  void (::QVector_QDateTime::*cxx_clear$)() = &::QVector_QDateTime::clear;
  (self.*cxx_clear$)();
}

bool cxxbridge1$202$QVector_QDateTime$cxx_contains(::QVector_QDateTime const &self, ::QDateTime const &arg0) noexcept {
...
namespace cxxqtlib1 {
extern "C" {
void rust$cxxqtlib1$cxxbridge1$202$qvector_clone_QDateTime(::QVector_QDateTime const &arg0, ::QVector_QDateTime *return$) noexcept {
...
void rust$cxxqtlib1$cxxbridge1$202$qvector_default_QDateTime(::QVector_QDateTime *return$) noexcept {
...
void rust$cxxqtlib1$cxxbridge1$202$qvector_drop_QDateTime(::QVector_QDateTime &arg0) noexcept {
...
namespace qvector {
extern "C" {
void rust$cxxqtlib1$qvector$cxxbridge1$202$reserve_QDateTime(::QVector_QDateTime &arg0, ::rust::isize size) noexcept {
  void (*reserve_QDateTime$)(::QVector_QDateTime &, ::rust::isize) = ::rust::cxxqtlib1::qvector::qvectorReserve;
  reserve_QDateTime$(arg0, size);
}

void rust$cxxqtlib1$qvector$cxxbridge1$202$append_QDateTime(::QVector_QDateTime &arg0, ::QDateTime const &arg1) noexcept {
  void (*append_QDateTime$)(::QVector_QDateTime &, ::QDateTime const &) = ::rust::cxxqtlib1::qvector::qvectorAppend;
  append_QDateTime$(arg0, arg1);
}

void rust$cxxqtlib1$qvector$cxxbridge1$202$get_unchecked_QDateTime(::QVector_QDateTime const &set, ::rust::isize pos, ::QDateTime const **return$) noexcept {
...
::rust::isize rust$cxxqtlib1$qvector$cxxbridge1$202$index_of_QDateTime(::QVector_QDateTime const &arg0, ::QDateTime const &arg1) noexcept {
...
void rust$cxxqtlib1$qvector$cxxbridge1$202$insert_QDateTime(::QVector_QDateTime &arg0, ::rust::isize arg1, ::QDateTime const &arg2) noexcept {
...
void rust$cxxqtlib1$qvector$cxxbridge1$202$remove_QDateTime(::QVector_QDateTime &arg0, ::rust::isize arg1) noexcept {
  void (*remove_QDateTime$)(::QVector_QDateTime &, ::rust::isize) = ::rust::cxxqtlib1::qvector::qvectorRemove;
  remove_QDateTime$(arg0, arg1);
}

::rust::isize rust$cxxqtlib1$qvector$cxxbridge1$202$len_QDateTime(::QVector_QDateTime const &arg0) noexcept {
