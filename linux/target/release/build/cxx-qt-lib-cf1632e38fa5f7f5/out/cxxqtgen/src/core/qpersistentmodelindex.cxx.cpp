...
extern "C" {
::std::int32_t cxxbridge1$202$QPersistentModelIndex$column(::QPersistentModelIndex const &self) noexcept {
  ::std::int32_t (::QPersistentModelIndex::*column$)() const = &::QPersistentModelIndex::column;
  return (self.*column$)();
}

bool cxxbridge1$202$QPersistentModelIndex$is_valid(::QPersistentModelIndex const &self) noexcept {
  bool (::QPersistentModelIndex::*is_valid$)() const = &::QPersistentModelIndex::isValid;
  return (self.*is_valid$)();
}

void cxxbridge1$202$QPersistentModelIndex$parent(::QPersistentModelIndex const &self, ::QModelIndex *return$) noexcept {
  ::QModelIndex (::QPersistentModelIndex::*parent$)() const = &::QPersistentModelIndex::parent;
  new (return$) ::QModelIndex((self.*parent$)());
}

::std::int32_t cxxbridge1$202$QPersistentModelIndex$row(::QPersistentModelIndex const &self) noexcept {
  ::std::int32_t (::QPersistentModelIndex::*row$)() const = &::QPersistentModelIndex::row;
  return (self.*row$)();
}

void cxxbridge1$202$QPersistentModelIndex$sibling(::QPersistentModelIndex const &self, ::std::int32_t row, ::std::int32_t column, ::QModelIndex *return$) noexcept {
...
void cxxbridge1$202$QPersistentModelIndex$swap(::QPersistentModelIndex &self, ::QPersistentModelIndex &other) noexcept {
...
namespace cxxqtlib1 {
extern "C" {
void rust$cxxqtlib1$cxxbridge1$202$qpersistentmodelindex_drop(::QPersistentModelIndex &string) noexcept {
  void (*qpersistentmodelindex_drop$)(::QPersistentModelIndex &) = ::rust::cxxqtlib1::drop;
  qpersistentmodelindex_drop$(string);
}

void rust$cxxqtlib1$cxxbridge1$202$qpersistentmodelindex_from_qmodelindex(::QModelIndex const &index, ::QPersistentModelIndex *return$) noexcept {
...
void rust$cxxqtlib1$cxxbridge1$202$qpersistentmodelindex_clone(::QPersistentModelIndex const &other, ::QPersistentModelIndex *return$) noexcept {
...
bool rust$cxxqtlib1$cxxbridge1$202$qpersistentmodelindex_eq(::QPersistentModelIndex const &a, ::QPersistentModelIndex const &b) noexcept {
...
void rust$cxxqtlib1$cxxbridge1$202$qpersistentmodelindex_to_debug_qstring(::QPersistentModelIndex const &value, ::QString *return$) noexcept {
