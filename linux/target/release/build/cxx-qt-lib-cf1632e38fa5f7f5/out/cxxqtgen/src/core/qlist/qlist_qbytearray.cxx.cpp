...
extern "C" {
void cxxbridge1$202$QList_QByteArray$cxx_clear(::QList_QByteArray &self) noexcept {
  void (::QList_QByteArray::*cxx_clear$)() = &::QList_QByteArray::clear;
  (self.*cxx_clear$)();
}

bool cxxbridge1$202$QList_QByteArray$cxx_contains(::QList_QByteArray const &self, ::QByteArray const &arg0) noexcept {
...
namespace cxxqtlib1 {
extern "C" {
void rust$cxxqtlib1$cxxbridge1$202$qlist_clone_QByteArray(::QList_QByteArray const &arg0, ::QList_QByteArray *return$) noexcept {
...
void rust$cxxqtlib1$cxxbridge1$202$qlist_default_QByteArray(::QList_QByteArray *return$) noexcept {
  ::QList_QByteArray (*qlist_default_QByteArray$)() = ::rust::cxxqtlib1::construct;
  new (return$) ::QList_QByteArray(qlist_default_QByteArray$());
}

void rust$cxxqtlib1$cxxbridge1$202$qlist_drop_QByteArray(::QList_QByteArray &arg0) noexcept {
...
namespace qlist {
extern "C" {
void rust$cxxqtlib1$qlist$cxxbridge1$202$reserve_QByteArray(::QList_QByteArray &arg0, ::rust::isize size) noexcept {
  void (*reserve_QByteArray$)(::QList_QByteArray &, ::rust::isize) = ::rust::cxxqtlib1::qlist::qlistReserve;
  reserve_QByteArray$(arg0, size);
}

void rust$cxxqtlib1$qlist$cxxbridge1$202$append_QByteArray(::QList_QByteArray &arg0, ::QByteArray const &arg1) noexcept {
  void (*append_QByteArray$)(::QList_QByteArray &, ::QByteArray const &) = ::rust::cxxqtlib1::qlist::qlistAppend;
  append_QByteArray$(arg0, arg1);
}

void rust$cxxqtlib1$qlist$cxxbridge1$202$get_unchecked_QByteArray(::QList_QByteArray const &set, ::rust::isize pos, ::QByteArray const **return$) noexcept {
...
::rust::isize rust$cxxqtlib1$qlist$cxxbridge1$202$index_of_QByteArray(::QList_QByteArray const &arg0, ::QByteArray const &arg1) noexcept {
...
void rust$cxxqtlib1$qlist$cxxbridge1$202$insert_QByteArray(::QList_QByteArray &arg0, ::rust::isize arg1, ::QByteArray const &arg2) noexcept {
...
void rust$cxxqtlib1$qlist$cxxbridge1$202$remove_QByteArray(::QList_QByteArray &arg0, ::rust::isize arg1) noexcept {
  void (*remove_QByteArray$)(::QList_QByteArray &, ::rust::isize) = ::rust::cxxqtlib1::qlist::qlistRemove;
  remove_QByteArray$(arg0, arg1);
}

::rust::isize rust$cxxqtlib1$qlist$cxxbridge1$202$len_QByteArray(::QList_QByteArray const &arg0) noexcept {
