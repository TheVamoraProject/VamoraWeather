...
extern "C" {
void cxxbridge1$202$QSet_i32$cxx_clear(::QSet_i32 &self) noexcept {
  void (::QSet_i32::*cxx_clear$)() = &::QSet_i32::clear;
  (self.*cxx_clear$)();
}

bool cxxbridge1$202$QSet_i32$cxx_contains(::QSet_i32 const &self, ::std::int32_t const &arg0) noexcept {
  bool (::QSet_i32::*cxx_contains$)(::std::int32_t const &) const = &::QSet_i32::contains;
  return (self.*cxx_contains$)(arg0);
}

bool cxxbridge1$202$QSet_i32$cxx_remove(::QSet_i32 &self, ::std::int32_t const &arg0) noexcept {
...
namespace cxxqtlib1 {
extern "C" {
void rust$cxxqtlib1$cxxbridge1$202$qset_clone_i32(::QSet_i32 const &arg0, ::QSet_i32 *return$) noexcept {
  ::QSet_i32 (*qset_clone_i32$)(::QSet_i32 const &) = ::rust::cxxqtlib1::construct;
  new (return$) ::QSet_i32(qset_clone_i32$(arg0));
}

void rust$cxxqtlib1$cxxbridge1$202$qset_default_i32(::QSet_i32 *return$) noexcept {
  ::QSet_i32 (*qset_default_i32$)() = ::rust::cxxqtlib1::construct;
  new (return$) ::QSet_i32(qset_default_i32$());
}

void rust$cxxqtlib1$cxxbridge1$202$qset_drop_i32(::QSet_i32 &arg0) noexcept {
...
namespace qset {
extern "C" {
::std::int32_t const *rust$cxxqtlib1$qset$cxxbridge1$202$get_unchecked_i32(::QSet_i32 const &set, ::rust::isize pos) noexcept {
...
void rust$cxxqtlib1$qset$cxxbridge1$202$insert_i32(::QSet_i32 &arg0, ::std::int32_t const &arg1) noexcept {
  void (*insert_i32$)(::QSet_i32 &, ::std::int32_t const &) = ::rust::cxxqtlib1::qset::qsetInsert;
  insert_i32$(arg0, arg1);
}

::rust::isize rust$cxxqtlib1$qset$cxxbridge1$202$len_i32(::QSet_i32 const &arg0) noexcept {
  ::rust::isize (*len_i32$)(::QSet_i32 const &) = ::rust::cxxqtlib1::qset::qsetLen;
  return len_i32$(arg0);
}

void rust$cxxqtlib1$qset$cxxbridge1$202$reserve_i32(::QSet_i32 &arg0, ::rust::isize size) noexcept {
