...
namespace rust {
  namespace cxxqtlib1 {
    using QTimeZoneNameType = ::rust::cxxqtlib1::QTimeZoneNameType;
    using QTimeZoneTimeType = ::rust::cxxqtlib1::QTimeZoneTimeType;
  }
}
...
static_assert(
    ...
    "type QByteArray should be trivially move constructible and trivially destructible in C++ to be used as a return value of `system_time_zone_id`, `id` in Rust");
static_assert(
    ::rust::IsRelocatable<::QList_QByteArray>::value,
    "type QList_QByteArray should be trivially move constructible and trivially destructible in C++ to be used as a return value of `available_time_zone_ids` in Rust");
static_assert(
...
extern "C" {
void cxxbridge1$202$QTimeZone$available_time_zone_ids(::QList_QByteArray *return$) noexcept {
  ::QList_QByteArray (*available_time_zone_ids$)() = &::QTimeZone::availableTimeZoneIds;
  new (return$) ::QList_QByteArray(available_time_zone_ids$());
}

void cxxbridge1$202$QTimeZone$system_time_zone_id(::QByteArray *return$) noexcept {
  ::QByteArray (*system_time_zone_id$)() = &::QTimeZone::systemTimeZoneId;
  new (return$) ::QByteArray(system_time_zone_id$());
}

void cxxbridge1$202$QTimeZone$abbreviation(::QTimeZone const &self, ::QDateTime const &at_date_time, ::QString *return$) noexcept {
...
void cxxbridge1$202$QTimeZone$comment(::QTimeZone const &self, ::QString *return$) noexcept {
  ::QString (::QTimeZone::*comment$)() const = &::QTimeZone::comment;
  new (return$) ::QString((self.*comment$)());
}

::std::int32_t cxxbridge1$202$QTimeZone$daylight_time_offset(::QTimeZone const &self, ::QDateTime const &at_date_time) noexcept {
...
bool cxxbridge1$202$QTimeZone$has_daylight_time(::QTimeZone const &self) noexcept {
  bool (::QTimeZone::*has_daylight_time$)() const = &::QTimeZone::hasDaylightTime;
  return (self.*has_daylight_time$)();
}

bool cxxbridge1$202$QTimeZone$has_transitions(::QTimeZone const &self) noexcept {
  bool (::QTimeZone::*has_transitions$)() const = &::QTimeZone::hasTransitions;
  return (self.*has_transitions$)();
}

void cxxbridge1$202$QTimeZone$id(::QTimeZone const &self, ::QByteArray *return$) noexcept {
  ::QByteArray (::QTimeZone::*id$)() const = &::QTimeZone::id;
  new (return$) ::QByteArray((self.*id$)());
}

bool cxxbridge1$202$QTimeZone$is_daylight_time(::QTimeZone const &self, ::QDateTime const &at_date_time) noexcept {
  bool (::QTimeZone::*is_daylight_time$)(::QDateTime const &) const = &::QTimeZone::isDaylightTime;
  return (self.*is_daylight_time$)(at_date_time);
}

bool cxxbridge1$202$QTimeZone$is_valid(::QTimeZone const &self) noexcept {
  bool (::QTimeZone::*is_valid$)() const = &::QTimeZone::isValid;
  return (self.*is_valid$)();
}

::std::int32_t cxxbridge1$202$QTimeZone$offset_from_utc(::QTimeZone const &self, ::QDateTime const &at_date_time) noexcept {
...
::std::int32_t cxxbridge1$202$QTimeZone$standard_time_offset(::QTimeZone const &self, ::QDateTime const &at_date_time) noexcept {
...
namespace cxxqtlib1 {
extern "C" {
::QTimeZone *rust$cxxqtlib1$cxxbridge1$202$qtimezone_clone(::QTimeZone const &timezone) noexcept {
...
::QTimeZone *rust$cxxqtlib1$cxxbridge1$202$qtimezone_default() noexcept {
  ::std::unique_ptr<::QTimeZone> (*qtimezone_default$)() = ::rust::cxxqtlib1::qtimezoneDefault;
  return qtimezone_default$().release();
}

void rust$cxxqtlib1$cxxbridge1$202$qtimezone_display_name(::QTimeZone const &timezone, ::rust::cxxqtlib1::QTimeZoneTimeType time_type, ::rust::cxxqtlib1::QTimeZoneNameType name_type, ::QString *return$) noexcept {
  ::QString (*qtimezone_display_name$)(::QTimeZone const &, ::rust::cxxqtlib1::QTimeZoneTimeType, ::rust::cxxqtlib1::QTimeZoneNameType) = ::rust::cxxqtlib1::qtimezoneDisplayName;
  new (return$) ::QString(qtimezone_display_name$(timezone, time_type, name_type));
}

::QTimeZone *rust$cxxqtlib1$cxxbridge1$202$qtimezone_from_offset_seconds(::std::int32_t offset_seconds) noexcept {
...
::QTimeZone *rust$cxxqtlib1$cxxbridge1$202$qtimezone_from_iana(::QByteArray const &iana_id) noexcept {
...
::QTimeZone *rust$cxxqtlib1$cxxbridge1$202$qtimezone_system_time_zone() noexcept {
...
::QTimeZone *rust$cxxqtlib1$cxxbridge1$202$qtimezone_utc() noexcept {
  ::std::unique_ptr<::QTimeZone> (*qtimezone_utc$)() = ::rust::cxxqtlib1::qtimezoneUtc;
  return qtimezone_utc$().release();
}

bool rust$cxxqtlib1$cxxbridge1$202$qtimezone_eq(::QTimeZone const &a, ::QTimeZone const &b) noexcept {
  bool (*qtimezone_eq$)(::QTimeZone const &, ::QTimeZone const &) = ::rust::cxxqtlib1::operatorEq;
  return qtimezone_eq$(a, b);
}

void rust$cxxqtlib1$cxxbridge1$202$qtimezone_to_debug_qstring(::QTimeZone const &value, ::QString *return$) noexcept {
