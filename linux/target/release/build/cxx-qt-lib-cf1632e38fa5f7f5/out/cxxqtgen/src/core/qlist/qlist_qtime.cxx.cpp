...
extern "C" {
void cxxbridge1$202$QList_QTime$cxx_clear(::QList_QTime &self) noexcept {
  void (::QList_QTime::*cxx_clear$)() = &::QList_QTime::clear;
  (self.*cxx_clear$)();
}

bool cxxbridge1$202$QList_QTime$cxx_contains(::QList_QTime const &self, ::QTime const &arg0) noexcept {
...
namespace cxxqtlib1 {
extern "C" {
void rust$cxxqtlib1$cxxbridge1$202$qlist_clone_QTime(::QList_QTime const &arg0, ::QList_QTime *return$) noexcept {
  ::QList_QTime (*qlist_clone_QTime$)(::QList_QTime const &) = ::rust::cxxqtlib1::construct;
  new (return$) ::QList_QTime(qlist_clone_QTime$(arg0));
}

void rust$cxxqtlib1$cxxbridge1$202$qlist_default_QTime(::QList_QTime *return$) noexcept {
  ::QList_QTime (*qlist_default_QTime$)() = ::rust::cxxqtlib1::construct;
  new (return$) ::QList_QTime(qlist_default_QTime$());
}

void rust$cxxqtlib1$cxxbridge1$202$qlist_drop_QTime(::QList_QTime &arg0) noexcept {
...
namespace qlist {
extern "C" {
void rust$cxxqtlib1$qlist$cxxbridge1$202$reserve_QTime(::QList_QTime &arg0, ::rust::isize size) noexcept {
  void (*reserve_QTime$)(::QList_QTime &, ::rust::isize) = ::rust::cxxqtlib1::qlist::qlistReserve;
  reserve_QTime$(arg0, size);
}

void rust$cxxqtlib1$qlist$cxxbridge1$202$append_QTime(::QList_QTime &arg0, ::QTime const &arg1) noexcept {
  void (*append_QTime$)(::QList_QTime &, ::QTime const &) = ::rust::cxxqtlib1::qlist::qlistAppend;
  append_QTime$(arg0, arg1);
}

void rust$cxxqtlib1$qlist$cxxbridge1$202$get_unchecked_QTime(::QList_QTime const &set, ::rust::isize pos, ::QTime const **return$) noexcept {
...
::rust::isize rust$cxxqtlib1$qlist$cxxbridge1$202$index_of_QTime(::QList_QTime const &arg0, ::QTime const &arg1) noexcept {
  ::rust::isize (*index_of_QTime$)(::QList_QTime const &, ::QTime const &) = ::rust::cxxqtlib1::qlist::qlistIndexOf;
  return index_of_QTime$(arg0, arg1);
}

void rust$cxxqtlib1$qlist$cxxbridge1$202$insert_QTime(::QList_QTime &arg0, ::rust::isize arg1, ::QTime const &arg2) noexcept {
  void (*insert_QTime$)(::QList_QTime &, ::rust::isize, ::QTime const &) = ::rust::cxxqtlib1::qlist::qlistInsert;
  insert_QTime$(arg0, arg1, arg2);
}

void rust$cxxqtlib1$qlist$cxxbridge1$202$remove_QTime(::QList_QTime &arg0, ::rust::isize arg1) noexcept {
  void (*remove_QTime$)(::QList_QTime &, ::rust::isize) = ::rust::cxxqtlib1::qlist::qlistRemove;
  remove_QTime$(arg0, arg1);
}

::rust::isize rust$cxxqtlib1$qlist$cxxbridge1$202$len_QTime(::QList_QTime const &arg0) noexcept {
