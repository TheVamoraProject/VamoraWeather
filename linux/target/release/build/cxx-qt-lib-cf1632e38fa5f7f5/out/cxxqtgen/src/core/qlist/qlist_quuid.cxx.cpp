...
extern "C" {
void cxxbridge1$202$QList_QUuid$cxx_clear(::QList_QUuid &self) noexcept {
  void (::QList_QUuid::*cxx_clear$)() = &::QList_QUuid::clear;
  (self.*cxx_clear$)();
}

bool cxxbridge1$202$QList_QUuid$cxx_contains(::QList_QUuid const &self, ::QUuid const &arg0) noexcept {
...
namespace cxxqtlib1 {
extern "C" {
void rust$cxxqtlib1$cxxbridge1$202$qlist_clone_QUuid(::QList_QUuid const &arg0, ::QList_QUuid *return$) noexcept {
  ::QList_QUuid (*qlist_clone_QUuid$)(::QList_QUuid const &) = ::rust::cxxqtlib1::construct;
  new (return$) ::QList_QUuid(qlist_clone_QUuid$(arg0));
}

void rust$cxxqtlib1$cxxbridge1$202$qlist_default_QUuid(::QList_QUuid *return$) noexcept {
  ::QList_QUuid (*qlist_default_QUuid$)() = ::rust::cxxqtlib1::construct;
  new (return$) ::QList_QUuid(qlist_default_QUuid$());
}

void rust$cxxqtlib1$cxxbridge1$202$qlist_drop_QUuid(::QList_QUuid &arg0) noexcept {
...
namespace qlist {
extern "C" {
void rust$cxxqtlib1$qlist$cxxbridge1$202$reserve_QUuid(::QList_QUuid &arg0, ::rust::isize size) noexcept {
  void (*reserve_QUuid$)(::QList_QUuid &, ::rust::isize) = ::rust::cxxqtlib1::qlist::qlistReserve;
  reserve_QUuid$(arg0, size);
}

void rust$cxxqtlib1$qlist$cxxbridge1$202$append_QUuid(::QList_QUuid &arg0, ::QUuid const &arg1) noexcept {
  void (*append_QUuid$)(::QList_QUuid &, ::QUuid const &) = ::rust::cxxqtlib1::qlist::qlistAppend;
  append_QUuid$(arg0, arg1);
}

void rust$cxxqtlib1$qlist$cxxbridge1$202$get_unchecked_QUuid(::QList_QUuid const &set, ::rust::isize pos, ::QUuid const **return$) noexcept {
...
::rust::isize rust$cxxqtlib1$qlist$cxxbridge1$202$index_of_QUuid(::QList_QUuid const &arg0, ::QUuid const &arg1) noexcept {
  ::rust::isize (*index_of_QUuid$)(::QList_QUuid const &, ::QUuid const &) = ::rust::cxxqtlib1::qlist::qlistIndexOf;
  return index_of_QUuid$(arg0, arg1);
}

void rust$cxxqtlib1$qlist$cxxbridge1$202$insert_QUuid(::QList_QUuid &arg0, ::rust::isize arg1, ::QUuid const &arg2) noexcept {
  void (*insert_QUuid$)(::QList_QUuid &, ::rust::isize, ::QUuid const &) = ::rust::cxxqtlib1::qlist::qlistInsert;
  insert_QUuid$(arg0, arg1, arg2);
}

void rust$cxxqtlib1$qlist$cxxbridge1$202$remove_QUuid(::QList_QUuid &arg0, ::rust::isize arg1) noexcept {
  void (*remove_QUuid$)(::QList_QUuid &, ::rust::isize) = ::rust::cxxqtlib1::qlist::qlistRemove;
  remove_QUuid$(arg0, arg1);
}

::rust::isize rust$cxxqtlib1$qlist$cxxbridge1$202$len_QUuid(::QList_QUuid const &arg0) noexcept {
