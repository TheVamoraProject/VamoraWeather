...
extern "C" {
void cxxbridge1$202$QList_QColor$cxx_clear(::QList_QColor &self) noexcept {
  void (::QList_QColor::*cxx_clear$)() = &::QList_QColor::clear;
  (self.*cxx_clear$)();
}

bool cxxbridge1$202$QList_QColor$cxx_contains(::QList_QColor const &self, ::QColor const &arg0) noexcept {
...
namespace cxxqtlib1 {
extern "C" {
void rust$cxxqtlib1$cxxbridge1$202$qlist_clone_QColor(::QList_QColor const &arg0, ::QList_QColor *return$) noexcept {
...
void rust$cxxqtlib1$cxxbridge1$202$qlist_default_QColor(::QList_QColor *return$) noexcept {
  ::QList_QColor (*qlist_default_QColor$)() = ::rust::cxxqtlib1::construct;
  new (return$) ::QList_QColor(qlist_default_QColor$());
}

void rust$cxxqtlib1$cxxbridge1$202$qlist_drop_QColor(::QList_QColor &arg0) noexcept {
...
namespace qlist {
extern "C" {
void rust$cxxqtlib1$qlist$cxxbridge1$202$reserve_QColor(::QList_QColor &arg0, ::rust::isize size) noexcept {
  void (*reserve_QColor$)(::QList_QColor &, ::rust::isize) = ::rust::cxxqtlib1::qlist::qlistReserve;
  reserve_QColor$(arg0, size);
}

void rust$cxxqtlib1$qlist$cxxbridge1$202$append_QColor(::QList_QColor &arg0, ::QColor const &arg1) noexcept {
  void (*append_QColor$)(::QList_QColor &, ::QColor const &) = ::rust::cxxqtlib1::qlist::qlistAppend;
  append_QColor$(arg0, arg1);
}

void rust$cxxqtlib1$qlist$cxxbridge1$202$get_unchecked_QColor(::QList_QColor const &set, ::rust::isize pos, ::QColor const **return$) noexcept {
...
::rust::isize rust$cxxqtlib1$qlist$cxxbridge1$202$index_of_QColor(::QList_QColor const &arg0, ::QColor const &arg1) noexcept {
...
void rust$cxxqtlib1$qlist$cxxbridge1$202$insert_QColor(::QList_QColor &arg0, ::rust::isize arg1, ::QColor const &arg2) noexcept {
  void (*insert_QColor$)(::QList_QColor &, ::rust::isize, ::QColor const &) = ::rust::cxxqtlib1::qlist::qlistInsert;
  insert_QColor$(arg0, arg1, arg2);
}

void rust$cxxqtlib1$qlist$cxxbridge1$202$remove_QColor(::QList_QColor &arg0, ::rust::isize arg1) noexcept {
  void (*remove_QColor$)(::QList_QColor &, ::rust::isize) = ::rust::cxxqtlib1::qlist::qlistRemove;
  remove_QColor$(arg0, arg1);
}

::rust::isize rust$cxxqtlib1$qlist$cxxbridge1$202$len_QColor(::QList_QColor const &arg0) noexcept {
