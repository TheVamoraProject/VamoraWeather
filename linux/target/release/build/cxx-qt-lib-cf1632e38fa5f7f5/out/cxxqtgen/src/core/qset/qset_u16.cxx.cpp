...
extern "C" {
void cxxbridge1$202$QSet_u16$cxx_clear(::QSet_u16 &self) noexcept {
  void (::QSet_u16::*cxx_clear$)() = &::QSet_u16::clear;
  (self.*cxx_clear$)();
}

bool cxxbridge1$202$QSet_u16$cxx_contains(::QSet_u16 const &self, ::std::uint16_t const &arg0) noexcept {
  bool (::QSet_u16::*cxx_contains$)(::std::uint16_t const &) const = &::QSet_u16::contains;
  return (self.*cxx_contains$)(arg0);
}

bool cxxbridge1$202$QSet_u16$cxx_remove(::QSet_u16 &self, ::std::uint16_t const &arg0) noexcept {
...
namespace cxxqtlib1 {
extern "C" {
void rust$cxxqtlib1$cxxbridge1$202$qset_clone_u16(::QSet_u16 const &arg0, ::QSet_u16 *return$) noexcept {
  ::QSet_u16 (*qset_clone_u16$)(::QSet_u16 const &) = ::rust::cxxqtlib1::construct;
  new (return$) ::QSet_u16(qset_clone_u16$(arg0));
}

void rust$cxxqtlib1$cxxbridge1$202$qset_default_u16(::QSet_u16 *return$) noexcept {
  ::QSet_u16 (*qset_default_u16$)() = ::rust::cxxqtlib1::construct;
  new (return$) ::QSet_u16(qset_default_u16$());
}

void rust$cxxqtlib1$cxxbridge1$202$qset_drop_u16(::QSet_u16 &arg0) noexcept {
...
namespace qset {
extern "C" {
::std::uint16_t const *rust$cxxqtlib1$qset$cxxbridge1$202$get_unchecked_u16(::QSet_u16 const &set, ::rust::isize pos) noexcept {
...
void rust$cxxqtlib1$qset$cxxbridge1$202$insert_u16(::QSet_u16 &arg0, ::std::uint16_t const &arg1) noexcept {
  void (*insert_u16$)(::QSet_u16 &, ::std::uint16_t const &) = ::rust::cxxqtlib1::qset::qsetInsert;
  insert_u16$(arg0, arg1);
}

::rust::isize rust$cxxqtlib1$qset$cxxbridge1$202$len_u16(::QSet_u16 const &arg0) noexcept {
  ::rust::isize (*len_u16$)(::QSet_u16 const &) = ::rust::cxxqtlib1::qset::qsetLen;
  return len_u16$(arg0);
}

void rust$cxxqtlib1$qset$cxxbridge1$202$reserve_u16(::QSet_u16 &arg0, ::rust::isize size) noexcept {
