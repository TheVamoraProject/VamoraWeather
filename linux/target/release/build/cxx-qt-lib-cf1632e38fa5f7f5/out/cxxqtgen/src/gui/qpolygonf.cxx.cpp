...
extern "C" {
void cxxbridge1$202$QPolygonF$bounding_rect(::QPolygonF const &self, ::QRectF *return$) noexcept {
  ::QRectF (::QPolygonF::*bounding_rect$)() const = &::QPolygonF::boundingRect;
  new (return$) ::QRectF((self.*bounding_rect$)());
}

bool cxxbridge1$202$QPolygonF$contains_point(::QPolygonF const &self, ::QPointF const &point, ::Qt::FillRule *fill_rule) noexcept {
...
void cxxbridge1$202$QPolygonF$intersected(::QPolygonF const &self, ::QPolygonF const &r, ::QPolygonF *return$) noexcept {
  ::QPolygonF (::QPolygonF::*intersected$)(::QPolygonF const &) const = &::QPolygonF::intersected;
  new (return$) ::QPolygonF((self.*intersected$)(r));
}

bool cxxbridge1$202$QPolygonF$intersects(::QPolygonF const &self, ::QPolygonF const &p) noexcept {
  bool (::QPolygonF::*intersects$)(::QPolygonF const &) const = &::QPolygonF::intersects;
  return (self.*intersects$)(p);
}

bool cxxbridge1$202$QPolygonF$is_closed(::QPolygonF const &self) noexcept {
  bool (::QPolygonF::*is_closed$)() const = &::QPolygonF::isClosed;
  return (self.*is_closed$)();
}

void cxxbridge1$202$QPolygonF$subtracted(::QPolygonF const &self, ::QPolygonF const &r, ::QPolygonF *return$) noexcept {
  ::QPolygonF (::QPolygonF::*subtracted$)(::QPolygonF const &) const = &::QPolygonF::subtracted;
  new (return$) ::QPolygonF((self.*subtracted$)(r));
}

void cxxbridge1$202$QPolygonF$to_polygon(::QPolygonF const &self, ::QPolygon *return$) noexcept {
  ::QPolygon (::QPolygonF::*to_polygon$)() const = &::QPolygonF::toPolygon;
  new (return$) ::QPolygon((self.*to_polygon$)());
}

void cxxbridge1$202$QPolygonF$translate(::QPolygonF &self, double dx, double dy) noexcept {
  void (::QPolygonF::*translate$)(double, double) = &::QPolygonF::translate;
  (self.*translate$)(dx, dy);
}

void cxxbridge1$202$QPolygonF$translated(::QPolygonF const &self, double dx, double dy, ::QPolygonF *return$) noexcept {
  ::QPolygonF (::QPolygonF::*translated$)(double, double) const = &::QPolygonF::translated;
  new (return$) ::QPolygonF((self.*translated$)(dx, dy));
}

void cxxbridge1$202$QPolygonF$united(::QPolygonF const &self, ::QPolygonF const &r, ::QPolygonF *return$) noexcept {
...
namespace cxxqt1 {
extern "C" {
::QVector_QPointF const *rust$cxxqt1$cxxbridge1$202$upcast_qpolygonf(::QPolygonF const *thiz) noexcept {
  ::QVector_QPointF const *(*upcast_qpolygonf$)(::QPolygonF const *) = ::rust::cxxqt1::upcastPtr;
  return upcast_qpolygonf$(thiz);
}

::QPolygonF const *rust$cxxqt1$cxxbridge1$202$downcast_qvector_qpointf(::QVector_QPointF const *base) noexcept {
...
namespace cxxqtlib1 {
extern "C" {
void rust$cxxqtlib1$cxxbridge1$202$qpolygonf_init_default(::QPolygonF *return$) noexcept {
  ::QPolygonF (*qpolygonf_init_default$)() = ::rust::cxxqtlib1::construct;
  new (return$) ::QPolygonF(qpolygonf_init_default$());
}

void rust$cxxqtlib1$cxxbridge1$202$qpolygonf_from_qrectf(::QRectF const &rectangle, ::QPolygonF *return$) noexcept {
  ::QPolygonF (*qpolygonf_from_qrectf$)(::QRectF const &) = ::rust::cxxqtlib1::construct;
  new (return$) ::QPolygonF(qpolygonf_from_qrectf$(rectangle));
}

void rust$cxxqtlib1$cxxbridge1$202$qpolygonf_from_qvector_qpointf(::QVector_QPointF const &points, ::QPolygonF *return$) noexcept {
  ::QPolygonF (*qpolygonf_from_qvector_qpointf$)(::QVector_QPointF const &) = ::rust::cxxqtlib1::construct;
  new (return$) ::QPolygonF(qpolygonf_from_qvector_qpointf$(points));
}

void rust$cxxqtlib1$cxxbridge1$202$qpolygonf_from_qpolygon(::QPolygon const &polygon, ::QPolygonF *return$) noexcept {
  ::QPolygonF (*qpolygonf_from_qpolygon$)(::QPolygon const &) = ::rust::cxxqtlib1::construct;
  new (return$) ::QPolygonF(qpolygonf_from_qpolygon$(polygon));
}

void rust$cxxqtlib1$cxxbridge1$202$qpolygonf_drop(::QPolygonF &pen) noexcept {
  void (*qpolygonf_drop$)(::QPolygonF &) = ::rust::cxxqtlib1::drop;
  qpolygonf_drop$(pen);
}

void rust$cxxqtlib1$cxxbridge1$202$qpolygonf_clone(::QPolygonF const &p, ::QPolygonF *return$) noexcept {
  ::QPolygonF (*qpolygonf_clone$)(::QPolygonF const &) = ::rust::cxxqtlib1::construct;
  new (return$) ::QPolygonF(qpolygonf_clone$(p));
}

bool rust$cxxqtlib1$cxxbridge1$202$qpolygonf_eq(::QPolygonF const &a, ::QPolygonF const &b) noexcept {
  bool (*qpolygonf_eq$)(::QPolygonF const &, ::QPolygonF const &) = ::rust::cxxqtlib1::operatorEq;
  return qpolygonf_eq$(a, b);
}

void rust$cxxqtlib1$cxxbridge1$202$qpolygonf_to_debug_qstring(::QPolygonF const &value, ::QString *return$) noexcept {
