...
extern "C" {
void cxxbridge1$202$QSet_f64$cxx_clear(::QSet_f64 &self) noexcept {
  void (::QSet_f64::*cxx_clear$)() = &::QSet_f64::clear;
  (self.*cxx_clear$)();
}

bool cxxbridge1$202$QSet_f64$cxx_contains(::QSet_f64 const &self, double const &arg0) noexcept {
  bool (::QSet_f64::*cxx_contains$)(double const &) const = &::QSet_f64::contains;
  return (self.*cxx_contains$)(arg0);
}

bool cxxbridge1$202$QSet_f64$cxx_remove(::QSet_f64 &self, double const &arg0) noexcept {
...
namespace cxxqtlib1 {
extern "C" {
void rust$cxxqtlib1$cxxbridge1$202$qset_clone_f64(::QSet_f64 const &arg0, ::QSet_f64 *return$) noexcept {
  ::QSet_f64 (*qset_clone_f64$)(::QSet_f64 const &) = ::rust::cxxqtlib1::construct;
  new (return$) ::QSet_f64(qset_clone_f64$(arg0));
}

void rust$cxxqtlib1$cxxbridge1$202$qset_default_f64(::QSet_f64 *return$) noexcept {
  ::QSet_f64 (*qset_default_f64$)() = ::rust::cxxqtlib1::construct;
  new (return$) ::QSet_f64(qset_default_f64$());
}

void rust$cxxqtlib1$cxxbridge1$202$qset_drop_f64(::QSet_f64 &arg0) noexcept {
...
namespace qset {
extern "C" {
double const *rust$cxxqtlib1$qset$cxxbridge1$202$get_unchecked_f64(::QSet_f64 const &set, ::rust::isize pos) noexcept {
...
void rust$cxxqtlib1$qset$cxxbridge1$202$insert_f64(::QSet_f64 &arg0, double const &arg1) noexcept {
  void (*insert_f64$)(::QSet_f64 &, double const &) = ::rust::cxxqtlib1::qset::qsetInsert;
  insert_f64$(arg0, arg1);
}

::rust::isize rust$cxxqtlib1$qset$cxxbridge1$202$len_f64(::QSet_f64 const &arg0) noexcept {
  ::rust::isize (*len_f64$)(::QSet_f64 const &) = ::rust::cxxqtlib1::qset::qsetLen;
  return len_f64$(arg0);
}

void rust$cxxqtlib1$qset$cxxbridge1$202$reserve_f64(::QSet_f64 &arg0, ::rust::isize size) noexcept {
