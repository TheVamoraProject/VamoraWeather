...
extern "C" {
void cxxbridge1$202$QList_QDateTime$cxx_clear(::QList_QDateTime &self) noexcept {
  void (::QList_QDateTime::*cxx_clear$)() = &::QList_QDateTime::clear;
  (self.*cxx_clear$)();
}

bool cxxbridge1$202$QList_QDateTime$cxx_contains(::QList_QDateTime const &self, ::QDateTime const &arg0) noexcept {
...
namespace cxxqtlib1 {
extern "C" {
void rust$cxxqtlib1$cxxbridge1$202$qlist_clone_QDateTime(::QList_QDateTime const &arg0, ::QList_QDateTime *return$) noexcept {
...
void rust$cxxqtlib1$cxxbridge1$202$qlist_default_QDateTime(::QList_QDateTime *return$) noexcept {
  ::QList_QDateTime (*qlist_default_QDateTime$)() = ::rust::cxxqtlib1::construct;
  new (return$) ::QList_QDateTime(qlist_default_QDateTime$());
}

void rust$cxxqtlib1$cxxbridge1$202$qlist_drop_QDateTime(::QList_QDateTime &arg0) noexcept {
...
namespace qlist {
extern "C" {
void rust$cxxqtlib1$qlist$cxxbridge1$202$reserve_QDateTime(::QList_QDateTime &arg0, ::rust::isize size) noexcept {
  void (*reserve_QDateTime$)(::QList_QDateTime &, ::rust::isize) = ::rust::cxxqtlib1::qlist::qlistReserve;
  reserve_QDateTime$(arg0, size);
}

void rust$cxxqtlib1$qlist$cxxbridge1$202$append_QDateTime(::QList_QDateTime &arg0, ::QDateTime const &arg1) noexcept {
  void (*append_QDateTime$)(::QList_QDateTime &, ::QDateTime const &) = ::rust::cxxqtlib1::qlist::qlistAppend;
  append_QDateTime$(arg0, arg1);
}

void rust$cxxqtlib1$qlist$cxxbridge1$202$get_unchecked_QDateTime(::QList_QDateTime const &set, ::rust::isize pos, ::QDateTime const **return$) noexcept {
...
::rust::isize rust$cxxqtlib1$qlist$cxxbridge1$202$index_of_QDateTime(::QList_QDateTime const &arg0, ::QDateTime const &arg1) noexcept {
...
void rust$cxxqtlib1$qlist$cxxbridge1$202$insert_QDateTime(::QList_QDateTime &arg0, ::rust::isize arg1, ::QDateTime const &arg2) noexcept {
...
void rust$cxxqtlib1$qlist$cxxbridge1$202$remove_QDateTime(::QList_QDateTime &arg0, ::rust::isize arg1) noexcept {
  void (*remove_QDateTime$)(::QList_QDateTime &, ::rust::isize) = ::rust::cxxqtlib1::qlist::qlistRemove;
  remove_QDateTime$(arg0, arg1);
}

::rust::isize rust$cxxqtlib1$qlist$cxxbridge1$202$len_QDateTime(::QList_QDateTime const &arg0) noexcept {
