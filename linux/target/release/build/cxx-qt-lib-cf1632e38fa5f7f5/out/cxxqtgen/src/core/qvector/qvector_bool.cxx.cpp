...
extern "C" {
void cxxbridge1$202$QVector_bool$cxx_clear(::QVector_bool &self) noexcept {
  void (::QVector_bool::*cxx_clear$)() = &::QVector_bool::clear;
  (self.*cxx_clear$)();
}

bool cxxbridge1$202$QVector_bool$cxx_contains(::QVector_bool const &self, bool const &arg0) noexcept {
...
namespace cxxqtlib1 {
extern "C" {
void rust$cxxqtlib1$cxxbridge1$202$qvector_clone_bool(::QVector_bool const &arg0, ::QVector_bool *return$) noexcept {
...
void rust$cxxqtlib1$cxxbridge1$202$qvector_default_bool(::QVector_bool *return$) noexcept {
  ::QVector_bool (*qvector_default_bool$)() = ::rust::cxxqtlib1::construct;
  new (return$) ::QVector_bool(qvector_default_bool$());
}

void rust$cxxqtlib1$cxxbridge1$202$qvector_drop_bool(::QVector_bool &arg0) noexcept {
...
namespace qvector {
extern "C" {
void rust$cxxqtlib1$qvector$cxxbridge1$202$reserve_bool(::QVector_bool &arg0, ::rust::isize size) noexcept {
  void (*reserve_bool$)(::QVector_bool &, ::rust::isize) = ::rust::cxxqtlib1::qvector::qvectorReserve;
  reserve_bool$(arg0, size);
}

void rust$cxxqtlib1$qvector$cxxbridge1$202$append_bool(::QVector_bool &arg0, bool const &arg1) noexcept {
  void (*append_bool$)(::QVector_bool &, bool const &) = ::rust::cxxqtlib1::qvector::qvectorAppend;
  append_bool$(arg0, arg1);
}

bool const *rust$cxxqtlib1$qvector$cxxbridge1$202$get_unchecked_bool(::QVector_bool const &set, ::rust::isize pos) noexcept {
...
::rust::isize rust$cxxqtlib1$qvector$cxxbridge1$202$index_of_bool(::QVector_bool const &arg0, bool const &arg1) noexcept {
...
void rust$cxxqtlib1$qvector$cxxbridge1$202$insert_bool(::QVector_bool &arg0, ::rust::isize arg1, bool const &arg2) noexcept {
  void (*insert_bool$)(::QVector_bool &, ::rust::isize, bool const &) = ::rust::cxxqtlib1::qvector::qvectorInsert;
  insert_bool$(arg0, arg1, arg2);
}

::rust::isize rust$cxxqtlib1$qvector$cxxbridge1$202$len_bool(::QVector_bool const &arg0) noexcept {
  ::rust::isize (*len_bool$)(::QVector_bool const &) = ::rust::cxxqtlib1::qvector::qvectorLen;
  return len_bool$(arg0);
}

void rust$cxxqtlib1$qvector$cxxbridge1$202$remove_bool(::QVector_bool &arg0, ::rust::isize arg1) noexcept {
