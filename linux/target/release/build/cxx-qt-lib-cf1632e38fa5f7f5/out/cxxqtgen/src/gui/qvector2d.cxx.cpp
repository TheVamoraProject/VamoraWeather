...
extern "C" {
bool cxxbridge1$202$QVector2D$is_null(::QVector2D const &self) noexcept {
  bool (::QVector2D::*is_null$)() const = &::QVector2D::isNull;
  return (self.*is_null$)();
}

float cxxbridge1$202$QVector2D$length(::QVector2D const &self) noexcept {
  float (::QVector2D::*length$)() const = &::QVector2D::length;
  return (self.*length$)();
}

float cxxbridge1$202$QVector2D$length_squared(::QVector2D const &self) noexcept {
  float (::QVector2D::*length_squared$)() const = &::QVector2D::lengthSquared;
  return (self.*length_squared$)();
}

void cxxbridge1$202$QVector2D$normalize(::QVector2D &self) noexcept {
  void (::QVector2D::*normalize$)() = &::QVector2D::normalize;
  (self.*normalize$)();
}

void cxxbridge1$202$QVector2D$normalized(::QVector2D const &self, ::QVector2D *return$) noexcept {
  ::QVector2D (::QVector2D::*normalized$)() const = &::QVector2D::normalized;
  new (return$) ::QVector2D((self.*normalized$)());
}

void cxxbridge1$202$QVector2D$set_x(::QVector2D &self, float x) noexcept {
  void (::QVector2D::*set_x$)(float) = &::QVector2D::setX;
  (self.*set_x$)(x);
}

void cxxbridge1$202$QVector2D$set_y(::QVector2D &self, float y) noexcept {
  void (::QVector2D::*set_y$)(float) = &::QVector2D::setY;
  (self.*set_y$)(y);
}

void cxxbridge1$202$QVector2D$to_point(::QVector2D const &self, ::QPoint *return$) noexcept {
  ::QPoint (::QVector2D::*to_point$)() const = &::QVector2D::toPoint;
  new (return$) ::QPoint((self.*to_point$)());
}

void cxxbridge1$202$QVector2D$to_pointf(::QVector2D const &self, ::QPointF *return$) noexcept {
  ::QPointF (::QVector2D::*to_pointf$)() const = &::QVector2D::toPointF;
  new (return$) ::QPointF((self.*to_pointf$)());
}

float cxxbridge1$202$QVector2D$x(::QVector2D const &self) noexcept {
  float (::QVector2D::*x$)() const = &::QVector2D::x;
  return (self.*x$)();
}

float cxxbridge1$202$QVector2D$y(::QVector2D const &self) noexcept {
...
namespace cxxqtlib1 {
extern "C" {
void rust$cxxqtlib1$cxxbridge1$202$qvector2d_init_qvector4d(::QVector4D *vector, ::QVector2D *return$) noexcept {
...
void rust$cxxqtlib1$cxxbridge1$202$qvector2d_init_qvector3d(::QVector3D *vector, ::QVector2D *return$) noexcept {
...
void rust$cxxqtlib1$cxxbridge1$202$qvector2d_init_qpointf(::QPointF *point, ::QVector2D *return$) noexcept {
...
void rust$cxxqtlib1$cxxbridge1$202$qvector2d_init_qpoint(::QPoint *point, ::QVector2D *return$) noexcept {
  ::QVector2D (*qvector2d_init_qpoint$)(::QPoint) = ::rust::cxxqtlib1::construct;
  new (return$) ::QVector2D(qvector2d_init_qpoint$(::std::move(*point)));
}

void rust$cxxqtlib1$cxxbridge1$202$qvector2d_init(float x, float y, ::QVector2D *return$) noexcept {
  ::QVector2D (*qvector2d_init$)(float, float) = ::rust::cxxqtlib1::construct;
  new (return$) ::QVector2D(qvector2d_init$(x, y));
}

void rust$cxxqtlib1$cxxbridge1$202$qvector2d_init_default(::QVector2D *return$) noexcept {
  ::QVector2D (*qvector2d_init_default$)() = ::rust::cxxqtlib1::construct;
  new (return$) ::QVector2D(qvector2d_init_default$());
}

float rust$cxxqtlib1$cxxbridge1$202$qvector2d_distance_to_line(::QVector2D const &vector, ::QVector2D *point, ::QVector2D *direction) noexcept {
...
float rust$cxxqtlib1$cxxbridge1$202$qvector2d_distance_to_point(::QVector2D const &vector, ::QVector2D *point) noexcept {
...
void rust$cxxqtlib1$cxxbridge1$202$qvector2d_to_debug_qstring(::QVector2D const &value, ::QString *return$) noexcept {
...
void rust$cxxqtlib1$cxxbridge1$202$qvector2d_plus(::QVector2D const &a, ::QVector2D const &b, ::QVector2D *return$) noexcept {
...
void rust$cxxqtlib1$cxxbridge1$202$qvector2d_minus(::QVector2D const &a, ::QVector2D const &b, ::QVector2D *return$) noexcept {
...
void rust$cxxqtlib1$cxxbridge1$202$qvector2d_mul(float a, ::QVector2D const &b, ::QVector2D *return$) noexcept {
  ::QVector2D (*qvector2d_mul$)(float, ::QVector2D const &) = ::rust::cxxqtlib1::operatorMul;
  new (return$) ::QVector2D(qvector2d_mul$(a, b));
}

void rust$cxxqtlib1$cxxbridge1$202$qvector2d_div(float a, ::QVector2D const &b, ::QVector2D *return$) noexcept {
