...
extern "C" {
void cxxbridge1$202$QSet_i8$cxx_clear(::QSet_i8 &self) noexcept {
  void (::QSet_i8::*cxx_clear$)() = &::QSet_i8::clear;
  (self.*cxx_clear$)();
}

bool cxxbridge1$202$QSet_i8$cxx_contains(::QSet_i8 const &self, ::std::int8_t const &arg0) noexcept {
  bool (::QSet_i8::*cxx_contains$)(::std::int8_t const &) const = &::QSet_i8::contains;
  return (self.*cxx_contains$)(arg0);
}

bool cxxbridge1$202$QSet_i8$cxx_remove(::QSet_i8 &self, ::std::int8_t const &arg0) noexcept {
...
namespace cxxqtlib1 {
extern "C" {
void rust$cxxqtlib1$cxxbridge1$202$qset_clone_i8(::QSet_i8 const &arg0, ::QSet_i8 *return$) noexcept {
  ::QSet_i8 (*qset_clone_i8$)(::QSet_i8 const &) = ::rust::cxxqtlib1::construct;
  new (return$) ::QSet_i8(qset_clone_i8$(arg0));
}

void rust$cxxqtlib1$cxxbridge1$202$qset_default_i8(::QSet_i8 *return$) noexcept {
  ::QSet_i8 (*qset_default_i8$)() = ::rust::cxxqtlib1::construct;
  new (return$) ::QSet_i8(qset_default_i8$());
}

void rust$cxxqtlib1$cxxbridge1$202$qset_drop_i8(::QSet_i8 &arg0) noexcept {
...
namespace qset {
extern "C" {
::std::int8_t const *rust$cxxqtlib1$qset$cxxbridge1$202$get_unchecked_i8(::QSet_i8 const &set, ::rust::isize pos) noexcept {
...
void rust$cxxqtlib1$qset$cxxbridge1$202$insert_i8(::QSet_i8 &arg0, ::std::int8_t const &arg1) noexcept {
  void (*insert_i8$)(::QSet_i8 &, ::std::int8_t const &) = ::rust::cxxqtlib1::qset::qsetInsert;
  insert_i8$(arg0, arg1);
}

::rust::isize rust$cxxqtlib1$qset$cxxbridge1$202$len_i8(::QSet_i8 const &arg0) noexcept {
  ::rust::isize (*len_i8$)(::QSet_i8 const &) = ::rust::cxxqtlib1::qset::qsetLen;
  return len_i8$(arg0);
}

void rust$cxxqtlib1$qset$cxxbridge1$202$reserve_i8(::QSet_i8 &arg0, ::rust::isize size) noexcept {
