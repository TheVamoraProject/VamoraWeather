...
namespace qvariant {
extern "C" {
bool rust$cxxqtlib1$qvariant$cxxbridge1$202$can_convert_QVector4D(::QVariant const &variant) noexcept {
...
void rust$cxxqtlib1$qvariant$cxxbridge1$202$construct_QVector4D(::QVector4D const &value, ::QVariant *return$) noexcept {
...
void rust$cxxqtlib1$qvariant$cxxbridge1$202$value_or_default_QVector4D(::QVariant const &variant, ::QVector4D *return$) noexcept {
