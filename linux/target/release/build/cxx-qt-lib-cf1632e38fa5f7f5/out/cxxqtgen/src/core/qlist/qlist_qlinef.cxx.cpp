...
extern "C" {
void cxxbridge1$202$QList_QLineF$cxx_clear(::QList_QLineF &self) noexcept {
  void (::QList_QLineF::*cxx_clear$)() = &::QList_QLineF::clear;
  (self.*cxx_clear$)();
}

bool cxxbridge1$202$QList_QLineF$cxx_contains(::QList_QLineF const &self, ::QLineF const &arg0) noexcept {
...
namespace cxxqtlib1 {
extern "C" {
void rust$cxxqtlib1$cxxbridge1$202$qlist_clone_QLineF(::QList_QLineF const &arg0, ::QList_QLineF *return$) noexcept {
...
void rust$cxxqtlib1$cxxbridge1$202$qlist_default_QLineF(::QList_QLineF *return$) noexcept {
  ::QList_QLineF (*qlist_default_QLineF$)() = ::rust::cxxqtlib1::construct;
  new (return$) ::QList_QLineF(qlist_default_QLineF$());
}

void rust$cxxqtlib1$cxxbridge1$202$qlist_drop_QLineF(::QList_QLineF &arg0) noexcept {
...
namespace qlist {
extern "C" {
void rust$cxxqtlib1$qlist$cxxbridge1$202$reserve_QLineF(::QList_QLineF &arg0, ::rust::isize size) noexcept {
  void (*reserve_QLineF$)(::QList_QLineF &, ::rust::isize) = ::rust::cxxqtlib1::qlist::qlistReserve;
  reserve_QLineF$(arg0, size);
}

void rust$cxxqtlib1$qlist$cxxbridge1$202$append_QLineF(::QList_QLineF &arg0, ::QLineF const &arg1) noexcept {
  void (*append_QLineF$)(::QList_QLineF &, ::QLineF const &) = ::rust::cxxqtlib1::qlist::qlistAppend;
  append_QLineF$(arg0, arg1);
}

void rust$cxxqtlib1$qlist$cxxbridge1$202$get_unchecked_QLineF(::QList_QLineF const &set, ::rust::isize pos, ::QLineF const **return$) noexcept {
...
::rust::isize rust$cxxqtlib1$qlist$cxxbridge1$202$index_of_QLineF(::QList_QLineF const &arg0, ::QLineF const &arg1) noexcept {
...
void rust$cxxqtlib1$qlist$cxxbridge1$202$insert_QLineF(::QList_QLineF &arg0, ::rust::isize arg1, ::QLineF const &arg2) noexcept {
  void (*insert_QLineF$)(::QList_QLineF &, ::rust::isize, ::QLineF const &) = ::rust::cxxqtlib1::qlist::qlistInsert;
  insert_QLineF$(arg0, arg1, arg2);
}

void rust$cxxqtlib1$qlist$cxxbridge1$202$remove_QLineF(::QList_QLineF &arg0, ::rust::isize arg1) noexcept {
  void (*remove_QLineF$)(::QList_QLineF &, ::rust::isize) = ::rust::cxxqtlib1::qlist::qlistRemove;
  remove_QLineF$(arg0, arg1);
}

::rust::isize rust$cxxqtlib1$qlist$cxxbridge1$202$len_QLineF(::QList_QLineF const &arg0) noexcept {
