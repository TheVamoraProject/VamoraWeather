...
extern "C" {
void cxxbridge1$202$QList_QMargins$cxx_clear(::QList_QMargins &self) noexcept {
  void (::QList_QMargins::*cxx_clear$)() = &::QList_QMargins::clear;
  (self.*cxx_clear$)();
}

bool cxxbridge1$202$QList_QMargins$cxx_contains(::QList_QMargins const &self, ::QMargins const &arg0) noexcept {
...
namespace cxxqtlib1 {
extern "C" {
void rust$cxxqtlib1$cxxbridge1$202$qlist_clone_QMargins(::QList_QMargins const &arg0, ::QList_QMargins *return$) noexcept {
...
void rust$cxxqtlib1$cxxbridge1$202$qlist_default_QMargins(::QList_QMargins *return$) noexcept {
  ::QList_QMargins (*qlist_default_QMargins$)() = ::rust::cxxqtlib1::construct;
  new (return$) ::QList_QMargins(qlist_default_QMargins$());
}

void rust$cxxqtlib1$cxxbridge1$202$qlist_drop_QMargins(::QList_QMargins &arg0) noexcept {
...
namespace qlist {
extern "C" {
void rust$cxxqtlib1$qlist$cxxbridge1$202$reserve_QMargins(::QList_QMargins &arg0, ::rust::isize size) noexcept {
  void (*reserve_QMargins$)(::QList_QMargins &, ::rust::isize) = ::rust::cxxqtlib1::qlist::qlistReserve;
  reserve_QMargins$(arg0, size);
}

void rust$cxxqtlib1$qlist$cxxbridge1$202$append_QMargins(::QList_QMargins &arg0, ::QMargins const &arg1) noexcept {
  void (*append_QMargins$)(::QList_QMargins &, ::QMargins const &) = ::rust::cxxqtlib1::qlist::qlistAppend;
  append_QMargins$(arg0, arg1);
}

void rust$cxxqtlib1$qlist$cxxbridge1$202$get_unchecked_QMargins(::QList_QMargins const &set, ::rust::isize pos, ::QMargins const **return$) noexcept {
...
::rust::isize rust$cxxqtlib1$qlist$cxxbridge1$202$index_of_QMargins(::QList_QMargins const &arg0, ::QMargins const &arg1) noexcept {
...
void rust$cxxqtlib1$qlist$cxxbridge1$202$insert_QMargins(::QList_QMargins &arg0, ::rust::isize arg1, ::QMargins const &arg2) noexcept {
...
void rust$cxxqtlib1$qlist$cxxbridge1$202$remove_QMargins(::QList_QMargins &arg0, ::rust::isize arg1) noexcept {
  void (*remove_QMargins$)(::QList_QMargins &, ::rust::isize) = ::rust::cxxqtlib1::qlist::qlistRemove;
  remove_QMargins$(arg0, arg1);
}

::rust::isize rust$cxxqtlib1$qlist$cxxbridge1$202$len_QMargins(::QList_QMargins const &arg0) noexcept {
