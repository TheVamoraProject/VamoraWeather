...
extern "C" {
void cxxbridge1$202$QVector_QColor$cxx_clear(::QVector_QColor &self) noexcept {
  void (::QVector_QColor::*cxx_clear$)() = &::QVector_QColor::clear;
  (self.*cxx_clear$)();
}

bool cxxbridge1$202$QVector_QColor$cxx_contains(::QVector_QColor const &self, ::QColor const &arg0) noexcept {
...
namespace cxxqtlib1 {
extern "C" {
void rust$cxxqtlib1$cxxbridge1$202$qvector_clone_QColor(::QVector_QColor const &arg0, ::QVector_QColor *return$) noexcept {
...
void rust$cxxqtlib1$cxxbridge1$202$qvector_default_QColor(::QVector_QColor *return$) noexcept {
  ::QVector_QColor (*qvector_default_QColor$)() = ::rust::cxxqtlib1::construct;
  new (return$) ::QVector_QColor(qvector_default_QColor$());
}

void rust$cxxqtlib1$cxxbridge1$202$qvector_drop_QColor(::QVector_QColor &arg0) noexcept {
...
namespace qvector {
extern "C" {
void rust$cxxqtlib1$qvector$cxxbridge1$202$reserve_QColor(::QVector_QColor &arg0, ::rust::isize size) noexcept {
  void (*reserve_QColor$)(::QVector_QColor &, ::rust::isize) = ::rust::cxxqtlib1::qvector::qvectorReserve;
  reserve_QColor$(arg0, size);
}

void rust$cxxqtlib1$qvector$cxxbridge1$202$append_QColor(::QVector_QColor &arg0, ::QColor const &arg1) noexcept {
  void (*append_QColor$)(::QVector_QColor &, ::QColor const &) = ::rust::cxxqtlib1::qvector::qvectorAppend;
  append_QColor$(arg0, arg1);
}

void rust$cxxqtlib1$qvector$cxxbridge1$202$get_unchecked_QColor(::QVector_QColor const &set, ::rust::isize pos, ::QColor const **return$) noexcept {
...
::rust::isize rust$cxxqtlib1$qvector$cxxbridge1$202$index_of_QColor(::QVector_QColor const &arg0, ::QColor const &arg1) noexcept {
...
void rust$cxxqtlib1$qvector$cxxbridge1$202$insert_QColor(::QVector_QColor &arg0, ::rust::isize arg1, ::QColor const &arg2) noexcept {
...
void rust$cxxqtlib1$qvector$cxxbridge1$202$remove_QColor(::QVector_QColor &arg0, ::rust::isize arg1) noexcept {
  void (*remove_QColor$)(::QVector_QColor &, ::rust::isize) = ::rust::cxxqtlib1::qvector::qvectorRemove;
  remove_QColor$(arg0, arg1);
}

::rust::isize rust$cxxqtlib1$qvector$cxxbridge1$202$len_QColor(::QVector_QColor const &arg0) noexcept {
