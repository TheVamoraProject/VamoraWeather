...
extern "C" {
void cxxbridge1$202$QHash_i32_QByteArray$cxx_clear(::QHash_i32_QByteArray &self) noexcept {
  void (::QHash_i32_QByteArray::*cxx_clear$)() = &::QHash_i32_QByteArray::clear;
  (self.*cxx_clear$)();
}

bool cxxbridge1$202$QHash_i32_QByteArray$cxx_contains(::QHash_i32_QByteArray const &self, ::std::int32_t const &key) noexcept {
...
namespace cxxqtlib1 {
extern "C" {
void rust$cxxqtlib1$cxxbridge1$202$qhash_clone_i32_QByteArray(::QHash_i32_QByteArray const &arg0, ::QHash_i32_QByteArray *return$) noexcept {
...
void rust$cxxqtlib1$cxxbridge1$202$qhash_default_i32_QByteArray(::QHash_i32_QByteArray *return$) noexcept {
...
void rust$cxxqtlib1$cxxbridge1$202$qhash_drop_i32_QByteArray(::QHash_i32_QByteArray &arg0) noexcept {
...
namespace qhash {
extern "C" {
void rust$cxxqtlib1$qhash$cxxbridge1$202$get_or_default_i32_QByteArray(::QHash_i32_QByteArray const &arg0, ::std::int32_t const &key, ::QByteArray *return$) noexcept {
...
::std::int32_t const *rust$cxxqtlib1$qhash$cxxbridge1$202$get_unchecked_key_i32_QByteArray(::QHash_i32_QByteArray const &arg0, ::rust::isize pos) noexcept {
...
void rust$cxxqtlib1$qhash$cxxbridge1$202$get_unchecked_value_i32_QByteArray(::QHash_i32_QByteArray const &arg0, ::rust::isize pos, ::QByteArray const **return$) noexcept {
...
void rust$cxxqtlib1$qhash$cxxbridge1$202$insert_i32_QByteArray(::QHash_i32_QByteArray &arg0, ::std::int32_t const &key, ::QByteArray const &value) noexcept {
...
::rust::isize rust$cxxqtlib1$qhash$cxxbridge1$202$len_i32_QByteArray(::QHash_i32_QByteArray const &arg0) noexcept {
  ::rust::isize (*len_i32_QByteArray$)(::QHash_i32_QByteArray const &) = ::rust::cxxqtlib1::qhash::qhashLen;
  return len_i32_QByteArray$(arg0);
}

bool rust$cxxqtlib1$qhash$cxxbridge1$202$remove_i32_QByteArray(::QHash_i32_QByteArray &arg0, ::std::int32_t const &key) noexcept {
